...
ax1.plot(years, company_b_users, label='Company B Users', marker='^', linestyle='-', color='slateblue', linewidth=2, markersize=6)
...
ax1.annotate('Company B hits 100M users', xy=(2008, 100), xytext=(2005, 150),
             arrowprops=dict(facecolor='gray', arrowstyle='->', lw=1.5),
             fontsize=10, fontweight='bold', color='slateblue')
