...
populations = {
    ...
    'Central America': [150, 160, 155, 158, 170, 175, 180, 185, 190, 195, 200]  # Added data series
}

plt.figure(figsize=(14, 8))

# Colors for each region line
colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728']  # Added color for new series

# Plot data with annotations for each region
for (region, pops), color in zip(populations.items(), colors):
    plt.plot(years, pops, '-o', label=region, color=color, linewidth=2, markersize=6, alpha=0.8)
