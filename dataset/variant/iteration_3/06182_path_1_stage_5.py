...
adoption_rates = np.array([
    [3, 5, 7, 9, 11, 14, 17, 19, 21, 24, 26],
    [5, 7, 9, 11, 14, 16, 19, 22, 25, 27, 30],
    [6, 8, 11, 13, 16, 18, 21, 23, 26, 28, 31],
    [8, 10, 12, 15, 18, 21, 23, 25, 28, 30, 32],
    [2, 3, 4, 5, 7, 9, 11, 13, 15, 18, 20],
    [10, 14, 18, 21, 25, 28, 32, 35, 39, 42, 45],
    [4, 5, 7, 9, 11, 13, 15, 17, 20, 22, 25],
...
im = ax.imshow(adoption_masked, cmap='viridis', aspect='auto')  # Changed colormap
