...
single_color = 'purple'
ax.plot(years, solar_energy, label='Solar', color=single_color, linestyle='-', marker='o', linewidth=2)
ax.plot(years, wind_energy, label='Wind', color=single_color, linestyle='--', marker='s', linewidth=2)
ax.plot(years, hydropower, label='Hydro', color=single_color, linestyle='-.', marker='^', linewidth=2)
ax.plot(years, geothermal_energy, label='Geo', color=single_color, linestyle=':', marker='d', linewidth=2)
