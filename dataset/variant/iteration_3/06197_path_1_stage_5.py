...
ax[0].bar(x_indexes - 1.5 * bar_width, plastic_recycling, width=bar_width, color='#33FF57', alpha=0.8)
ax[0].bar(x_indexes - 0.5 * bar_width, glass_recycling, width=bar_width, color='#FFD700', alpha=0.8)
ax[0].bar(x_indexes + 0.5 * bar_width, metal_recycling, width=bar_width, color='#FF5733', alpha=0.8)
ax[0].bar(x_indexes + 1.5 * bar_width, paper_recycling, width=bar_width, color='#3357FF', alpha=0.8)
...
ax[1].bar(months, plastic_percentage, color='#33FF57', alpha=0.8)
ax[1].bar(months, glass_percentage, bottom=plastic_percentage, color='#FFD700', alpha=0.8)
ax[1].bar(months, metal_percentage, bottom=plastic_percentage + glass_percentage, color='#FF5733', alpha=0.8)
ax[1].bar(months, paper_percentage, bottom=plastic_percentage + glass_percentage + metal_percentage, color='#3357FF', alpha=0.8)
