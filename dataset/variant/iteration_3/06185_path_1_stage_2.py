...
ax.plot(days, exercise_intensity, color='blue', marker='o', linewidth=2, markersize=8, label='Exercise Intensity')

# Titles and Labels
ax.set_title('30-Day Fitness Challenge: Exercise Intensity', fontsize=18, fontweight='bold')
ax.set_xlabel('Days', fontsize=14)
ax.set_ylabel('Exercise Intensity (arbitrary units)', fontsize=14, color='blue')
