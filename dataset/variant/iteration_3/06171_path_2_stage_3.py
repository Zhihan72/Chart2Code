...
# Create the figures with a different subplot arrangement (2 rows, 1 column)
...
# Donut pie chart for pet types
colors = ['#FF9999', '#66B2FF', '#99FF99']
explode = (0.1, 0, 0)

wedges, texts, autotexts = ax2.pie(pet_counts, labels=pet_types, explode=explode, colors=colors,
