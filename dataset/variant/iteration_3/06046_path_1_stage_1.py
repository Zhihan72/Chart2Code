...
# Colors shuffled by switching
ax1.plot(years, company_a_users, label='Company A Users', marker='o', linestyle='-', color='tomato', linewidth=2, markersize=6)
ax1.plot(years, company_b_users, label='Company B Users', marker='^', linestyle='-', color='royalblue', linewidth=2, markersize=6)
