...
ax.plot(years, solar_panels_A, linestyle='-', marker='o', color='#ff5733', linewidth=2, markersize=6, label='Array Alpha')
ax.plot(years, solar_panels_B, linestyle='--', marker='s', color='#33ff57', linewidth=2, markersize=6, label='Array Beta')
ax.plot(years, solar_panels_C, linestyle=':', marker='^', color='#3357ff', linewidth=2, markersize=6, label='Array Gamma')
