...
# Data for each plant type (in acres) after removing the 'Grasses' category
...
# Create the stacked area plot after removing 'Grasses'
...
ax.stackplot(
    ...
    colors=['#228B22', '#32CD32', '#FF69B4', '#BA55D3'],
    alpha=0.8
)
