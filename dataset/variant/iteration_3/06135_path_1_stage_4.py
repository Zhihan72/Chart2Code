...
plt.scatter(sunlight, succulent_growth, s=sizes, c='blue', alpha=0.6, edgecolor='k')
plt.scatter(sunlight, fern_growth, s=sizes, c='blue', alpha=0.6, edgecolor='k')
plt.scatter(sunlight, pothos_growth, s=sizes, c='blue', alpha=0.6, edgecolor='k')
plt.scatter(sunlight, cactus_growth, s=sizes, c='blue', alpha=0.6, edgecolor='k')
