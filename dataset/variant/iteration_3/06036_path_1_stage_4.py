...
ax.set_xlabel('Schools', fontsize=12, fontstyle='italic')
ax.set_ylabel('Budget (k USD)', fontsize=12, fontstyle='italic')
...
ax.legend(title='Yr', fontsize=10, loc='upper left', frameon=True, shadow=True)
