...
apples = [950, 1250, 1100, 1200, 850]  # Randomly altered values
oranges = [1200, 950, 1020, 900, 820]  # Randomly altered values
grapes = [980, 1100, 880, 1200, 950]   # Randomly altered values
