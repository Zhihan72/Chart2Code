...
bars_2020 = ax.bar(x - width, sorted_budget_2020, width, label='Year 2020', color='gold', linewidth=2, edgecolor='gray')
bars_2021 = ax.bar(x, sorted_budget_2021, width, label='The Year 2021', color='darkred', hatch='/', linewidth=2, edgecolor='darkred')
bars_2022 = ax.bar(x + width, sorted_budget_2022, width, label='Fiscal 2022', color='navy', linestyle='-', linewidth=2, edgecolor='black')
