...
# Manually altered data to simulate random changes while preserving dimensions
voltage_levels = np.array([
    [225, 210, 220, 219, 221, 223, 222, 227, 228, 225, 228, 227],  # Residential
    [228, 230, 229, 234, 232, 239, 236, 239, 237, 236, 233, 232],  # Commercial
    [212, 217, 218, 223, 233, 230, 242, 243, 247, 246, 242, 238],  # Industrial
    [202, 207, 208, 213, 218, 222, 230, 232, 224, 219, 214, 211],  # Agricultural
    [231, 235, 233, 235, 239, 238, 241, 243, 242, 240, 237, 236],  # Healthcare
    [222, 223, 223, 225, 230, 229, 233, 235, 230, 229, 232, 228],  # Education
    [213, 220, 218, 223, 225, 224, 229, 228, 226, 225, 223, 220]   # Recreational
])
...
heatmap = axes[0].imshow(voltage_levels, cmap='cool', aspect='auto', interpolation='nearest')
