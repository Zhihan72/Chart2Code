...
fiction_sales = np.array([28, 25, 33, 30, 23, 40, 35, 20, 27, 32, 35, 30])  # manually shuffled
non_fiction_sales = np.array([25, 18, 24, 22, 20, 33, 28, 15, 27, 28, 30, 25])  # manually shuffled
children_sales = np.array([18, 12, 21, 18, 10, 25, 22, 15, 20, 21, 23, 20])  # manually shuffled
educational_sales = np.array([12, 7, 16, 10, 8, 18, 15, 5, 14, 14, 16, 13])  # manually shuffled
...
axs[0].stackplot(month_names, fiction_sales, non_fiction_sales, children_sales, educational_sales,
                 labels=['Fiction', 'Non-Fic', 'Kids', 'Edu'],
...
axs[0].legend(title="Genre", loc="upper left", fontsize=11, frameon=False)
