...
ax.barh(y_pos, sales_totals, align='center', color='blue', edgecolor='darkblue', linestyle='--')

# Manually changed titles and labels for consistency, no randomness
ax.set_yticks(y_pos)
ax.set_yticklabels(sorted_categories[::-1])  # Reversed labels for clarity as per reference code

ax.set_xlabel('Cumulative Sales (k units)', fontsize=12, color='darkgreen', fontweight='bold')
ax.set_title('Total Sales Overview for 2023', fontsize=14, fontweight='bold', color='purple')
