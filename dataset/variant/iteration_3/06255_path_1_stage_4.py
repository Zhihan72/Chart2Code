...
ax.set_title('Mythica Resource Use (2010-2020)', fontsize=16, fontweight='bold', pad=20)
ax.set_xlabel('Yr', fontsize=14)
ax.set_ylabel('Usage (K Units)', fontsize=14)

ax.set_xticks(years)
ax.set_yticks(np.arange(0, 101, 10))

ax.annotate('Moon Crystals Intro', xy=(2015, 20), xytext=(2012, 50),
            arrowprops=dict(facecolor='black', shrink=0.05),
            fontsize=10, ha='center', backgroundcolor='white')

ax.annotate('Star Dust Discover', xy=(2017, 28), xytext=(2018, 65),
            arrowprops=dict(facecolor='black', shrink=0.05),
            fontsize=10, ha='center', backgroundcolor='white')
