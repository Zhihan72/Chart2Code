...
# Changed both plot colors to a single color 'blue'
ax.plot(years, population, label="Residents (in thousands)", color='blue', linestyle='-', marker='o', linewidth=2)
ax.plot(years, household_income, label="Household Earnings (in thousands)", color='blue', linestyle='-', marker='^', linewidth=2)
