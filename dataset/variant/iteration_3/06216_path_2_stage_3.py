...
plt.plot(decades, pop_music, marker='v', linestyle=':', color='aqua', linewidth=2.5, label='Jazz')
plt.plot(decades, rock_music, marker='x', linestyle='-.', color='gold', linewidth=2.5, label='Electronic')
plt.plot(decades, electronic_music, marker='<', linestyle='-', color='magenta', linewidth=2.5, label='Pop')
plt.plot(decades, jazz_music, marker='h', linestyle='-', color='green', linewidth=2.5, label='Rock')
