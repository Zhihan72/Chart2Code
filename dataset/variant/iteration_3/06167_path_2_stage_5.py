...
axes[0].set_title("Sweet Treat Sales in Zone Alpha (2015-2020)", fontsize=13, fontweight='bold', pad=20)
axes[0].set_xlabel("Timeline (Years)", fontsize=12)
axes[0].set_ylabel("Units Sold (000s)", fontsize=12)
...
axes[1].set_title("Sweet Treat Sales in Zone Gamma (2015-2020)", fontsize=13, fontweight='bold', pad=20)
axes[1].set_xlabel("Timeline (Years)", fontsize=12)
axes[1].set_ylabel("Units Sold (000s)", fontsize=12)
axes[1].set_xticks(years)

fig.suptitle("6-Year Sweet Treat Sales Analysis", fontsize=16, fontweight='bold', y=1.05)
