...
# New set of colors
colors = ['#ff6666', '#66ff66', '#6666ff', '#ff66ff', '#66ffff']
hatches = ['', '//', '\\\\', 'xx', '..']
...
bars = ax2.bar(cities, total_harvest_yield, color='#ffa500', alpha=0.75, edgecolor='orange', linewidth=2, linestyle='dotted')
