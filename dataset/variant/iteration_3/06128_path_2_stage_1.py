...
# Shuffled color assignment for each student
ax.plot(subjects, student_A_grades, marker='o', linestyle='-', color='green', label='Student A')  # Shuffled to green
ax.plot(subjects, student_B_grades, marker='s', linestyle='--', color='red', label='Student B')   # Shuffled to red
ax.plot(subjects, student_C_grades, marker='^', linestyle='-.', color='blue', label='Student C')  # Shuffled to blue
