...
# We shuffle the colors for each data group
ax.plot(years, farm_a_productivity, color='blue', linestyle='-', linewidth=2, marker='o', label='Farm A')
ax.plot(years, farm_b_productivity, color='green', linestyle='--', linewidth=2, marker='x', label='Farm B')
...
ax.annotate(f"Farm A spike\nin {highlight_year}", xy=(highlight_year, highlight_a), xytext=(highlight_year, highlight_a + 10),
            ...
            fontsize=12, ha='center', va='bottom', bbox=dict(boxstyle="round,pad=0.3", edgecolor='blue', facecolor='white'))

ax.annotate(f"Farm B surge\nin {highlight_year}", xy=(highlight_year, highlight_b), xytext=(highlight_year + 1, highlight_b - 15),
            arrowprops=dict(facecolor='black', shrink=0.05, width=1.5),
            fontsize=12, ha='center', va='top', bbox=dict(boxstyle="round,pad=0.3", edgecolor='green', facecolor='white'))
