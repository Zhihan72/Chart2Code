...
# In undirected graphs, edges are bidirectional by default
...
nx.draw_networkx_edges(G, pos, edgelist=edges, edge_color='blue', width=[weight / 5 for weight in edge_weights])
