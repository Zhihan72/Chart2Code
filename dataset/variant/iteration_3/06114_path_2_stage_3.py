...
# Subplot 1: Water Clarity (originally the third subplot)
axs[0].plot(years, delta_a_water_clarity, color='lime', linestyle='-', linewidth=2, label='Delta A')
axs[0].plot(years, delta_b_water_clarity, color='cyan', linestyle='--', linewidth=2, label='Delta B')
axs[0].plot(years, delta_c_water_clarity, color='magenta', linestyle='-.', linewidth=2, label='Delta C')
...
# Subplot 2: Fish Population (remains the same)
axs[1].plot(years, delta_a_fish_population, color='brown', linestyle='-', linewidth=2, label='Delta A')
axs[1].plot(years, delta_b_fish_population, color='blue', linestyle='--', linewidth=2, label='Delta B')
axs[1].plot(years, delta_c_fish_population, color='green', linestyle='-.', linewidth=2, label='Delta C')
...
# Subplot 3: Pollution Levels (originally the first subplot)
axs[2].plot(years, delta_a_pollution, color='purple', linestyle='-', linewidth=2, label='Delta A')
axs[2].plot(years, delta_b_pollution, color='red', linestyle='--', linewidth=2, label='Delta B')
axs[2].plot(years, delta_c_pollution, color='orange', linestyle='-.', linewidth=2, label='Delta C')
