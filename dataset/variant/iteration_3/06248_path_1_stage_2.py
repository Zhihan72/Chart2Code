...
# Randomly altered seagrass coverage data while maintaining the original structure
seagrass_coverage = np.array([130, 140, 170, 150])
# Randomly altered biodiversity index while maintaining the original structure
biodiversity_index = np.array([85, 75, 95, 80])
# Randomly altered coral reef quality while maintaining the original structure
