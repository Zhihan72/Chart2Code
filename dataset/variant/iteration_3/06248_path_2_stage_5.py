...
# Manually altered data to simulate random changes
seagrass_coverage_km2 = np.array([160, 120, 180, 150])
biodiversity_index = np.array([85, 70, 90, 80])
coral_reef_quality = np.array([7.5, 7, 8, 6])
