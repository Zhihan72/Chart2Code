...
ebook_streaming = np.array([0, 1, 2, 3, 4, 6, 9, 12, 16, 21, 27])
...
ax.fill_between(years, ebook_cum, color='#ff9999', alpha=0.6, label='eBooks', linestyle='solid')
ax.fill_between(years, game_cum, ebook_cum, color='#66b3ff', alpha=0.6, label='Games', linestyle='solid')
ax.fill_between(years, podcast_cum, game_cum, color='#c2c2f0', alpha=0.8, label='Podcasts', linestyle='dashed')
ax.fill_between(years, music_cum, podcast_cum, color='#b3e0ff', alpha=0.5, label='Music', linestyle='dashdot')
ax.fill_between(years, tv_cum, music_cum, color='#99ff99', alpha=0.4, label='TV', linestyle='dotted')
ax.fill_between(years, movie_cum, tv_cum, color='#ffcc99', alpha=0.7, label='Movies', linestyle='solid')
