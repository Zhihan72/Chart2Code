...
# Nodes representing space agencies and key astronomical discoveries
nodes = [
...
# Undirected edges based on collaboration and shared missions
edges = [
    ('NASA', 'ESA'),
    ('NASA', 'JAXA'),
    ('NASA', 'Roscosmos'),
...
# Sizes for different nodes based on their significance
node_sizes = {
