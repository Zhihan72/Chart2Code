...
ax1.plot(years, salmon_catches, marker='x', linestyle='--', linewidth=1.5, color='purple', label='Catch of Salmon')
ax1.plot(years, tuna_catches, marker='d', linestyle='-.', linewidth=1.5, color='c', label='Catch of Tuna')
ax1.plot(years, cod_catches, marker='v', linestyle=':', linewidth=1.5, color='orange', label='Catch of Cod')
...
ax1.text(2011, 185, 'Enhanced Salmon\nCapture Techniques', fontsize=10, ha='center', color='purple', backgroundcolor='white')
ax1.text(2014, 265, 'Marginal Dip\nDue to Intensive Fishing', fontsize=10, ha='center', color='orange', backgroundcolor='white')
