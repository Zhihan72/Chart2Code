...
ax.plot(months, temps_2021, marker='o', linestyle='-', color='r', linewidth=2)
ax.plot(months, temps_2022, marker='s', linestyle='--', color='g', linewidth=2)
ax.plot(months, temps_2023, marker='d', linestyle='-.', color='b', linewidth=2)
