...
ax.plot(years, tiger_population, marker='o', linestyle='-', color='purple', linewidth=2, markersize=6)
ax.plot(years, panda_population, marker='s', linestyle='-', color='pink', linewidth=2, markersize=6)
ax.plot(years, rhino_population, marker='^', linestyle='-', color='brown', linewidth=2, markersize=6)
ax.plot(years, elephant_population, marker='d', linestyle='-', color='cyan', linewidth=2, markersize=6)
