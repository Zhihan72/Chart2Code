...
bars1 = ax.barh(y_pos - bar_height/2, weekday_sleepers, bar_height, label='Weekdays', color='#1f77b4', edgecolor='black', alpha=0.7)
bars2 = ax.barh(y_pos + bar_height/2, weekend_sleepers, bar_height, label='Weekends', color='#ff7f0e', edgecolor='black', alpha=0.7)
