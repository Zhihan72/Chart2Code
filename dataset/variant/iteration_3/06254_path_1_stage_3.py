...
plt.scatter(green_space_per_capita_orig, happiness_index_orig, color='royalblue', edgecolors='black', s=150, alpha=0.7, label='Initial Regions')
plt.scatter(green_space_per_capita_add, happiness_index_add, color='forestgreen', edgecolors='black', s=150, alpha=0.7, label='New Regions')
...
plt.plot(green_space_per_capita_orig, m_orig * green_space_per_capita_orig + b_orig, color='firebrick', linestyle='--', linewidth=2, label='Trend - Initial')

m_add, b_add = np.polyfit(green_space_per_capita_add, happiness_index_add, 1)
plt.plot(green_space_per_capita_add, m_add * green_space_per_capita_add + b_add, color='darkorange', linestyle='--', linewidth=2, label='Trend - New')
