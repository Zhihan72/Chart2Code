...
colors = ['#FFDDC1', '#FFABAB', '#FFC3A0', '#D5AAFF', '#85E3FF', '#B9FBC0', '#FF9CEE', '#A0E7E5']
ax.bar(range(len(sorted_brightness)), sorted_brightness, color=colors * ((len(sorted_brightness) // len(colors)) + 1), edgecolor='black')
