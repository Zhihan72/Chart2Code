...
# Randomly altered production values for each division in each year (rows: divisions, cols: years)
production = np.array([
    [20, 19, 22, 25, 26],  # North America
    [18, 21, 20, 24, 25],  # Europe
    [15, 13, 16, 21, 23],  # Asia
    [12, 17, 18, 19, 19],  # Africa
    [10, 14, 15, 15, 17],  # Australia
    [8, 10, 12, 14, 14],   # South America
])
