...
# Data with manually shuffled elements
years = np.array([2010, 2012, 2014, 2016, 2018, 2020, 2022])
penetration_rate = np.array([30, 20, 65, 45, 85, 55, 75])  # Shuffled indices
avg_daily_hours_online = np.array([4.8, 3.2, 1.5, 6.1, 5.5, 2.3, 4.0])  # Shuffled indices
...
# Second y-axis for average daily hours online
ax2 = ax1.twinx()
color2 = 'tab:orange'
