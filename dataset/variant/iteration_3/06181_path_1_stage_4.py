...
# Shuffled colors
ax.plot(months, max_temp_2022, color='black', marker='x', linestyle=':', linewidth=2)
ax.plot(months, min_temp_2022, color='green', marker='+', linestyle='-.', linewidth=2)
ax.plot(months, max_temp_2023, color='brown', marker='*', linestyle='-', linewidth=2)
ax.plot(months, min_temp_2023, color='purple', marker='^', linestyle='--', linewidth=2)
