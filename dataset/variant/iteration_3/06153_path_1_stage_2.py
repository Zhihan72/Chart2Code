...
# Calculate the total number of books per genre
...
# Plot sorted bar chart with new colors
rects1 = ax.bar(x - width, fiction_books, width, label='Fiction', color='firebrick')
rects2 = ax.bar(x, non_fiction_books, width, label='Non-Fiction', color='mediumvioletred')
rects3 = ax.bar(x + width, scifi_books, width, label='Science Fiction', color='dodgerblue')
