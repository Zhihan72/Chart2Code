...
colors = ['yellow', 'cyan', 'magenta']  # Changed order: Aerobics, Yoga, Cardio

# Change line styles and marker types
line_styles = ['-.', '--', '-']
markers = ['s', 'D', 'o']

# Randomly changed bar colors and marker styles
...
ax2.plot(years, retention_rate, color='darkblue', linestyle='--', marker='s', label='Retention Rate')
ax2.set_ylabel('Retention Rate (%)', color='darkblue')

# Randomly changing the legend location and grid settings
fig.legend(loc='lower right', ncol=2, bbox_to_anchor=(0.95, 0.05))
