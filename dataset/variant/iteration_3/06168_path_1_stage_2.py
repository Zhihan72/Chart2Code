...
n, bins, patches = ax.hist(growth_combined, bins=np.arange(2.5, 6.5, 0.5),
                           edgecolor='black', color='lightblue', alpha=0.7, rwidth=0.85)

# Titles and labels
ax.set_title('Solar Growth 2045', fontsize=16, fontweight='bold')
ax.set_xlabel('Growth %', fontsize=14)
ax.set_ylabel('Freq', fontsize=14)

# Adding a legend
ax.legend(country_labels, title='Nations', loc='upper right', fontsize=10, edgecolor='gray', facecolor='lightgrey', framealpha=0.7)
