...
# Updated pie chart styles
data = [arcane_spells, mystic_spells, elemental_spells, enchantment_spells]
marker_styles = ['x', '^', 'o', 's']  # Custom marker styles for demonstration purposes
...
for i, school_data in enumerate(data):
    ...
    ax1.scatter(0, 0, s=100, c='black', marker=marker_styles[i])  # Adding different markers
    
    center_circle = plt.Circle((0, 0), 0.7, fc='white')
    ax1.add_artist(center_circle)
    
    # Adding legend for pie chart
