...
ax.plot(days, year_2022_temps, marker='^', linestyle='-', color=consistent_color, label='2022')
ax.plot(days, year_2023_temps, marker='x', linestyle=':', color=consistent_color, label='2023')
ax.plot(days, year_2024_temps, marker='h', linestyle='--', color=consistent_color, label='2024')
...
for i, temp in enumerate(year_2022_temps):
    ax.annotate(f'{temp}', xy=(days[i], temp), xytext=(-10, 10), textcoords='offset points', fontsize=8, color='darkgreen')
...
for i, temp in enumerate(year_2024_temps):
    ax.annotate(f'{temp}', xy=(days[i], temp), xytext=(-10, -25), textcoords='offset points', fontsize=8, color='darkgreen')
