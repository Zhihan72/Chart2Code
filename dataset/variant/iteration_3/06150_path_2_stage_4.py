...
ax.plot(years, bandwidth, color=bandwidth_color, marker='o', linestyle='-', linewidth=2, markersize=8)
ax.plot(years, latency, color=latency_color, marker='s', linestyle='--', linewidth=2, markersize=8)
