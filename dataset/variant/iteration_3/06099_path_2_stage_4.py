...
# Shuffled colors for each category
ax1.bar(r1, hypermarkets_sales, color='#FFD700', width=bar_width, edgecolor='none')  # Gold
ax1.bar(r2, corner_stores_sales, color='#FF33A1', width=bar_width, edgecolor='none')  # Pink
ax1.bar(r3, ecommerce_sales, color='#FF5733', width=bar_width, edgecolor='none')  # Red-orange
ax1.bar(r4, artisan_shops_sales, color='#3357FF', width=bar_width, edgecolor='none')  # Blue
ax1.bar(r5, kiosk_sales, color='#33FF57', width=bar_width, edgecolor='none')  # Green
