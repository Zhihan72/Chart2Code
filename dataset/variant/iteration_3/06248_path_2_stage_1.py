...
bars1 = ax1.bar(x_positions - bar_width/2, seagrass_coverage_km2, bar_width, label='Seagrass (km²)', color='seagreen')

# Secondary y-axis for indices
ax2 = ax1.twinx()
line1 = ax2.plot(x_positions, biodiversity_index, color='deepskyblue', lw=2, marker='o', label='Biodiversity')
line2 = ax2.plot(x_positions, coral_reef_quality, color='coral', lw=2, marker='s', label='Coral Quality')
