...
solar_energy = np.array([10, 40, 20, 150, 80, 600, 250, 400, 950, 1000, 800])  # Shuffled content
wind_energy = np.array([15, 50, 30, 140, 90, 450, 220, 320, 750, 900, 600])  # Shuffled content
solar_workforce = np.array([2, 6, 4, 16, 10, 50, 25, 35, 80, 90, 65])  # Shuffled content
wind_workforce = np.array([3, 8, 5, 18, 12, 52, 27, 38, 85, 100, 70])  # Shuffled content
