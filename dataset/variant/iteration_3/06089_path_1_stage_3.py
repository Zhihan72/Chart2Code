...
bars1 = ax.bar(index, production_capacities, bar_width, label='Production Capacity', color='gold', alpha=0.9, edgecolor='black', hatch='/')
bars2 = ax.bar(index + bar_width, energy_consumptions, bar_width, label='Energy Consumption', color='lightgreen', alpha=0.9, edgecolor='red', hatch='x')
bars3 = ax.bar(index + 2 * bar_width, targets, bar_width, label='Production Target', color='purple', alpha=0.9, edgecolor='blue', hatch='\\')
