...
# Main line plot with consistent color
...
# Annotate milestones consistently using blue color
for year, event in milestones.items():
    ...
    ax.annotate(
        ...
        color='black', fontsize=9, ha='right', bbox=dict(boxstyle="round,pad=0.3", edgecolor='blue', facecolor='lightyellow')
    )
