...
plt.plot(years, traditional_energy, label='Traditional', color='green', linestyle='-', linewidth=2)
plt.plot(years, solar_energy, label='Solar', color='orange', linestyle='--', linewidth=2)
plt.plot(years, wind_energy, label='Wind', color='blue', linestyle='-.', linewidth=2)
plt.plot(years, hydro_energy, label='Hydro', color='purple', linestyle=':', linewidth=2)
...
# Legend and Grid
plt.legend(loc='upper right', fontsize=10, title='Sources')
