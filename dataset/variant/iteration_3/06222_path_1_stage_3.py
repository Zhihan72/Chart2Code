...
# Altered colors and line styles for variation
ax.stackplot(years, data, labels=['IG', 'SC', 'FB', 'TW', 'TT'], 
             colors=['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd'], alpha=0.8, linestyle='-.')
