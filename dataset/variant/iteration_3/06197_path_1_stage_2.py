...
ax[0].bar(x_indexes - bar_width, plastic_recycling, width=bar_width, color='#33FF57', alpha=0.8)
ax[0].bar(x_indexes, glass_recycling, width=bar_width, color='#FFD700', alpha=0.8)
ax[0].bar(x_indexes + bar_width, metal_recycling, width=bar_width, color='#FF5733', alpha=0.8)
ax[0].bar(x_indexes + 2*bar_width, paper_recycling, width=bar_width, color='#3357FF', alpha=0.8)
