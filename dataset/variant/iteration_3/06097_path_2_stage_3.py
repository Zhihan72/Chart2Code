...
candies = ['Bright Chocolate', 'Milky Chocolate', 'Light Chocolate']
...
ax1.bar(x, light_chocolate, bottom=np.array(bright_chocolate) + np.array(milky_chocolate), color=colors[2], edgecolor='grey', label='Light Chocolate', linestyle='--')
