...
# Adjusted colors and defined bars
bars1 = ax.bar(index, production_capacities, bar_width, label='Prod Cap.', color='gold', alpha=0.9, edgecolor='black', hatch='/')
bars2 = ax.bar(index + bar_width, energy_consumptions, bar_width, label='Cons.', color='lightgreen', alpha=0.9, edgecolor='red', hatch='x')
bars3 = ax.bar(index + 2 * bar_width, targets, bar_width, label='Target', color='purple', alpha=0.9, edgecolor='blue', hatch='\\')

# Shortened title, labels, and legend
ax.set_title('Energy Prod vs. Cons\n(2021-2030)', fontsize=16, fontweight='heavy')
