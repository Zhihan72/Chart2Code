...
# Area chart for monthly rainfall with a shuffled color
ax1.fill_between(months, rainfall, color='orange', alpha=0.6, label='Rainfall (mm)')
...
# Line chart for average monthly temperature with a shuffled color
ax2.plot(months, temperature, color='skyblue', marker='o', linestyle='-', linewidth=2, markersize=5, label='Temperature (°C)')
