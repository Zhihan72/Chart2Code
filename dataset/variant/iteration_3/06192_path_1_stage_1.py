...
# Data: Population in millions over three decades for six cities
...
bar_positions = np.arange(len(years))  # Generate the bar positions for each city

# Plotting data for each city as groups using a single color
