...
# Define years and shuffled regions
...
adoption_rates = np.array([
    [8, 9, 13, 14, 18, 19, 22, 25, 27, 30, 31],   # Europe
    [3, 6, 7, 8, 11, 15, 16, 18, 21, 23, 25],     # South America
    [3, 3, 4, 5, 8, 9, 10, 14, 15, 19, 20],       # Africa
    [5, 8, 11, 12, 14, 16, 19, 23, 25, 27, 29],   # North America
    [10, 13, 18, 22, 24, 30, 32, 33, 40, 41, 44], # Asia
    [7, 8, 10, 13, 17, 17, 22, 22, 26, 27, 31],   # Australia
    [4, 6, 8, 9, 12, 13, 16, 18, 21, 21, 24]      # Middle East
])

# Manually altered Efficiency improvement data (%/year)
efficiency_improvement = np.array([
    [0.5, 0.8, 0.9, 1.2, 1.4, 1.5, 1.7, 1.9, 2.3, 2.4, 2.6],  # Europe
    [0.5, 0.4, 0.7, 0.9, 1.1, 1.1, 1.4, 1.7, 2.1, 2.0, 2.5],  # South America
    [0.3, 0.5, 0.5, 0.6, 0.9, 0.8, 1.1, 1.3, 1.3, 1.6, 1.7],  # Africa
    [0.4, 0.6, 0.9, 1.0, 1.2, 1.3, 1.4, 1.8, 1.9, 2.0, 2.1],  # North America
    [0.6, 0.9, 1.0, 1.3, 1.5, 1.7, 2.2, 2.3, 2.5, 2.9, 3.0],  # Asia
    [0.4, 0.6, 0.9, 1.1, 1.3, 1.5, 1.6, 1.8, 2.0, 2.3, 2.6],  # Australia
    [0.5, 0.6, 0.8, 0.9, 0.9, 1.2, 1.5, 1.7, 1.8, 2.1, 2.4]   # Middle East
])
...
axs[0].set_yticklabels(['Eur', 'S.Am', 'Afr', 'N.Am', 'Asia', 'Oz', 'M.E'])
...
axs[1].set_yticklabels(['Eur', 'S.Am', 'Afr', 'N.Am', 'Asia', 'Oz', 'M.E'])
for i in range(len(regions)):
    for j in range(len(years)):
