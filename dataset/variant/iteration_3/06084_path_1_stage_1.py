...
# Randomly altered division names and labels
divisions = ['Eurasia', 'Oceania', 'Pan Africa', 'Latin America', 'USA-Canada', 'EuroZone']
years = [2018, 2019, 2020, 2021, 2022]

# Production values remain the same for a consistent test analysis
production = np.array([
    [20, 21, 23, 24, 26],  # USA-Canada
    [18, 19, 22, 23, 25],  # EuroZone
    [15, 17, 20, 21, 23],  # Eurasia
    [12, 14, 16, 18, 19],  # Pan Africa
    [10, 13, 15, 17, 18],  # Oceania
    [8, 10, 12, 13, 14],   # Latin America
])
...
# Titles and labels altered with irrelevant names
...
# Adjust X-axis with new division names
