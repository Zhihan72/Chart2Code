...
ax1.plot(hours, cluster_A, color='blue', linewidth=2, linestyle='-')
ax1.plot(hours, cluster_B, color='green', linewidth=2, linestyle='-.')
ax1.plot(hours, cluster_C, color='red', linewidth=2, linestyle=':')

# Plot the average CPU usage line
ax1.plot(hours, average_cpu_usage, color='purple', linestyle='--', linewidth=2)
