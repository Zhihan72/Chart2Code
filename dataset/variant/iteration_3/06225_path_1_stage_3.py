...
# Original data points remain the same
...
# Plot with altered labels
plt.plot(months, adults_steps, color='tab:blue', linestyle='--', marker='s', linewidth=2, label='Younger Adults')
plt.plot(months, seniors_steps, color='tab:red', linestyle='-.', marker='^', linewidth=2, label='Elderly')
