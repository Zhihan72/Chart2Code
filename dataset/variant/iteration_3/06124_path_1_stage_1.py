...
# Plot the data
for data, name, marker in zip([teens, twenties, thirties, forties, fifties_plus, seniors], age_groups, markers):
    ax.plot(years, data, label=name, color=single_color, marker=marker, linewidth=2, linestyle='-')
    # Annotate end points
