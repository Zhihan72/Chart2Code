...
current_share = [20, 30, 25, 10, 15]  # Randomly altered
future_share = [30, 15, 25, 20, 10]   # Randomly altered
colors = ['#FFD700', '#00BFFF', '#32CD32', '#FFA07A', '#8A2BE2']
explode = (0.05, 0.1, 0.05, 0.05, 0)  # Randomly altered
...
rects1 = ax2.barh(index, current_share, bar_width, color=colors, edgecolor='black')
rects2 = ax2.barh(index + bar_width, future_share, bar_width, color='#ADD8E6', edgecolor='black')
