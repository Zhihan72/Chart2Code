...
new_colors = ['purple', 'yellow', 'orange', 'blue']
new_markers = ['o', 's', 'D', '^']
new_line_styles = ['-', '--', '-.', ':']

for ax_, season, data, color, marker, linestyle in zip(ax.flatten(), seasons, wind_speed_data, new_colors, new_markers, new_line_styles):
