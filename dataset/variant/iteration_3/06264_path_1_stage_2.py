...
# Randomly altered food consumption data (preserving structure but shuffling contents)
...
ax.stackplot(years, data, labels=['Edibles', 'Herbs', 'Proteins', 'Milk Products'], colors=colors, alpha=0.8)
