...
ax1.bar(months_indices - 2*width, colony_alpha, width, edgecolor='black', color=colors[0], alpha=0.7)
ax1.bar(months_indices - width, colony_beta, width, edgecolor='black', color=colors[1], alpha=0.7)
ax1.bar(months_indices, colony_gamma, width, edgecolor='black', color=colors[2], alpha=0.7)
ax1.bar(months_indices + width, colony_delta, width, edgecolor='black', color=colors[3], alpha=0.7)
ax1.bar(months_indices + 2*width, colony_epsilon, width, edgecolor='black', color=colors[4], alpha=0.7)
