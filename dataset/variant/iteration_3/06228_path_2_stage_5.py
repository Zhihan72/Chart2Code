...
for city in cities:
    ...
    ax2.plot(quarters, temperatures, marker='o', color='blue')  # Changed color to blue

ax1.scatter(tree_coverage, AQI_levels, color='blue', s=100, alpha=0.8, # Changed color to blue
