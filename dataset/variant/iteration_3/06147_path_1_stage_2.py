...
# Create a stacked bar chart with shuffled colors
# Shuffled colors scheme
ax.bar(bar_positions, coffee_preference, bar_width, color='#CD853F', label='Coffee')
ax.bar(bar_positions, tea_preference, bar_width, bottom=coffee_preference, color='#FBC02D', label='Tea')
ax.bar(bar_positions, juice_preference, bar_width, bottom=np.array(coffee_preference) + np.array(tea_preference), color='#8B4513', label='Juice')
