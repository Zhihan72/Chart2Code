...
ax.barh(y_pos - 1.5 * bar_width, reusable_bags, bar_width, label='Bags', color=colors[0])
ax.barh(y_pos - 0.5 * bar_width, solar_chargers, bar_width, label='Chargers', color=colors[1])
ax.barh(y_pos + 0.5 * bar_width, bamboo_toothbrushes, bar_width, label='Brushes', color=colors[2])
ax.barh(y_pos + 1.5 * bar_width, eco_water_bottles, bar_width, label='Bottles', color=colors[3])
