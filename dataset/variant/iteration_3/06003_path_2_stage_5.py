...
# Apply a consistent color across all data groups
common_color = 'dodgerblue'

bars_2020 = ax.barh(y - width, budget_2020, height=width, color=common_color, label='2020')
bars_2021 = ax.barh(y, budget_2021, height=width, color=common_color, label='2021')
bars_2022 = ax.barh(y + width, budget_2022, height=width, color=common_color, label='2022')
