...
shuffled_colors = [
    (0.993248, 0.906157, 0.143936, 1.0),  # Yellowish part
    (0.127568, 0.566949, 0.550556, 1.0),  # Teal part
    (0.993248, 0.906157, 0.143936, 1.0),  # Yellowish part
    (0.267004, 0.004874, 0.329415, 1.0),  # Purple part
    (0.26851, 0.009605, 0.335427, 1.0),   # Slightly different purple
    (0.993248, 0.906157, 0.143936, 1.0),  # Yellowish part
    (0.127568, 0.566949, 0.550556, 1.0),  # Teal part
    (0.993248, 0.906157, 0.143936, 1.0),  # Yellowish part
    (0.280267, 0.165302, 0.470647, 1.0),  # Dark blue part
    (0.127568, 0.566949, 0.550556, 1.0)   # Teal part
]
