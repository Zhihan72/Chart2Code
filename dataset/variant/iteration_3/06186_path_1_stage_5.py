...
# First subplot
ax[0].bar(year_indices - bar_width/2, smartphones_sales, width=bar_width, color='seagreen')
ax[0].bar(year_indices + bar_width/2, laptops_sales, width=bar_width, color='royalblue')
...
ax[0].set_xticklabels(['18', '19', '20', '21', '22'])
...
ax[1].pie(revenues_2022, autopct='%1.1f%%', startangle=140, colors=colors, explode=explode, wedgeprops={'edgecolor': 'black', 'linewidth': 1.5})
