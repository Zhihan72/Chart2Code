...
# Randomly altered line styles, colors, and markers
...
ax1.legend(loc='lower right', fontsize=10)  # Changed legend location and fontsize
ax1.grid(True, linestyle='-', alpha=0.3)  # Changed grid style and transparency

ax1.annotate('Significant Uptake Post-2025', xy=(2025, 150), xytext=(2030, 300),
             arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=12)

expansion_projects_urban_parks = [1, 3, 2, 8, 5, 13, 21, 34, 55, 144, 89, 233]
expansion_projects_roof_gardens = [1, 2, 1, 5, 3, 8, 13, 21, 34, 89, 55, 144]
expansion_projects_green_walls = [1, 2, 1, 3, 5, 8, 13, 13, 21, 34, 55, 89]

decades = np.arange(2000, 2060, 5)
width = 8

# Changed bar colors and styles
ax2.bar(decades - width, expansion_projects_urban_parks, width, label='Urban Parks', color='#7F91C0', hatch='/')
ax2.bar(decades, expansion_projects_roof_gardens, width, label='Roof Gardens', color='#D88C9A', hatch='\\')
ax2.bar(decades + width, expansion_projects_green_walls, width, label='Green Walls', color='#97C891', hatch='|')
...
ax2.legend(loc='upper left', fontsize=11)  # Changed legend fontsize
ax2.grid(False)  # Removed grid for the second subplot
