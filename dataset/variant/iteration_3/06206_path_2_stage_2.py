...
# Additional data series for scooters and carpooling
...
ax.plot(years, scooters, label='Scooters', color='purple', marker='x', linestyle='-', linewidth=2, markersize=6)
ax.plot(years, carpool, label='Carpool', color='brown', marker='*', linestyle='--', linewidth=2, markersize=6)
