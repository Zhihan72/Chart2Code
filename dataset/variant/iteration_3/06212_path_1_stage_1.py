...
# Biomass data (in arbitrary units) for each ecosystem over four quarters, excluding "Wetland"
...
# Aggregating data for Box Plot, excluding "Wetland"
biomass_data = [
    forest_biomass,
    grassland_biomass,
    desert_biomass,
...
# Labels for each ecosystem, excluding "Wetland"
...
# Customizing colors for each box, excluding "Wetland"
colors = ['lightgreen', 'lightskyblue', 'lightgoldenrodyellow', 'lightpink']
...
# Add legend manually, excluding "Wetland"
...
# Adding annotations for each ecosystem with the maximum variation's quarter, excluding "Wetland"
annotations = [
