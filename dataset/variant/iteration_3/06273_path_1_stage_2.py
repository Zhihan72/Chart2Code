...
ax1.bar(X, alice_genres, width=bar_width, label='Alice', color='lightcoral')
ax1.bar(X + bar_width, bob_genres, width=bar_width, label='Bob', color='lightblue')
ax1.bar(X + 2 * bar_width, charlie_genres, width=bar_width, label='Charlie', color='lightgreen')
ax1.bar(X + 3 * bar_width, diana_genres, width=bar_width, label='Diana', color='lightyellow')
