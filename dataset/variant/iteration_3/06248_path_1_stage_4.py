...
ax1.barh(y_positions - bar_height/2, seagrass_coverage, bar_height, label='Seagrass Coverage', color='mediumaquamarine')

ax2 = ax1.twiny()

ax2.plot(biodiversity_index, y_positions, color='royalblue', lw=2, marker='v', linestyle='--', label='Biodiversity')
ax2.plot(coral_reef_quality, y_positions, color='tomato', lw=2, marker='d', linestyle='-.', label='Coral Quality')
...
ax1.set_xlabel("Seagrass (km²)", fontsize=14, color='mediumaquamarine')
ax2.set_xlabel("Index", fontsize=14, color='royalblue')

ax1.set_yticks(y_positions)
ax1.set_yticklabels(zones, rotation=0, fontsize=12)
ax1.xaxis.set_tick_params(labelcolor='mediumaquamarine')
ax2.xaxis.set_tick_params(labelcolor='royalblue')
