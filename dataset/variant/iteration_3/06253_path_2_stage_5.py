...
module_colors = {
    "Command Center": "blue",  # Changed from "orange"
    "Habitat Module": "red",   # Changed from "purple"
    "Research Lab": "green",   # Changed from "red"
    "Satellite Uplink": "brown", # Changed from "blue"
    "Rover Operations": "purple", # Changed from "green"
    "Power Plant": "orange"    # Changed from "brown"
}
