...
# We are removing the data for 'London'
cities = ['Tokyo', 'Cairo', 'Sydney', 'New York']
...
ax.set_title('Climatic Differences of Urban Jungles', fontsize=16, fontweight='bold')
ax.set_ylabel('Heat Measure (Celsius)', fontsize=14)
ax.yaxis.grid(True, linestyle=':', which='major', color='purple', alpha=0.5)

colors = ['lavender', 'peachpuff', 'lemonchiffon', 'papayawhip']
