...
axs[0, 1].pie([40, 30, 30], labels=['Germany', 'UK', 'France'], autopct='%1.1f%%', colors=['olivedrab', 'darkolivegreen', 'yellowgreen'])
axs[0, 1].set_title('EU CO2 Split (2022)', fontsize=14)

axs[0, 2].pie([50, 30, 20], labels=['China', 'India', 'Japan'], autopct='%1.1f%%', colors=['crimson', 'firebrick', 'lightcoral'])
