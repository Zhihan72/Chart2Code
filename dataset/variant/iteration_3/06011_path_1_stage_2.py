...
ax.barh(regions, apples, label='Red Apples', color='#FF6347')
ax.barh(regions, oranges, left=apples, label='Orange Citrus', color='#FFA500')
ax.barh(regions, grapes, left=np.array(apples) + np.array(oranges), label='Purple Grapes', color='#9370DB')
