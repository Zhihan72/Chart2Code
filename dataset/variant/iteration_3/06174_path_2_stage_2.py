...
bars1 = ax1.barh(y - 1.5*height, q1_sales, height, label='Q1', color='steelblue', hatch='/', edgecolor='navy')
bars2 = ax1.barh(y - 0.5*height, q2_sales, height, label='Q2', color='darkorange', hatch='\\', edgecolor='tan')
bars3 = ax1.barh(y + 0.5*height, q3_sales, height, label='Q3', color='forestgreen', hatch='-', edgecolor='darkgreen')
bars4 = ax1.barh(y + 1.5*height, q4_sales, height, label='Q4', color='firebrick', hatch='|', edgecolor='maroon')
