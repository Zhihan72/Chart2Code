...
plt.errorbar(months, marketing_performance, yerr=marketing_error, fmt='-o', label='Marketing',
             color='royalblue', linestyle='-', linewidth=2, capsize=4, elinewidth=1.0, alpha=0.9)
plt.errorbar(months, finance_performance, yerr=finance_error, fmt='-s', label='Finance',
