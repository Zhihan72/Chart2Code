...
axs[0].set_title('Solar Panel Efficiency Improvement (%/year)\n(2011-2021)', fontsize=16, weight='bold')
...
cbar1.set_label('Efficiency Improvement (%/year)', rotation=270, labelpad=20)

# Heatmap for Adoption Rates
im2 = axs[1].imshow(adoption_rates, cmap='YlGnBu', aspect='auto')

# Annotate and label the heatmap
axs[1].set_title('Solar Panel Adoption Rates (%)\n(2011-2021)', fontsize=16, weight='bold')
...
cbar2.set_label('Adoption Rate (%)', rotation=270, labelpad=20)
