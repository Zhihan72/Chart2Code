...
ax.plot(years, atlantic_anomalies, color='blue', marker='o', markersize=5, linewidth=2)
ax.plot(years, pacific_anomalies, color='green', marker='^', markersize=5, linewidth=2)
ax.plot(years, indian_anomalies, color='red', marker='s', markersize=5, linewidth=2)
