...
ax.plot(angles, neptune_academy, linewidth=2, linestyle='-', label='Neptune Academy', color=single_color, marker='o')
ax.fill(angles, neptune_academy, single_color, alpha=0.15)

ax.plot(angles, mars_academy, linewidth=2, linestyle='-', label='Mars Academy', color=single_color, marker='s')
ax.fill(angles, mars_academy, single_color, alpha=0.15)

ax.plot(angles, jupiter_academy, linewidth=2, linestyle='-', label='Jupiter Academy', color=single_color, marker='^')
ax.fill(angles, jupiter_academy, single_color, alpha=0.15)
