...
ax.plot(months, heating, marker='o', linestyle='-', color='b', linewidth=2, label='Heating')
ax.plot(months, cooling, marker='s', linestyle='--', color='g', linewidth=2, label='Cooling')
ax.plot(months, lighting, marker='^', linestyle='-.', color='m', linewidth=2, label='Lighting')
ax.plot(months, appliances, marker='d', linestyle=':', color='c', linewidth=2, label='Appliances')
ax.plot(months, monthly_savings, marker='*', linestyle='-', color='r', linewidth=2, label='Savings')
