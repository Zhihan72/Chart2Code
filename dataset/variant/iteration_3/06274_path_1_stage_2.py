...
ax.plot(years, tiger_population, marker='*', linestyle='--', color='red', linewidth=2, markersize=8, label='Tigers')
ax.plot(years, panda_population, marker='d', linestyle='-.', color='purple', linewidth=2, markersize=8, label='Pandas')
ax.plot(years, rhino_population, marker='+', linestyle=':', color='blue', linewidth=2, markersize=8, label='Rhinos')
