...
# Removed Apollo 14 mission from the data
missions = ['Apollo 11', 'Apollo 12', 'Apollo 15', 'Apollo 16', 'Apollo 17']
daytime_highs = np.array([127, 123, 125, 127, 128])
nighttime_lows = np.array([-153, -155, -157, -155, -156])
