...
plt.plot(months, san_francisco_temps, marker='o', linestyle='-', label='San Francisco', color='cyan')
plt.plot(months, new_york_temps, marker='s', linestyle='-', label='New York', color='magenta')
plt.plot(months, miami_temps, marker='^', linestyle='-', label='Miami', color='yellow')
plt.plot(months, seattle_temps, marker='D', linestyle='-', label='Seattle', color='brown')
plt.plot(months, san_diego_temps, marker='x', linestyle='-', label='San Diego', color='pink')
