...
reusable_bags = [950, 1100, 800, 1200]  # Altered positions
solar_chargers = [920, 700, 750, 850]   # Altered positions
bamboo_toothbrushes = [610, 720, 580, 530]  # Altered positions
