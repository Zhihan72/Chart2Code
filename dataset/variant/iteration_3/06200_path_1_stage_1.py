...
# Additional data
gov_incentives = [5, 10, 20, 30, 50, 70, 90, 120, 150, 180, 220]  # In millions
charging_stations = [10, 15, 25, 35, 50, 70, 90, 115, 145, 180, 220]  # Number of stations
...
ax2.plot(years, gov_incentives, color='orange', linestyle='-', marker='s', linewidth=2, markersize=8, label='Gov Incentives (in millions)')

# Plotting Charging Stations Installed
ax2.plot(years, charging_stations, color='red', linestyle='-.', marker='^', linewidth=2, markersize=8, label='Charging Stations')
