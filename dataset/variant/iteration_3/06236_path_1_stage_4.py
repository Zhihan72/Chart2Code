...
# Plot for weekly averages with style alterations
axs[0].barh(range(len(data)), np.mean(data, axis=1), color=['#FFB6C1', '#87CEFA', '#98FB98', '#FFDAB9'])
...
# Diverging bar chart with style alterations
x = np.arange(len(days))
colors = ['#FFB6C1', '#87CEFA', '#98FB98', '#FFDAB9']
