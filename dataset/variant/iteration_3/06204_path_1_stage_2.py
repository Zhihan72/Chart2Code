...
# Apply a single color 'black' across all data groups
ax1.plot(years, usa_missions, label='USA', marker='o', linestyle='-', color='black', linewidth=2, markersize=8)
ax1.plot(years, russia_missions, label='Russia', marker='d', linestyle='--', color='black', linewidth=2, markersize=8)
ax1.plot(years, china_missions, label='China', marker='s', linestyle='-.', color='black', linewidth=2, markersize=8)

ax2 = ax1.twinx()
ax2.plot(years, total_missions, label='Total Missions', color='black', linestyle='-', marker='v', linewidth=3, markersize=10, alpha=0.6)
