...
# Plot internet users
ax1.plot(years, internet_users, marker='o', linestyle='-', linewidth=2, color='blue', label='Net Users (Billions)')
...
ax2 = ax1.twinx()
ax2.plot(years, bandwidth_usage, marker='s', linestyle='-', linewidth=2, color='green', label='Data Traffic (Exabytes)')
...
ax1.set_ylabel("Web Users (Billions)", fontsize=14, color='blue')
ax2.set_ylabel("Data Usage (Exabytes)", fontsize=14, color='green')
