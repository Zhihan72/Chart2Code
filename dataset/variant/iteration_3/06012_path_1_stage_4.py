...
# Titles and labels modified
ax.set_title('Stellar Brightness - Styled Again!', fontsize=18, fontweight='light')
ax.set_xlabel('Star Index', fontsize=11, style='italic')
ax.set_ylabel('Brightness (Absolute Magnitude)', fontsize=11, style='italic')
ax.invert_yaxis()

# Alter legends and grids
ax.legend(['Brightness'], loc='upper right', fontsize=10, title='Legend', title_fontsize='11')
