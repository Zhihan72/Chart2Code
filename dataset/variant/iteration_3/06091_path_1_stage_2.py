...
ax.plot(decades, key_point_1, 'o-', label='Key Point 1', color='green')
ax.plot(decades, key_point_2, 's-', label='Key Point 2', color='green')
ax.plot(decades, key_point_4, 'd-', label='Key Point 4', color='green')

ax2 = ax.twinx()
ax2.plot(decades, conservation_efforts, 'o--', color='green', label='Conservation Efforts Effectiveness')
...
ax2.set_ylabel('Conservation Efforts Effectiveness (%)', fontsize=12, color='green')
