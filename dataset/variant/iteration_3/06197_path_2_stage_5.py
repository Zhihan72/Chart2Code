...
ax[0].barh(x_indexes, paper_percentage, color='#FFD700')
ax[0].barh(x_indexes, -plastic_percentage, color='#FF5733')
ax[0].barh(x_indexes, -glass_percentage, color='#33FF57', left=-plastic_percentage)

ax[0].set_yticks(x_indexes)

ax[1].barh(x_indexes, paper_recycling, color='#FFD700')
ax[1].barh(x_indexes, -plastic_recycling, color='#FF5733')
ax[1].barh(x_indexes, -glass_recycling, color='#33FF57', left=-plastic_recycling)
