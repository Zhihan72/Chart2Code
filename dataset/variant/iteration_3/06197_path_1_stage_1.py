...
ax[0].bar(x_indexes - bar_width, plastic_recycling, width=bar_width, color='#33FF57', label='Plastic', alpha=0.8)  # changed color
ax[0].bar(x_indexes, glass_recycling, width=bar_width, color='#FFD700', label='Glass', alpha=0.8)                  # changed color
ax[0].bar(x_indexes + bar_width, metal_recycling, width=bar_width, color='#FF5733', label='Metal', alpha=0.8)     # changed color
ax[0].bar(x_indexes + 2*bar_width, paper_recycling, width=bar_width, color='#3357FF', label='Paper', alpha=0.8)   # changed color
...
ax[1].bar(months, plastic_percentage, color='#33FF57', label='Plastic', alpha=0.8)  # changed color
ax[1].bar(months, glass_percentage, bottom=plastic_percentage, color='#FFD700', label='Glass', alpha=0.8)         # changed color
ax[1].bar(months, metal_percentage, bottom=plastic_percentage+glass_percentage, color='#FF5733', label='Metal', alpha=0.8)  # changed color
ax[1].bar(months, paper_percentage, bottom=plastic_percentage+glass_percentage+metal_percentage, color='#3357FF', label='Paper', alpha=0.8)  # changed color
