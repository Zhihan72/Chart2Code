...
# Updated colors: blue for coffee and green for tea
ax.bar(bar_positions, -coffee_preference, bar_width, bottom=coffee_start, color='#1f77b4')  # Blue
ax.bar(bar_positions, tea_preference, bar_width, bottom=tea_start, color='#2ca02c')  # Green
