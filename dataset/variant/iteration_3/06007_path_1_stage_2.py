...
# Shuffling the colors for each data series
ax.plot(years, drama_viewership, '-o', label='Drama', color='orange', linewidth=2, markersize=6)
ax.plot(years, comedy_viewership, '-s', label='Comedy', color='green', linewidth=2, markersize=6)
ax.plot(years, scifi_viewership, '-^', label='Sci-Fi', color='purple', linewidth=2, markersize=6)
ax.plot(years, horror_viewership, '-d', label='Horror', color='blue', linewidth=2, markersize=6)
ax.plot(years, fantasy_viewership, '-p', label='Fantasy', color='red', linewidth=2, markersize=6)
