...
plt.scatter(exercise_hours_A, happiness_scores_A, color='green', s=100, alpha=0.75, edgecolor='black')
plt.scatter(exercise_hours_B, happiness_scores_B, color='blue', s=100, alpha=0.75, edgecolor='black')
...
plt.plot(x_fit_A, y_fit_A, color='orange', linestyle='--', linewidth=2)
...
plt.plot(x_fit_B, y_fit_B, color='red', linestyle='--', linewidth=2)
