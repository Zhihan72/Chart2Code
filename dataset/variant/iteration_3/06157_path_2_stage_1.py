...
ax1.plot(years, smart_features, marker='o', linestyle='-', color='royalblue', linewidth=2)
...
ax1.axvspan(2022, 2027, alpha=0.1, color='purple')
ax1.axvspan(2030, 2035, alpha=0.1, color='orange')

ax2.plot(years, investment_proportion, marker='s', linestyle='--', color='seagreen', linewidth=2)
