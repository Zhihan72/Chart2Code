...
bar1 = ax.barh(r1, sales_jan, color='skyblue', height=bar_height, edgecolor='black', label='Jan')
bar2 = ax.barh(r2, sales_feb, color='gold', height=bar_height, edgecolor='black', label='Feb')
bar3 = ax.barh(r3, sales_mar, color='lime', height=bar_height, edgecolor='black', label='Mar')
bar4 = ax.barh(r4, sales_apr, color='salmon', height=bar_height, edgecolor='black', label='Apr')
bar5 = ax.barh(r5, sales_may, color='violet', height=bar_height, edgecolor='black', label='May')

# Altering the grid style
