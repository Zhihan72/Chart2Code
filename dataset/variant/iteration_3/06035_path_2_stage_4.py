...
screen_time_data = {
    '12-13 years': np.array([3.4, 3.2, 4.2, 4.0, 4.5]),
    '14-15 years': np.array([4.3, 3.7, 3.5, 4.8, 4.5]),
    '16-17 years': np.array([4.7, 5.2, 4.0, 4.2, 4.9])
}

# Calculate the middle value for diverging effect
...
ax.set_xlabel('Deviation from Average Screen Time (Hours per Day)', fontsize=12)
ax.set_title('Diverging Bar Chart of Average Daily Screen Time of Teenagers (2018-2022)', fontsize=14, fontweight='bold')
ax.set_yticks(years)
