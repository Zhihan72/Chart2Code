...
# Plot data for two lunar probes using the same color
common_color = 'royalblue'
ax1.plot(days, probe_A, ':x', label='Unit Alpha', color=common_color, markersize=8, linewidth=2, markerfacecolor='none')
ax1.plot(days, probe_B, '--^', label='Unit Bravo', color=common_color, markersize=8, linewidth=2, markerfacecolor='darkblue')
