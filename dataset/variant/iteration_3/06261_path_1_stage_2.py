...
ax.plot(years, deer_growth, marker='D', linestyle=':', color='#00FF00', linewidth=2, label='Wildlife Numbers')
...
# Annotating with shuffled colors
for growth, label, color in zip(
        [oak_growth, pine_growth, maple_growth, deer_growth, bird_growth],
        ['Bark Trees', 'Conifer Trees', 'Liquid Trees', 'Wildlife Numbers', 'Avian Numbers'],
        ['#1E90FF', '#8A2BE2', '#FF4500', '#00FF00', '#FFA500']):
