...
ax2 = ax1.twinx()
ax2.plot(sleep_hours, activity_levels, color='purple', marker='o', linestyle='-', label='Activity Level')  # Changed color from 'green' to 'purple'
ax2.set_ylabel('Physical Activity Level', fontsize=12, color='purple')
