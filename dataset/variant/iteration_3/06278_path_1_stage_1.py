...
# Single color for bars and line
consistent_color = '#4682B4'

# Create the figure and axis
fig, ax1 = plt.subplots(figsize=(10, 6))

# Bar chart for number of wins with consistent color
bars = ax1.bar(sports, wins, color=consistent_color, alpha=0.7)

# Line plot for average scores with consistent color
ax2 = ax1.twinx()
ax2.plot(sports, avg_scores, color=consistent_color, marker='o', linestyle='-', linewidth=2, label='Average Scores')
...
ax2.set_ylabel('Average Scores', fontsize=12, color=consistent_color)
...
for i, value in enumerate(avg_scores):
    ax2.text(i, value + 0.5, f'{value}', color=consistent_color, fontsize=10, ha='center', va='bottom')
