...
axs[0].plot(years, delta_a_pollution, color='purple', linestyle='-', linewidth=2, label='Delta A')
axs[0].plot(years, delta_b_pollution, color='red', linestyle='--', linewidth=2, label='Delta B')
axs[0].plot(years, delta_c_pollution, color='orange', linestyle='-.', linewidth=2, label='Delta C')
...
axs[2].plot(years, delta_a_water_clarity, color='lime', linestyle='-', linewidth=2, label='Delta A')
axs[2].plot(years, delta_b_water_clarity, color='cyan', linestyle='--', linewidth=2, label='Delta B')
axs[2].plot(years, delta_c_water_clarity, color='magenta', linestyle='-.', linewidth=2, label='Delta C')
