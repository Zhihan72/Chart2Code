...
# Data: Activities and their corresponding percentage shares (added additional data)
activities = ['Social Media', 'Entertainment', 'Online Shopping', 'Education', 'Work', 'News Reading', 'Other', 'Gaming', 'Fitness']
percentages = [28, 18, 14, 9, 9, 8, 5, 6, 3]
