...
ax1.set_title('Renewable Energy Growth (1990-2020)', 
...
ax2.plot(years, total_energy_percentage, color='purple', linestyle='--', marker='o', linewidth=2, label='Energy Util (%)')
ax2.set_ylabel('Utilization (%)', fontsize=14)

ax1.legend(loc='upper left', title='Sources', fontsize=12, title_fontsize='13')
ax2.legend(loc='upper right', fontsize=12)

milestones = {
    2000: (total_energy_percentage[2], '20% Util.'),
    2015: (total_energy_percentage[5], '70% Util.'),
    2020: (total_energy_percentage[6], '85% Util.')
}
