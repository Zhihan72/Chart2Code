...
# Updated list of kingdoms to include 'Sky' and 'Deep'
kingdoms = [
...
# Added new relationships, including 'Sky' and 'Deep'
relationships = [
    ("North", "River", 8),
    ("River", "High", 5),
    ("High", "Wood", -7),
...
# Updated node_colors to accommodate new nodes
node_colors = ['palegreen', 'lightcoral', 'lightskyblue', 'thistle', 
               'khaki', 'lightpink', 'peachpuff', 'lightcyan', 'lavender', 'lightsteelblue']
