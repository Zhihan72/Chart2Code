...
expenses = [3, 3.5, 3.5, 4, 4, 4.5, 5, 5.5, 6, 6.5]
...
bar_width = 0.4
ax1.bar(years - bar_width/2, revenues, width=bar_width, color='darkorange', label='Revenue ($ billion)')
ax1.bar(years + bar_width/2, expenses, width=bar_width, color='royalblue', label='Expense ($ billion)')
