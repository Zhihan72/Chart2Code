...
# Changed colors for scatter plot and trend line
scatter = ax1.scatter(coffee_consumption, lines_of_code, color='deepskyblue', edgecolors='black', s=100, zorder=2)
...
trend = ax1.plot(trendline_x, trendline_y, color='tomato', linestyle='-', linewidth=2, zorder=1)
