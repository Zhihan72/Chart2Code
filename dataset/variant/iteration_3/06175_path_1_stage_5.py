...
# Altered activity labels
weekend_activities = ['Reading', 'Gaming', 'Traveling', 'Socializing', 'Watching TV', 'Outdoor Sports', 'Others', 'Cooking']
weekend_percentages = [7, 3, 8, 12, 10, 15, 20, 25]
weekday_percentages = [5, 10, 5, 10, 15, 20, 5, 30]

# Consistent single color
single_color = '#69b3a2'
...
ax2.set_xlabel('Daily Activities', fontsize=12)
ax2.set_ylabel('Proportion (%)', fontsize=12)
ax2.set_title('Activity Preferences: Weekdays and Weekends', fontsize=14, weight='bold', pad=25)

# Adjusted x-tick labels order
ax2.set_xticks(x)
