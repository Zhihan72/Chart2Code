...
solarlandia_renewables = [28, 19, 22, 15, 40, 34, 17, 37, 31, 25]
windtopia_renewables = [11, 30, 22, 13, 10, 35, 15, 28, 25, 18]
hydroville_renewables = [21, 32, 25, 30, 26, 23, 36, 20, 28, 34]
geothermia_renewables = [12, 9, 5, 25, 30, 28, 15, 18, 7, 22]

plt.figure(figsize=(14, 8))

plt.plot(years, solarlandia_renewables, marker='o', linestyle='-', linewidth=2, color='red')
plt.plot(years, windtopia_renewables, marker='s', linestyle='--', linewidth=2, color='cyan')
plt.plot(years, hydroville_renewables, marker='^', linestyle='-.', linewidth=2, color='magenta')
plt.plot(years, geothermia_renewables, marker='d', linestyle=':', linewidth=2, color='yellow')

plt.title("Renewable Energy Surge in Various Nations (2011-2020)", fontsize=16, fontweight='bold', pad=20)
...
plt.annotate(f'{max_windtopia}%', xy=(years[np.argmax(windtopia_renewables)], max_windtopia), 
             ...
             arrowprops=dict(facecolor='cyan', shrink=0.05), fontsize=10, color='cyan')
...
plt.annotate(f'{max_geothermia}%', xy=(years[np.argmax(geothermia_renewables)], max_geothermia), 
             ...
             arrowprops=dict(facecolor='yellow', shrink=0.05), fontsize=10, color='yellow')
