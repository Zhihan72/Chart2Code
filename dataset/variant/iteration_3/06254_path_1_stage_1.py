...
plt.scatter(green_space_per_capita_orig, happiness_index_orig, color='forestgreen', edgecolors='black', s=150, alpha=0.7, label='Original Cities')
plt.scatter(green_space_per_capita_add, happiness_index_add, color='royalblue', edgecolors='black', s=150, alpha=0.7, label='Additional Cities')
...
# Add trend lines for both groups (linear regression)
m_orig, b_orig = np.polyfit(green_space_per_capita_orig, happiness_index_orig, 1)
plt.plot(green_space_per_capita_orig, m_orig * green_space_per_capita_orig + b_orig, color='darkorange', linestyle='--', linewidth=2, label='Trend Line - Original')

m_add, b_add = np.polyfit(green_space_per_capita_add, happiness_index_add, 1)
plt.plot(green_space_per_capita_add, m_add * green_space_per_capita_add + b_add, color='firebrick', linestyle='--', linewidth=2, label='Trend Line - Additional')
