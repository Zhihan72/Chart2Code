...
ax.plot(mars_day, north_temp, marker='d', color='green', label='North', linestyle='-', linewidth=2)
ax.plot(mars_day, south_temp, marker='v', color='red', label='South', linestyle='--', linewidth=2)
ax.plot(mars_day, equator_temp, marker='^', color='purple', label='Equator', linestyle='-.', linewidth=2)
ax.plot(mars_day, crater_temp, marker='x', color='orange', label='Crater', linestyle=':', linewidth=2)
ax.plot(mars_day, volcano_temp, marker='*', color='brown', label='Volcano', linestyle='-', linewidth=2)
...
ax.grid(which='both', linestyle='-', linewidth=0.7, alpha=0.5)

# Randomly altered legend
ax.legend(loc='lower left', fontsize=12, title='Zones', title_fontsize='13', frameon=False)
