...
ax2 = ax1.twinx()
ax2.plot(months, temperatures, color='orange', marker='s', linestyle='-', linewidth=2, markersize=8, label='Temperature (°C)')
...
ax2.annotate(f'Highest Temperature ({max_temp_value}°C)', xy=(max_temp_month, max_temp_value), xytext=(max_temp_month, max_temp_value+5),
             arrowprops=dict(facecolor='orange', shrink=0.1), fontsize=10, color='orange', ha='center')
