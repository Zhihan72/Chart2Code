...
ax.fill_between(years, market_share, color='mediumslateblue', alpha=0.6, label='Market Share (%)')
ax.fill_between(years, revenue, color='mediumseagreen', alpha=0.6, label='Revenue (millions)')
ax.fill_between(years, rnd_investment, color='salmon', alpha=0.6, label='R&D Investment (millions)')
ax.fill_between(years, employee_growth, color='gold', alpha=0.6, label='Employee Growth (count)')
