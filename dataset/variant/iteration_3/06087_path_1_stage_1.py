...
ax.set_title('Caloric Intake in Age Groups - 2023', fontsize=16, fontweight='bold', pad=20)
...
ax.scatter(means, range(1, len(age_groups) + 1), color='blue', marker='D', label='Mean')
