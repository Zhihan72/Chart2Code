...
ax.bar(index, current_share, bar_width, color=colors, edgecolor='black')
ax.bar(index + bar_width, future_share, bar_width, color='#ADD8E6', edgecolor='black')
ax.bar(index + 2 * bar_width, experimental_share, bar_width, color='#FF6347', edgecolor='black')
