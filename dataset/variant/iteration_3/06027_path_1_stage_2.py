...
ax.plot(months, city1_temps, marker='o', linestyle='-', color='blue', linewidth=2, label='Alpha', alpha=0.9)
ax.plot(months, city2_temps, marker='s', linestyle='--', color='green', linewidth=2, label='Bravo', alpha=0.8)
ax.plot(months, city3_temps, marker='^', linestyle='-.', color='red', linewidth=2, label='Charlie', alpha=0.7)
