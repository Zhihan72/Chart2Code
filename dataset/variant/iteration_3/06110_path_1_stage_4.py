...
plt.title("Yearly Average Climatic Values in Diverse Regions (2013-2022)", fontsize=18, fontweight='bold', pad=20)
plt.xlabel("Annual Period", fontsize=14, fontweight='bold', labelpad=15)
plt.ylabel("Mean Temp (°C)", fontsize=14, fontweight='bold', labelpad=15)
