...
# Define the updated data for the pie chart
market_share = [25, 20, 15, 18, 12]  # Removed the 'Others' category

# Choose a consistent color for all data groups
single_color = '#20B2AA'  # Light Sea Green

# Updated data showing the growth of categories over years
...
explode = (0, 0.1, 0, 0, 0)  # Adjusted explode tuple size
