...
genres = ['Mystery', 'Romance', 'Sci-Fi', 'Fantasy', 'Nonfic']
...
ax1.set_title('Book Sales by Genre\n(Jan-Jun)', fontsize=16, fontweight='bold')
ax1.set_xlabel('Month', fontsize=14)
ax1.set_ylabel('Sold', fontsize=14)
ax1.set_xticks(x + width * (len(genres) - 1) / 2)
ax1.set_xticklabels(months, fontsize=12)
ax1.legend(title='Genre', fontsize=10, loc='upper right')

bars = ax2.barh(genres, yearly_sales, color=colors, edgecolor='black')

ax2.set_title('Yearly Sales by Genre', fontsize=16, fontweight='bold')
ax2.set_xlabel('Sold', fontsize=14)
