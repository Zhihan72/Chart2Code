...
ax1.plot(years, company_a_users, label='Users', marker='^', linestyle='--', color='royalblue', linewidth=2.5, markersize=8)

ax1.annotate('Hits 100M', xy=(2007, 100), xytext=(2003, 150),
...
ax1.text(2021, 750, '2020 Peak', rotation=90, verticalalignment='center', fontsize=10, color='indianred')

ax1.set_title("Tech Growth (2000-2020)", fontsize=16, fontweight='bold', pad=30, color='darkblue')
ax1.set_xlabel("Year", fontsize=12)
ax1.set_ylabel("Users (M)", fontsize=12)
