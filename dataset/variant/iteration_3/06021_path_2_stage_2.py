...
# Define crop growth rates for three colonies in percentage (%)
...
ax.plot(years, wheat_c, color='green', linestyle=':')
ax.plot(years, corn_c, color='blue', linestyle=':')
ax.plot(years, rice_c, color='red', linestyle=':')
