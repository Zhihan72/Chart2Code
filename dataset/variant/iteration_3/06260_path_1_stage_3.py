...
# Use a single color for both the scatter plot and the trendline
scatter = ax1.scatter(coffee_consumption, lines_of_code, color='navy', edgecolors='black', s=120, label='Coding Productivity', marker='^', zorder=2)
...
trend = ax1.plot(trendline_x, trendline_y, color='navy', linestyle='--', linewidth=2, label='Productivity Trend', zorder=1)
