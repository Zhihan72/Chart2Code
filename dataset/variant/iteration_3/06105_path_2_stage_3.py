...
ax2.bar(average_scores.keys(), average_scores.values(), color=colors, edgecolor='black', hatch='//')
ax2.set_ylim(0, 10)
ax2.set_title("Avg Scores", size=16, weight='bold')
ax2.set_ylabel('Avg Score', size=12)
ax2.set_xticklabels(average_scores.keys(), rotation=30, ha='right', fontsize=10)
