...
new_colors = ['#8B0000', '#00FA9A', '#1E90FF', '#8A2BE2']
...
ax.set_xlabel("Purity Index (0-100)", fontsize=14)
ax.set_ylabel("Geographic Sectors", fontsize=14)

ax.annotate('Peak Purity Achieved', xy=(94, 2), xytext=(96, 1.5),
