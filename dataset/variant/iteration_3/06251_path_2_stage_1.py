...
ax1.plot(days, probe_A, '-o', label='Unit Alpha', color='tomato', markersize=6, linewidth=2, markerfacecolor='darkred')
ax1.plot(days, probe_B, '-s', label='Unit Bravo', color='mediumseagreen', markersize=6, linewidth=2, markerfacecolor='darkgreen')
ax1.plot(days, probe_C, '-^', label='Unit Charlie', color='cornflowerblue', markersize=6, linewidth=2, markerfacecolor='darkblue')
...
ax1.set_title('Lunar Temperature: Weekly Fluctuations of Surface', fontsize=16, fontweight='bold', loc='center')
