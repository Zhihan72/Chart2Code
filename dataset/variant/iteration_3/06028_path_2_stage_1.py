...
ax1.plot(years, city3_population, marker='^', linestyle='-.', color='red', linewidth=2, label='City C')
...
ax2.bar(ind - width, city1_growth, width=width, color='blue', alpha=0.7, label='Metropolis A')
ax2.bar(ind, city2_growth, width=width, color='green', alpha=0.7, label='Urban Zone B')
ax2.bar(ind + width, city3_growth, width=width, color='red', alpha=0.7, label='City C')
