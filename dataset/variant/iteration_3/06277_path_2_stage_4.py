...
for idx in sorted_indices:
    axes[0].bar(years, solar_energy[idx], label=countries[idx], color=new_shuffled_colors[idx], hatch='//')
...
for idx in sorted_indices:
    axes[1].bar(years, wind_energy[idx], label=countries[idx], color=new_shuffled_colors[idx], hatch='|')
