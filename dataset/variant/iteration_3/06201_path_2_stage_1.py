...
ax1.plot(hours, cluster_A, label='A', color='blue', linewidth=2, linestyle='-')
ax1.plot(hours, cluster_B, label='B', color='green', linewidth=2, linestyle='-.')
ax1.plot(hours, cluster_C, label='C', color='red', linewidth=2, linestyle=':')
