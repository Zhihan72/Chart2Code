...
ax.barh(bar_positions_2020, quantities_2020, height=height, color='#ff9999')      
ax.barh(bar_positions_2021, quantities_2021, height=height, color='#66b3ff')      
ax.barh(bar_positions_2022, quantities_2022, height=height, color='#99ff99')     
ax.barh(bar_positions_2023, quantities_2023, height=height, color='#ffcc99')     
ax.barh(bar_positions_2024, quantities_2024, height=height, color='#c2c2f0')     
