...
populations = {
    ...
    'Central America': [150, 160, 155, 158, 170, 175, 180, 185, 190, 195, 200]
}
...
markers = ['s', '^', 'D', '*']
line_styles = ['--', '-.', ':', '-']
colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728']  # New colors
...
plt.legend(title='Regions', loc='lower left', fontsize=10, frameon=False)
