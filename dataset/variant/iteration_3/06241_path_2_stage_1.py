...
# Define new colors for each budget category
colors = ['#FF6347', '#4682B4', '#32CD32', '#FFD700', '#8A2BE2', '#DEB887', '#5F9EA0', '#D2691E']
...
for (tech, improvements), color in zip(tech_advancement.items(), line_colors):
    ax[1].plot(years, improvements, label=tech, marker='o', linewidth=2.5, color=color)
