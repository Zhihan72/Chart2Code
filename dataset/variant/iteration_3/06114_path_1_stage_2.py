...
axs[0].plot(years, delta_c_pollution, color='magenta', linestyle=':', marker='o', linewidth=2)
axs[0].plot(years, delta_a_pollution, color='lime', linestyle='--', marker='^', linewidth=2)
axs[0].plot(years, delta_b_pollution, color='yellow', linestyle='-', marker='s', linewidth=2)
axs[0].grid(True, linestyle='-', linewidth=0.5, alpha=0.9)

# Subplot 2: Fish Population
axs[1].plot(years, delta_b_fish_population, color='black', linestyle='--', marker='x', linewidth=2)
axs[1].plot(years, delta_c_fish_population, color='red', linestyle=':', marker='d', linewidth=2)
axs[1].plot(years, delta_a_fish_population, color='teal', linestyle='-.', marker='v', linewidth=2)
axs[1].grid(True, linestyle=':', linewidth=0.5, alpha=0.5)

# Subplot 3: Water Clarity
axs[2].plot(years, delta_a_water_clarity, color='navy', linestyle='-', marker='P', linewidth=2)
axs[2].plot(years, delta_b_water_clarity, color='orange', linestyle='--', marker='H', linewidth=2)
axs[2].plot(years, delta_c_water_clarity, color='olive', linestyle='-.', marker='<', linewidth=2)
