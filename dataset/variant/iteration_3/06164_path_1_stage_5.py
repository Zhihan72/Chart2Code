...
# Changed colors for the bars
bars1 = ax1.barh(y_pos, consumption_data, height=bar_height, color='#FFD700', edgecolor='black', linestyle='--', label='Servings', alpha=0.85)

ax2 = ax1.twiny()
bars2 = ax2.barh(y_pos + bar_height, calories_data, height=bar_height, color='#5F9EA0', edgecolor='brown', linestyle=':', label='Calories', alpha=0.85)
