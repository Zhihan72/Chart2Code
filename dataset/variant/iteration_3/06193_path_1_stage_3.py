...
# Plot upload speeds with new color
plt.plot(time_slots, upload_rates, marker='o', color='orange', linewidth=2, markersize=8)

# Plot download speeds with new color
plt.plot(time_slots, download_rates, marker='o', color='red', linewidth=2, markersize=8)
