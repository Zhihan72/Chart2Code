...
sectors = ["IoT", "Blockchain", "AI", "CyberSec"]
...
ax.set_title('Innovation Battleground: Tech Triumphs of 2023', fontsize=16, fontweight='bold', pad=20)
ax.set_xlabel('Industry Verticals', fontsize=12)
ax.set_ylabel('Funding & Revenue (Million USD)', fontsize=12)
...
ax2.set_ylabel('Rise in Growth (%)', fontsize=12)
