...
ax3.plot(years, smart_features, marker='o', linestyle='-', color='darkorange', linewidth=2)
ax3.set_title('Evolution of Virtual Assistants Over 20 Years', fontsize=16, fontweight='bold', pad=20)
ax3.set_ylabel('Smart Feature Count', fontsize=12, color='darkorange')
...
for year, milestone in milestones.items():
    ...
    ax3.annotate(milestone,
                 ...
                 fontsize=10,
                 color='slateblue')
    ax3.scatter(year, smart_features[idx], color='crimson', zorder=5)

ax3.axvspan(2022, 2027, alpha=0.1, color='lightgrey')
ax3.axvspan(2030, 2035, alpha=0.1, color='lightcoral')
...
ax1.plot(years, user_engagement, marker='^', linestyle='-.', color='purple', linewidth=2)
ax1.set_xlabel('Timeline', fontsize=12)
ax1.set_ylabel('User Engagement Rate', fontsize=12, color='purple')
