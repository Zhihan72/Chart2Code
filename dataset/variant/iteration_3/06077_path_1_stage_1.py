...
ax1.plot(years, urban_parks, label='Parks', color='#63A375', linewidth=2, marker='o')
ax1.plot(years, roof_gardens, label='Roofs', color='#E6B655', linewidth=2, marker='s')
ax1.plot(years, green_walls, label='Walls', color='#A44A3F', linewidth=2, marker='^')
...
ax1.annotate('Uptake Post-2025', xy=(2025, 150), xytext=(2030, 300),
...
ax2.bar(decades, expansion_projects_roof_gardens, width, label='Roofs', color='#E6B655')
ax2.bar(decades + width, expansion_projects_green_walls, width, label='Walls', color='#A44A3F')
