...
ax.plot(mars_day, crater_temp, marker='x', color='orange', label='Crater', linewidth=2)
ax.plot(mars_day, volcano_temp, marker='*', color='purple', label='Volcano', linewidth=2)
