...
# Changed color of scatter plot to blue
ax1.scatter(tree_coverage, AQI_levels, color='blue', s=100, alpha=0.8,
...
# Changed line plot colors
colors = ['red', 'purple', 'orange', 'brown', 'pink', 'cyan']

for city, color in zip(cities, colors):
    temperatures = temperature_trends[city]
    quarters = ['W', 'Sp', 'Su', 'A']
    ax2.plot(quarters, temperatures, marker='o', label=city, color=color)
