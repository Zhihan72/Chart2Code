...
plt.title('Cityscape Attributes', size=15, weight='bold', ha='center', va='top', position=(0.5, 1.1))

global_averages += global_averages[:1]
ax.fill(angles, global_averages, color='grey', alpha=0.1, label='Global Avg')
