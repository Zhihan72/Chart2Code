...
# Rainfall data with manually altered content
rainfall_data = np.array([
    [95, 78, 120, 89, 150, 70, 80, 110, 60, 85, 55, 100],  # City A
    [65, 52, 85, 70, 100, 50, 45, 75, 90, 80, 55, 65],    # City B
    [90, 85, 105, 95, 120, 80, 90, 130, 70, 95, 110, 60], # City C
    [75, 60, 95, 80, 110, 65, 75, 105, 60, 80, 55, 95],   # City D
    [105, 90, 130, 110, 150, 90, 100, 140, 85, 110, 75, 125]   # City E
])

# Temperature data with manually altered content
temperature_data = np.array([
    [7, 5, 13, 10, 17, 24, 21, 6, 20, 15, 23, 10],   # City A
    [4, 2, 10, 7, 19, 15, 22, 3, 18, 13, 22, 8],     # City B
    [10, 8, 15, 12, 20, 28, 25, 9, 24, 18, 27, 12],  # City C
    [6, 4, 12, 9, 16, 23, 20, 5, 19, 14, 22, 9],     # City D
    [5, 3, 11, 8, 16, 21, 19, 4, 17, 12, 20, 7]      # City E
])
