...
wedges, texts, autotexts = ax1.pie(
    ...
    startangle=160, shadow=True, wedgeprops=dict(edgecolor='black', linewidth=1.5), radius=1.2)
...
ax1.legend(title='Divisions', loc='upper right', bbox_to_anchor=(1.3, 0.8), shadow=True, fontsize=10)
