...
plt.plot(years, solar_growth, label='Sun Energy', color='#00FF00', marker='o', linewidth=2, linestyle='-')
plt.plot(years, wind_growth, label='Breeze Power', color='#FFA500', marker='^', linewidth=2, linestyle='--')
plt.plot(years, hydro_growth, label='Water Force', color='#1E90FF', marker='s', linewidth=2, linestyle='-.')
