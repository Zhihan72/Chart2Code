...
ax1.stackplot(years, storage_data, labels=['Bat.', 'PH', 'Therm.', 'Flywh.'], 
              colors=colors, alpha=0.75)

ax1.set_title('Energy Storage in Greenopolis (2010-2030)', fontsize=14, fontweight='normal', pad=15)
ax1.set_xlabel('Year', fontsize=11)
ax1.set_ylabel('Capacity (GWh)', fontsize=11)

ax1.legend(loc='upper center', fontsize=9, bbox_to_anchor=(0.5, 1.05), title='Types')

ax1.grid(True, linestyle=':', alpha=0.5)

ax1.set_ylim(0, 800)

summary_text = "Growth in capacity, led by batteries."
