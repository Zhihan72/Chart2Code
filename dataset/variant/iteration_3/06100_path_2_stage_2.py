...
regions = ['North', 'South', 'East']  # Removed 'West'
...
total_sales = [sum(north_sales), sum(south_sales), sum(east_sales)]  # Updated totals without West
...
# Colors for the bars
colors = ['#28A745', '#FF5733', '#007ACC']  # Adjusted colors
