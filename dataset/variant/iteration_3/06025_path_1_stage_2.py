...
plt.grid(False) # Removed grid for stylistic variation

plt.gca().spines['top'].set_visible(False) # Modified to create more visual interest by hiding the top border
plt.gca().spines['right'].set_visible(False) # Similarly hiding the right border

plt.tight_layout()
plt.legend(['2016_A', '2017_A', '2018_A', '2019_A', '2020_A', '2016_B', '2017_B', '2018_B', '2019_B', '2020_B'], loc='upper left', ncol=2)
