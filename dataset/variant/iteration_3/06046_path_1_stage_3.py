...
ax1.plot(years, company_a_users, label='Users of Company A', marker='o', linestyle='-', color='tomato', linewidth=2, markersize=6)
...
ax1.legend(loc='upper left', fontsize=10, title="Entities", frameon=True)
