...
ax.set_ylabel('Departments', fontsize=15, color='blue')
ax.set_xlabel('Scores', fontsize=15, color='green')
...
ax.legend(handles, departments, title='Department Legend', loc='upper right')
