...
width = 8
ax2.bar(decades - width, expansion_projects_urban_parks, width, color='#63A375')
ax2.bar(decades, expansion_projects_roof_gardens, width, color='#FFD57E')
ax2.bar(decades + width, expansion_projects_green_walls, width, color='#CC444B')
