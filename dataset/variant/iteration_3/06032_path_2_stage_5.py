...
ax1 = axes[0]
bp1 = ax1.boxplot(winter_temperatures, vert=False, patch_artist=True, showmeans=True, notch=True,
...
ax2 = axes[1]
bp2 = ax2.boxplot(summer_temperatures, vert=False, patch_artist=True, showmeans=True, notch=True,
