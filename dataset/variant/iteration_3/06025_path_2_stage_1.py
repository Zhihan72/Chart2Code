...
plt.plot(months, city_a_2016, marker='o', color='#1f77b4')
plt.plot(months, city_a_2017, marker='s', color='#ff7f0e')
plt.plot(months, city_a_2018, marker='^', color='#2ca02c')
plt.plot(months, city_a_2019, marker='d', color='#d62728')
plt.plot(months, city_a_2020, marker='*', color='#9467bd')

plt.plot(months, city_b_2016, marker='o', linestyle='dashed', color='#17becf')
plt.plot(months, city_b_2017, marker='s', linestyle='dashed', color='#bcbd22')
plt.plot(months, city_b_2018, marker='^', linestyle='dashed', color='#8c564b')
plt.plot(months, city_b_2019, marker='d', linestyle='dashed', color='#e377c2')
plt.plot(months, city_b_2020, marker='*', linestyle='dashed', color='#7f7f7f')
