...
crop_types = ['Wheat', 'Corn', 'Barley', 'Soybeans', 'Oats', 'Rice', 'Quinoa']
...
# Create the plot
fig, ax = plt.subplots(figsize=(14, 8))  # Adjusted figure size for additional data

width = 0.12  # Slightly reduced width for more bars
