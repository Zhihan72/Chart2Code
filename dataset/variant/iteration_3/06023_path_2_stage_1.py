...
sns.kdeplot(tweets_ai, label='AI', color='blue', shade=True, alpha=0.6, ax=ax)
sns.kdeplot(tweets_blockchain, label='Blockchain', color='green', shade=True, alpha=0.6, ax=ax)

# Customize text
ax.set_title('Tweet Density by Time', fontsize=16, fontweight='bold', pad=20)
ax.set_xlabel('Hour', fontsize=14)
ax.set_ylabel('Density', fontsize=14)
ax.legend(title='Topic', fontsize=12, title_fontsize=14)
