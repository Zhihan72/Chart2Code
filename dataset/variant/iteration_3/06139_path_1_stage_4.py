...
ax.set_title("Monthly Social Media Use by Age", fontsize=18, fontweight='bold', color='darkblue')
ax.set_xlabel("Age", fontsize=14, color='brown')
ax.set_ylabel("Hours/Month", fontsize=14, color='brown')
