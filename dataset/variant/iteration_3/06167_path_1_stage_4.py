...
axes[0].barh(years - 0.1, region2_sales[1], height=0.1, label='Chocolate', color='#FFD700')
axes[0].barh(years, region2_sales[2], height=0.1, label='Strawberry', color='#8B4513')
axes[0].barh(years + 0.1, region2_sales[3], height=0.1, label='Mint', color='#FF69B4')
axes[0].barh(years + 0.2, region2_sales[4], height=0.1, label='Butterscotch', color='#98FB98')
...
axes[0].set_xlabel("Sales (in thousands)", fontsize=12)
...
axes[1].barh(years - 0.1, region1_sales[1], height=0.1, label='Chocolate', color='#FFD700')
axes[1].barh(years, region1_sales[2], height=0.1, label='Strawberry', color='#8B4513')
axes[1].barh(years + 0.1, region1_sales[3], height=0.1, label='Mint', color='#FF69B4')
axes[1].barh(years + 0.2, region1_sales[4], height=0.1, label='Butterscotch', color='#98FB98')
...
axes[1].set_xlabel("Sales (in thousands)", fontsize=12)
