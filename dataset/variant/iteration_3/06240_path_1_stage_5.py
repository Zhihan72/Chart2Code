...
# Create a donut (ring) chart by setting wedgeprops with 'width'
ax2.pie(counts, labels=types, colors=['#ff7f0e', '#1f77b4'], autopct='%1.1f%%', startangle=270, counterclock=True, wedgeprops=dict(width=0.3))
