...
ax.plot(years, televisions, label='TVs', color='green', marker='s', linestyle='--', linewidth=2, markersize=8)
ax.plot(years, refrigerators, label='Fridges', color='cyan', marker='x', linestyle=':', linewidth=2, markersize=8)
ax.plot(years, washing_machines, label='Washers', color='orange', marker='v', linestyle='-', linewidth=2, markersize=8)
