...
x = np.arange(len(years)) * 1.5  # Added spacing due to sorted bars
width = 0.25
...
ax.set_xlabel('Years Sorted by Count')  # Updated label for context
ax.set_ylabel('Participants')
ax.set_title('Impact of Fitness Programs Over Years (Sorted)')
ax.set_xticks(x + width)
ax.set_xticklabels(years)

# Remove the plot of retention rate as it's not relevant for a sorted bar chart
