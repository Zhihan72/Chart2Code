...
plt.plot(years, computer_vision, marker='s', color='green', linestyle='-', linewidth=2)
...
plt.annotate('Accuracy Improvements in Vision', xy=(2018, computer_vision[8]), xytext=(2018, computer_vision[8] + 10),
            arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=10, ha='right')
