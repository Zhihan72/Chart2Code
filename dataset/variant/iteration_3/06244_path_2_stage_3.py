...
plt.subplot(2, 1, 1)
plt.plot(years, fossil_fuels, color='blue', marker='o', linestyle='-')
plt.plot(years, solar_energy, color='blue', marker='o', linestyle='-')
plt.plot(years, wind_energy, color='blue', marker='o', linestyle='-')
plt.plot(years, total_energy, color='blue', marker='D', linestyle='--')
...
plt.subplot(2, 1, 2)
plt.plot(years, share_renewable, color='blue', marker='o', linestyle='-')
