...
bars1 = ax.barh(index, production_capacities, bar_height, label='Production Capacity', color=color, alpha=0.7)
bars3 = ax.barh(index + bar_height, targets, bar_height, label='Production Target', color=color, alpha=0.7)

ax.set_title('GreenSolutions: Energy Production (2021-2030)', fontsize=14, fontweight='bold')
ax.set_ylabel('Energy Types', fontsize=12)
