...
# Horizontal density plots for tweets with shuffled colors
sns.kdeplot(y=tweets_ai, label='AI Tweets', color='green', shade=True, alpha=0.6, ax=ax)  # Changed color to 'green'
sns.kdeplot(y=tweets_blockchain, label='Blockchain Tweets', color='blue', shade=True, alpha=0.6, ax=ax)  # Changed color to 'blue'
