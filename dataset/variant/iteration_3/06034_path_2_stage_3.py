...
emissions_oc = [1100, 1150, 1200, 1250, 1300]  # New data for Oceania
...
countries_oc = ['Australia', 'New Zealand', 'Fiji']  # New countries for Oceania
proportion_oc = [70, 20, 10]  # New proportions for Oceania

fig, axs = plt.subplots(nrows=3, ncols=2, figsize=(12, 15))  # Adjust layout for additional pie chart
...
axs[0, 0].bar(years, emissions_oc, color='orange', alpha=0.7)  # Add new Oceania data to bar chart
...
axs[1, 1].set_title('Proportion of CO2 Emissions in Asia (2022)', fontsize=14)

axs[2, 0].pie(proportion_af, labels=countries_af, autopct='%1.1f%%', colors=['purple', 'violet', 'lightblue'])
axs[2, 0].set_title('Proportion of CO2 Emissions in Africa (2022)', fontsize=14)

axs[2, 1].pie(proportion_sa, labels=countries_sa, autopct='%1.1f%%', colors=['darkred', 'orangered', 'peru'])
axs[2, 1].set_title('Proportion of CO2 Emissions in South America (2022)', fontsize=14)

axs[2, 0].pie(proportion_oc, labels=countries_oc, autopct='%1.1f%%', colors=['gold', 'lightcoral', 'dodgerblue'])
axs[2, 0].set_title('Proportion of CO2 Emissions in Oceania (2022)', fontsize=14)  # New pie chart for Oceania
