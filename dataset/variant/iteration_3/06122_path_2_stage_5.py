...
# Calculate total sales per category and sort
...
# Set a single consistent color across all data groups
bars = ax.bar(sorted_categories, sorted_sales_data, color='blue', edgecolor='black')
