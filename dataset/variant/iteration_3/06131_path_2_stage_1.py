...
plt.plot(years, techcorp_stocks, label='TechC', color='blue', marker='s', linewidth=2, linestyle='-')
plt.plot(years, innovateinc_stocks, label='InnovInc', color='green', marker='d', linewidth=2, linestyle='--')
plt.plot(years, futuresystems_stocks, label='FutSys', color='red', marker='o', linewidth=2, linestyle='-.')
...
# Add a shortened title and axis labels
