...
# Sort flavors by average sales in descending order
sorted_indices = np.argsort(-average_sales)
sorted_flavors = [flavors[i] for i in sorted_indices]
sorted_average_sales = average_sales[sorted_indices]

fig, axs = plt.subplots(2, 1, figsize=(10, 10))

bars = axs[0].bar(sorted_flavors, sorted_average_sales, color=['#F08080', '#87CEEB', '#32CD32', '#FFD700'])
