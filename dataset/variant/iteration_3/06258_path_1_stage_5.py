...
# Data (Gobi Desert is removed)
regions = ['Nile', 'Arctic', 'Savannah', 'Andes', 'Rockies']
...
carbon_sequestration = [300, 150, 100, 200, 120]
...
for i, specie in enumerate(species):
    ...
    positive_values = currentSpeciesDistribution - currentSpeciesDistribution.mean()
    ax1.barh(sequence_ids + i * bar_width, positive_values, bar_width, color=colors[i])

ax1.axvline(x=0, color='grey', linewidth=0.8)
