...
plt.title('Frontline Outfitters: Sales Product Monthly Average (H1)', fontsize=16, pad=20)
plt.xlabel('Monthly Average Product Sales (Units)', fontsize=14)
plt.ylabel('Category of Product', fontsize=14)
