...
plt.plot(years, asia_bandwidth, label='Asia', color='blue', linewidth=1, marker='X', markersize=6)
plt.plot(years, europe_bandwidth, label='Europe', color='green', linewidth=3, marker='P', markersize=8)
plt.plot(years, north_america_bandwidth, label='North America', color='orange', linewidth=2, marker='v', markersize=5)
plt.plot(years, africa_bandwidth, label='Africa', color='brown', linewidth=2, linestyle='-.', marker='*', markersize=7)
...
plt.annotate('Massive Growth\nin Asia', xy=(2015, 750), xytext=(2008, 1400),
             arrowprops=dict(facecolor='black', arrowstyle='wedge'), fontsize=10, color='blue')
