...
bars = axs[0].barh(flavors, average_sales, color=single_color)
...
for sales in monthly_sales:
    axs[1].plot(months, sales, marker='o', color=single_color)
...
axs[1].legend(title='Flavors', labels=flavors, fontsize=10)
