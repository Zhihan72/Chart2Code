...
ax1.plot(months, water_levels, color='green', marker='o', linestyle='-', linewidth=2, markersize=8, label='Water (m)')
...
ax2 = ax1.twinx()
ax2.plot(months, temperatures, color='green', marker='s', linestyle='-', linewidth=2, markersize=8, label='Temp (°C)')
