...
plt.plot(decades, pop_music, marker='D', linestyle='--', color='orange', linewidth=3, label='Pop')
plt.plot(decades, rock_music, marker='v', linestyle='-.', color='purple', linewidth=2, label='Rock')
plt.plot(decades, hiphop_music, marker='x', linestyle='-', color='cyan', linewidth=2, label='Hip Hop')
plt.plot(decades, jazz_music, marker='h', linestyle=':', color='pink', linewidth=2, label='Jazz')
