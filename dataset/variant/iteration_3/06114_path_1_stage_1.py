...
# Re-arranged stylistic features for illustration purposes only:
# Subplot 1: Pollution Levels
axs[0].plot(years, delta_c_pollution, color='magenta', linestyle=':', marker='o', linewidth=2, label='Delta C')
axs[0].plot(years, delta_a_pollution, color='lime', linestyle='--', marker='^', linewidth=2, label='Delta A')
axs[0].plot(years, delta_b_pollution, color='yellow', linestyle='-', marker='s', linewidth=2, label='Delta B')
axs[0].set_title('Pollution Levels (in arbitrary units)', fontsize=14, pad=10)
axs[0].set_ylabel('Pollution Level', fontsize=12)
axs[0].legend(loc='upper center', fontsize=10, shadow=True)
axs[0].grid(True, linestyle='-', linewidth=0.5, alpha=0.9)

# Subplot 2: Fish Population
axs[1].plot(years, delta_b_fish_population, color='black', linestyle='--', marker='x', linewidth=2, label='Delta B')
axs[1].plot(years, delta_c_fish_population, color='red', linestyle=':', marker='d', linewidth=2, label='Delta C')
axs[1].plot(years, delta_a_fish_population, color='teal', linestyle='-.', marker='v', linewidth=2, label='Delta A')
axs[1].set_title('Fish Population (in thousands)', fontsize=14, pad=10)
axs[1].set_ylabel('Fish Population', fontsize=12)
axs[1].legend(loc='lower left', fontsize=10, shadow=True)
axs[1].grid(True, linestyle=':', linewidth=0.5, alpha=0.5)

# Subplot 3: Water Clarity
axs[2].plot(years, delta_a_water_clarity, color='navy', linestyle='-', marker='P', linewidth=2, label='Delta A')
axs[2].plot(years, delta_b_water_clarity, color='orange', linestyle='--', marker='H', linewidth=2, label='Delta B')
axs[2].plot(years, delta_c_water_clarity, color='olive', linestyle='-.', marker='<', linewidth=2, label='Delta C')
...
axs[2].legend(loc='lower right', fontsize=10, shadow=True)
