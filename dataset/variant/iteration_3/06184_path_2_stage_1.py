...
bars_apples = ax.bar(positions_apples, apples, bar_width, label='Apples', color='blue')
bars_bananas = ax.bar(positions_bananas, bananas, bar_width, label='Bananas', color='blue')
bars_oranges = ax.bar(positions_oranges, oranges, bar_width, label='Oranges', color='blue')
bars_grapes = ax.bar(positions_grapes, grapes, bar_width, label='Grapes', color='blue')
bars_strawberries = ax.bar(positions_strawberries, strawberries, bar_width, label='Strawberries', color='blue')
