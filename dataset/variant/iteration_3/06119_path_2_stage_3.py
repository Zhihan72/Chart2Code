...
# Define book genres and monthly sales data, excluding Horror
...
# Shuffled colors for the bar charts
colors = plt.cm.viridis(np.linspace(0.2, 0.8, len(genres)))
colors = [colors[2], colors[0], colors[4], colors[3], colors[1]]  # Shuffling the colors
