...
bars1 = ax2.bar(x - width/2, weekend_percentages, width, label='Weekend', color='#caffbf', edgecolor='black', linestyle='-')
bars2 = ax2.bar(x + width/2, weekday_percentages, width, label='Weekday', color='#fdffb6', edgecolor='black', linestyle='--')
