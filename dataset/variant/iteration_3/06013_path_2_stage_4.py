...
color = 'teal'
bars_day = ax.bar(x_pos - width / 2, daytime_highs, width, label='Apollo Day Highs', color=color)
bars_night = ax.bar(x_pos + width / 2, nighttime_lows, width, label='Apollo Night Lows', color=color)
