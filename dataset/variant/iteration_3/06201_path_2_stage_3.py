...
ax1.plot(hours, cluster_A, color='green', linewidth=2, linestyle='-')
ax1.plot(hours, cluster_B, color='red', linewidth=2, linestyle='-.')
ax1.plot(hours, cluster_C, color='blue', linewidth=2, linestyle=':')
