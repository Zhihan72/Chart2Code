...
# Manually shuffled sales data for both regions
region1_sales = np.array([
    [60, 70, 80, 90, 40, 55],  # Previously Strawberry
    [50, 60, 65, 70, 80, 90],  # Previously Vanilla
    [30, 40, 45, 50, 55, 65],  # Unchanged
    [40, 45, 55, 60, 70, 80],  # Previously Mint
    [20, 30, 35, 45, 50, 60]   # Previously Butterscotch
])
region2_sales = np.array([
    [65, 75, 85, 95, 45, 60],  # Previously Strawberry
    [55, 65, 70, 75, 85, 95],  # Previously Vanilla
    [35, 45, 50, 55, 60, 70],  # Unchanged
    [45, 50, 60, 65, 75, 85],  # Previously Mint
    [25, 35, 40, 50, 55, 65]   # Previously Butterscotch
])
