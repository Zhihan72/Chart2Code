...
sns.kdeplot(tweets_ai, color='blue', shade=True, alpha=0.6, ax=ax, label='AI', vertical=True)
sns.kdeplot(tweets_blockchain, color='green', shade=True, alpha=0.6, ax=ax, label='Blockchain', vertical=True)
sns.kdeplot(tweets_cryptocurrency, color='red', shade=True, alpha=0.6, ax=ax, label='Cryptocurrency', vertical=True)
sns.kdeplot(tweets_climate, color='purple', shade=True, alpha=0.6, ax=ax, label='Climate', vertical=True)
