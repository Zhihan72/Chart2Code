...
# Altered percentage of energy from renewable sources for four fictional countries
...
plt.plot(years, solarlandia_renewables, marker='o', linestyle='-', linewidth=2, color='orange', label='Sunnyland')
plt.plot(years, windtopia_renewables, marker='s', linestyle='--', linewidth=2, color='blue', label='Breezeborough')
plt.plot(years, hydroville_renewables, marker='^', linestyle='-.', linewidth=2, color='green', label='Watertown')
plt.plot(years, geothermia_renewables, marker='d', linestyle=':', linewidth=2, color='purple', label='Hotspotville')
