...
im1 = axs[0].imshow(adoption_masked, cmap='YlGnBu', aspect='auto')
...
# Create lower triangle heatmap for Efficiency Improvement
efficiency_masked = np.ma.masked_array(efficiency_improvement, mask)
im2 = axs[1].imshow(efficiency_masked, cmap='Oranges', aspect='auto')
