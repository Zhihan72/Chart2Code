...
single_color = 'purple'
ax.plot(years, solar_energy, color=single_color, linestyle='-', marker='o', linewidth=2)
ax.plot(years, wind_energy, color=single_color, linestyle='--', marker='s', linewidth=2)
ax.plot(years, hydropower, color=single_color, linestyle='-.', marker='^', linewidth=2)
ax.plot(years, geothermal_energy, color=single_color, linestyle=':', marker='d', linewidth=2)
