...
ax.set_title('Smoothie Sales', fontsize=16, fontweight='bold')
ax.set_xlabel('Mnth', fontsize=14)
ax.set_ylabel('Sold', fontsize=14)
ax.set_xticks(months_idx + bar_width)
ax.set_xticklabels(months, fontsize=10, rotation=45)

ax.legend(title='Flvs', fontsize=10, title_fontsize='11', loc='upper right', shadow=True)
