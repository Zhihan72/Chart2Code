...
# Plotting average temperatures for each city with new colors
plt.plot(months, san_francisco_temps, marker='o', linestyle='-', label='San Francisco', color='darkred')
plt.plot(months, new_york_temps, marker='s', linestyle='-', label='New York', color='dodgerblue')
plt.plot(months, miami_temps, marker='^', linestyle='-', label='Miami', color='darkgreen')
plt.plot(months, seattle_temps, marker='D', linestyle='-', label='Seattle', color='gold')
plt.plot(months, san_diego_temps, marker='x', linestyle='-', label='San Diego', color='magenta')
plt.plot(months, honolulu_temps, marker='*', linestyle='-', label='Honolulu', color='purple')
