...
elephant_population = np.array([600, 620, 640, 650, 660, 680, 700, 720, 750, 780, 800, 820, 850, 880, 900, 
                                930, 960, 980, 1000, 1020, 1050])
...
ax.plot(years, elephant_population, marker='o', linestyle='-', color='brown', linewidth=2, markersize=8, label='Elephants')
