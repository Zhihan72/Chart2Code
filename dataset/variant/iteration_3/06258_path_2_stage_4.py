...
ax1.set_xlabel('Zones', fontsize=12)
ax1.set_ylabel('Variation from Norm (%)', fontsize=12)
ax1.set_title('Different Plant Types Spread', fontsize=14, fontweight='bold', pad=20)
...
ax2.set_xlabel('Carbon Capture (Million Metric Tons)', fontsize=12)
ax2.set_title('CO2 Absorption by Zone', fontsize=14, fontweight='bold', pad=20)
