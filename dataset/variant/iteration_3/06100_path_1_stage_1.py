...
# Altered sales data for each region (in thousands of units)
north_sales = [22, 15, 30, 25, 35, 20]  # shuffled
south_sales = [12, 28, 10, 20, 15, 25]  # shuffled
east_sales = [35, 18, 40, 30, 22, 27]  # shuffled
west_sales = [15, 8, 18, 22, 12, 10]   # shuffled
