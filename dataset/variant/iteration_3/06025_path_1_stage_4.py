...
plt.plot(months, city_a_2016, marker='v', color=single_color, linestyle='--')
plt.plot(months, city_a_2017, marker='s', color=single_color, linestyle='-.')
plt.plot(months, city_a_2018, marker='+', color=single_color, linestyle=':')
plt.plot(months, city_a_2019, marker='x', color=single_color, linestyle='-')
plt.plot(months, city_a_2020, marker='D', color=single_color, linestyle='--')

plt.plot(months, city_b_2016, marker='o', linestyle='-', color=single_color)
plt.plot(months, city_b_2017, marker='<', linestyle='--', color=single_color)
plt.plot(months, city_b_2018, marker='>', linestyle=':', color=single_color)
plt.plot(months, city_b_2019, marker='^', linestyle='-.', color=single_color)
plt.plot(months, city_b_2020, marker='h', linestyle='-', color=single_color)

plt.plot(months, city_c_2016, marker='*', linestyle='-', color=single_color)
plt.plot(months, city_c_2017, marker='p', linestyle='--', color=single_color)
plt.plot(months, city_c_2018, marker='d', linestyle=':', color=single_color)
plt.plot(months, city_c_2019, marker='H', linestyle='-.', color=single_color)
plt.plot(months, city_c_2020, marker='8', linestyle='-', color=single_color)
