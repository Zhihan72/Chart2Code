...
# Plot lines for each AI technology with new colors
...
plt.plot(years, natural_language_processing, marker='^', color='cyan', linestyle='-', linewidth=2, label='Natural Language Processing')
