...
# Colors are swapped between the two data groups
plt.plot(years, machine_learning, marker='o', color='red', linestyle='-', linewidth=2)
plt.plot(years, natural_language_processing, marker='^', color='blue', linestyle='-', linewidth=2)
