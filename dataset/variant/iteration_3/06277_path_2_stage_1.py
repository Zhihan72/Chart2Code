...
# Data for energy production in TWh
...
for i in range(len(countries)):
    axes[0].bar(years, solar_energy[i], label=countries[i])
...
# Wind Energy Plot
for i in range(len(countries)):
    axes[1].bar(years, wind_energy[i], label=countries[i])
...
# Hydro Energy Plot
for i in range(len(countries)):
    axes[2].bar(years, hydro_energy[i], label=countries[i])
