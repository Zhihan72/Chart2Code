...
boxplot = ax.boxplot(calorie_intake, vert=False, patch_artist=True, labels=meal_types, notch=True)
...
for i, annotation in enumerate(annotations):
    ax.text(max(calorie_intake[i]) + 10, i + 1, annotation, ha='left', va='center', 
