...
ax1.set_ylabel('EVs Sold', fontsize=12)
ax1.set_title('Techville EV Adoption (2015-25)', fontsize=16, fontweight='bold')
...
ax2.set_ylabel('CO2 Red. (tons)', fontsize=12, color='#FF7F0E')
