...
athlete_labels = ["Rookie", "Intermediate", "Expert", "Endurer", "Speedster"]
...
ax.set_xlabel("Distance Run (km)", fontsize=14)
ax.set_title("Comparison of Running Distances Among Different Athletes", fontsize=16)
