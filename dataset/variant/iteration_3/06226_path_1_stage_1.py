...
plt.ylabel("Passenger-Kilometers (Millions)", fontsize=13)

# Legend
plt.legend(loc='lower left', fontsize=10, title='Modes of Transport', title_fontsize='13')

# Annotations to highlight key transitions
plt.annotate('Peak of EV usage', xy=(2030, 400), xytext=(2025, 420),
             arrowprops=dict(facecolor='grey', arrowstyle='-|>'), fontsize=10)

plt.annotate('Decline of\nTraditional Cars', xy=(2029, 240), xytext=(2023, 300),
