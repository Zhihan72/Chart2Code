...
ax1.bar(x - bar_width, apple_sorted, bar_width, color='#ff9999')
ax1.bar(x, orange_sorted, bar_width, color='#66b3ff')
ax1.bar(x + bar_width, banana_sorted, bar_width, color='#99ff99')
