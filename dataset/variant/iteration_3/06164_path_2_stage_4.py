...
combined_data = list(zip(fruits, consumption_data, calories_data))

# Sort the data by consumption_data in descending order
...
ax2.set_ylabel('Total Calories', fontsize=12, color='#6A5ACD')
