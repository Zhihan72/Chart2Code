...
ax.stackplot(years, flora_data, colors=['#228B22', '#8FBC8F', '#FFD700'], alpha=0.7)
...
ax.spines['right'].set_visible(False)  # Removing the right border
ax.spines['left'].set_visible(False)  # Removing the left border
ax.spines['bottom'].set_visible(False)  # Removing the bottom border
