...
ax1.plot(years, roof_gardens, label='Roofs', color='#63A375', linewidth=2, marker='s')
ax1.plot(years, green_walls, label='Walls', color='#63A375', linewidth=2, marker='^')
...
ax2.bar(decades, expansion_projects_roof_gardens, width, label='Roofs', color='#63A375')
ax2.bar(decades + width, expansion_projects_green_walls, width, label='Walls', color='#63A375')
