...
new_colors = ['#8B0000', '#FFD700', '#00FA9A', '#1E90FF', '#8A2BE2']  # New set of colors
...
legend_elements = [Patch(facecolor=color, label=city) for color, city in zip(new_colors, city_names)]
