...
wizards = {
    'Merlin': [10, 8, 7, 9, 9],  # Values manually shuffled
    'Gandalf': [9, 8, 10, 7, 8], # Values manually shuffled
    'Dumbledore': [8, 9, 7, 8, 10], # Values manually shuffled
    'Morgana': [10, 7, 9, 7, 8], # Values manually shuffled
    'Saruman': [7, 9, 9, 7, 8] # Values manually shuffled
}
...
for score in wizards.values():
    ax.plot(angles, score, linewidth=2, linestyle='solid', color=single_color)
