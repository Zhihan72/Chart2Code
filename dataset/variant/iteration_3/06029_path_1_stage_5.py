...
common_color = '#66B3FF'  # Choose a single color for all data groups

ax1 = axs[1]
ax1.hist(colony_alpha, bins=10, edgecolor='black', color=common_color, alpha=0.5, label='Alpha Group')
ax1.hist(colony_beta, bins=10, edgecolor='black', color=common_color, alpha=0.5, label='Beta Settlement')
...
ax2.bar(months_indices - width / 2, colony_alpha, width, label='Alpha Group', edgecolor='black', color=common_color, alpha=0.7)
ax2.bar(months_indices + width / 2, colony_beta, width, label='Beta Settlement', edgecolor='black', color=common_color, alpha=0.7)
