...
# Shuffle the colors for the plot
ax1.plot(years, city1_population, marker='o', linestyle='-', color='green', linewidth=2)
ax1.plot(years, city2_population, marker='s', linestyle='--', color='blue', linewidth=2)
...
ax2.barh(ind - width/2, city1_growth, height=width, color='green', alpha=0.7)
ax2.barh(ind + width/2, city2_growth, height=width, color='blue', alpha=0.7)
