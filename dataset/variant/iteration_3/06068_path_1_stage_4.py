...
ax.plot(months, prod_development, marker='o', linestyle='-', color='orange')
ax.plot(months, prod_marketing, marker='s', linestyle='--', color='cyan')
ax.plot(months, prod_sales, marker='^', linestyle=':', color='magenta')
ax.plot(months, prod_customer_support, marker='D', linestyle='-.', color='brown')
