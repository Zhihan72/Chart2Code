...
# Define cities, incorporating the new city "Sunset Shores"
cities = ["Inferno City", "Frostville", "Temperate Town", "Zephyr Zone", "Aqua Haven", "Sunset Shores"]
...
summer_temperatures = [
    ...
    [28, 29, 30, 32, 31, 30, 29, 31, 32, 30] # Sunset Shores data for summer
]
...
winter_temperatures = [
    ...
    [20, 21, 23, 22, 20, 19, 20, 21, 22, 23] # Sunset Shores data for winter
]
