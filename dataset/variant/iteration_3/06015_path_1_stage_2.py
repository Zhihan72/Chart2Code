...
solar_panels_D = np.array([35, 40, 43, 47, 50, 54, 58, 61, 64, 68, 72])  # Additional data series
...
ax.plot(years, solar_panels_D, linestyle='-.', marker='d', color='#ff33ab', linewidth=2, markersize=6)  # Plot for new group D

ax.grid(True, linestyle='--', alpha=0.7)
ax.set_xticks(years)
ax.set_yticks(np.arange(35, 85, step=5))  # Adjusted to include new range from solar_panels_D
