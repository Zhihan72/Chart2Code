...
meal_types = ['Dawn Fuel', 'Midday Munchies', 'Tiny Bites', 'Liquid Refreshments']
calorie_intake = [
...
colors = ['#5F9EA0', '#FFD700', '#8A2BE2', '#FF4500']
...
annotations = ["Sunshine Starter", "Noon Boost", "Quick Munch", "Refresh"]
