...
# Apply new set of colors for the bars
ax1.bar(x - 1.5*width, q1_sales_sorted, width, color='skyblue', label='Q1')
ax1.bar(x - 0.5*width, q2_sales_sorted, width, color='orange', label='Q2')
ax1.bar(x + 0.5*width, q3_sales_sorted, width, color='limegreen', label='Q3')
ax1.bar(x + 1.5*width, q4_sales_sorted, width, color='indianred', label='Q4')
