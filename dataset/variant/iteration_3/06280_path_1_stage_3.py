...
# Applying a single color 'blue' to all data groups
ax.plot(years, country_a_production, marker='d', linestyle='--', linewidth=1.5, color='blue')
ax.plot(years, country_b_production, marker='x', linestyle='-', linewidth=1.5, color='blue')
ax.plot(years, country_c_production, marker='h', linestyle=':', linewidth=1.5, color='blue')
