...
# Global Carbon Emissions Reductions (in million tons) from different sectors (including new made-up data)
...
ax.stackplot(years, data, labels=['Energy', 'Transport', 'Industry', 'Agriculture', 'Technology'], colors=colors, alpha=0.8)
