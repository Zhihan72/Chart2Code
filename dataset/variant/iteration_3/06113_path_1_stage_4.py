...
teams = ["Frontend Experts", "Backend Professionals", "Ops Wizards"]
...
# Choose a single color to apply consistently across all data groups
single_color = '#1f77b4'

for i, (team_data, team_name) in enumerate(zip(proficiency_data, teams)):
    team_data += team_data[:1]
    ax.plot(angles, team_data, linewidth=2, linestyle='solid', label=team_name, color=single_color)
