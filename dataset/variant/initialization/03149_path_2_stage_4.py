...
fiction = 1 - 1 * np.sin(np.linspace(0, 10 * np.pi, 132)) + np.linspace(0, 5, 132)
mystery = 12 + 4 * np.sin(np.linspace(0, 6 * np.pi, 132)) + np.linspace(2, 6, 132)
science_fiction = -10 + 5 * np.sin(np.linspace(0, 8 * np.pi, 132)) + np.linspace(1, 7, 132)
non_fiction = 10 + 2 * np.sin(np.linspace(0, 7 * np.pi, 132)) + np.linspace(1, 3, 132)
fantasy = 9 + 10 * np.sin(np.linspace(0, 9 * np.pi, 132)) + np.linspace(1, 2, 132)
