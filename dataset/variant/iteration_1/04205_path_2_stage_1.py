...
# Energy production data (in terawatt-hours) from various sources
...
# Define labels and new color set for the energy sources
sources = ['Fossil Fuels', 'Solar', 'Wind', 'Hydro', 'Nuclear']
colors = ['#FF6347', '#FF8C00', '#4682B4', '#3CB371', '#DDA0DD']
