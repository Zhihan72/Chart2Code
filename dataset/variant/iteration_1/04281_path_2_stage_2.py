...
ax1.plot(months, avg_temperatures_2022, marker='o', linestyle='-', color='#1f77b4', linewidth=2, label='Yr2022')
ax1.plot(months, avg_temperatures_2021, marker='s', linestyle='--', color='#ff7f0e', linewidth=2, label='Yr2021')
...
ax2.bar(months, temperature_range_2022, color='#2ca02c', label='Temp Diff', alpha=0.7)
