...
plt.plot(months, city_bravo_temp, linestyle='-.', marker='x', color='green', linewidth=2.5)
plt.plot(months, city_charlie_temp, linestyle=':', marker='D', color='orange', linewidth=2.5)
...
plt.legend(['City Alpha', 'City Bravo', 'City Charlie'], loc='upper right')
plt.tight_layout()
