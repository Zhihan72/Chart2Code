...
ax.barh(age_groups, ads_seen, color='teal', label='Ads Seen')  # Changed color from 'blue' to 'teal'
ax.barh(age_groups, -products_purchased, color='salmon', label='Products Purchased')  # Changed color from 'orange' to 'salmon'
