...
single_color = 'tab:purple'  # A single consistent color for all metrics
ax1.set_xlabel('Energy Source')
ax1.set_ylabel('Carbon Emissions (gCO2/kWh)', color=single_color)
bars1 = ax1.bar(energy_sources, carbon_emissions, color=single_color, alpha=0.6, label='Carbon Emissions')
...
bars2 = ax2.bar(energy_sources, cost, color=single_color, alpha=0.6, label='Cost', width=0.4, align='edge')
...
bars3 = ax3.bar(energy_sources, capacity, color=single_color, alpha=0.6, label='Capacity', width=0.4, align='center')
