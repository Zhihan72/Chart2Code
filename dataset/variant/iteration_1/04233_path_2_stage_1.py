...
# Plot the bar charts for each year with new colors
bars_2011 = ax1.barh(y_pos - bar_width, borrowings_2011, bar_width, label='2011', color='#8e44ad')  # Purple
bars_2016 = ax1.barh(y_pos, borrowings_2016, bar_width, label='2016', color='#e67e22')  # Orange
bars_2021 = ax1.barh(y_pos + bar_width, borrowings_2021, bar_width, label='2021', color='#3498db')  # Blue
