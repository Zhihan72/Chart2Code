...
bar_colors = ['#20B2AA', '#778899', '#FFFACD', '#DDA0DD']  # Light Sea Green, Light Slate Gray, Lemon Chiffon, Plum
...
ax.set_title('Yearly Library Budget Allocation Across Departments (2018-2021)', fontsize=16, fontweight='bold')
ax.set_xticks(x)
