...
group_d_scores = np.array([60, 62, 65, 68, 71])  # New data series
...
ax.plot(years, group_d_scores, marker='D', linestyle=':', linewidth=2, markersize=6, color='blue')  # Added new series
...
for i in range(len(years)):
    ...
    ax.annotate(f'{group_d_scores[i]}', xy=(years[i], group_d_scores[i]), textcoords="offset points", xytext=(0, 10), ha='center', color='blue')  # Annotate new series
