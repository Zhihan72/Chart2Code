...
# Manually shuffled temperature data for each city
...
# Plots with replaced temperature data
...
ax.annotate('Highest', xy=(8, 26), xytext=(9, 27), arrowprops=dict(facecolor='blue', shrink=0.1), **highlight_style)
ax.annotate('Lowest', xy=(6, -1), xytext=(7, -6), arrowprops=dict(facecolor='blue', shrink=0.1), **highlight_style)
ax.annotate('Highest', xy=(8, 24), xytext=(9, 25), arrowprops=dict(facecolor='orange', shrink=0.1), **highlight_style)
ax.annotate('Lowest', xy=(0, 14), xytext=(1, 10), arrowprops=dict(facecolor='orange', shrink=0.1), **highlight_style)
ax.annotate('Highest', xy=(5, 25), xytext=(6, 26), arrowprops=dict(facecolor='green', shrink=0.1), **highlight_style)
ax.annotate('Lowest', xy=(8, -5), xytext=(9, -10), arrowprops=dict(facecolor='green', shrink=0.1), **highlight_style)
