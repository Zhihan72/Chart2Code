...
ax2.barh(cities, variances, color=colors, edgecolor='black', hatch='/')
...
for i, city in enumerate(cities):
    ax1.bar(x_positions + i * bar_width, temp_data[i], width=bar_width, label=city, color=colors[i], edgecolor='black', capstyle='round')
