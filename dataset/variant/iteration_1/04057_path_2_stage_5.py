...
# Using diamond marker, solid border and dotted grid
axs[0, 0].scatter(sleep_hours, happiness_score, color='blue', marker='D', s=100, edgecolor='black', alpha=0.7)
...
# Using cross marker, solid grid line and removing one border
axs[0, 1].scatter(daily_steps, happiness_score, color='green', marker='x', s=100, edgecolor='black', alpha=0.7)
...
# Using square marker, dashed grid line and changing color
axs[1, 0].scatter(outdoor_hours, happiness_score, color='red', marker='s', s=100, edgecolor='black', alpha=0.7)
...
# Using triangle marker, dot-dash grid line and removing bottom border
axs[1, 1].scatter(exercise_duration, happiness_score, color='orange', marker='^', s=100, edgecolor='black', alpha=0.7)
