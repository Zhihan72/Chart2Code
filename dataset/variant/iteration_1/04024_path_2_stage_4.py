...
single_color = '#FFD700'  # Consistent single color

ax.stackplot(years, energy_data, labels=['Sunshine Energy', 'Breeze Power', 'Earth Heat'], colors=[single_color]*3, alpha=0.7)
