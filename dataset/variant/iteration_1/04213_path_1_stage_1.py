...
# Changing the color palette to a new set of colors
bars = ax.bar(household_types, energy_consumption, color=['#f28e2b', '#76b7b2', '#59a14f', '#edc948', '#e15759'], edgecolor='black', alpha=0.85)
