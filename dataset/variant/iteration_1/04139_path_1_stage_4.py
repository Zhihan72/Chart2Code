...
ax2.barh(np.arange(len(city_zones)), sorted_total_activity_by_zone, color='steelblue')
...
ax2_2 = ax2.twinx()
ax2_2.bar(np.arange(len(days)), sorted_total_activity_by_day, alpha=0.7, color='orange', width=0.3, align='center')
