...
# Expanded data: Energy usage (in Terawatt-hours) from 1990 to 2020 including additional energy sources
...
plt.plot(years, biomass_energy, color='#9ACD32', linestyle='-', linewidth=2, marker='*', label='Biomass Energy')
plt.plot(years, wave_energy, color='#8A2BE2', linestyle='-', linewidth=2, marker='x', label='Wave Energy')
