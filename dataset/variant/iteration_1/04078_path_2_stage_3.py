...
# Additional made-up data series for hypothetical emissions
hypothetical_emissions = np.array([500, 600, 700, 800, 900, 1000])

emissions_data = np.vstack([
    co2_emissions, ch4_emissions, n2o_emissions, fgases_emissions, hypothetical_emissions
])
new_colors = ['#377eb8', '#4daf4a', '#984ea3', '#ff7f00', '#e41a1c']  # Updated color set
...
ax.annotate('Kyoto Protocol', xy=(2000, 14000), xytext=(2005, 18000),
