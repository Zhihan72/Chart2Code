...
# Alteration of data for each creature while keeping the structure
data = {
    'Elves': [20, 20, 20, 20, 20],          # Even distribution, sum maintained
    'Fairies': [30, 10, 40, 5, 15],         # Values shuffled
    'Dwarves': [25, 25, 10, 20, 20],        # Values shuffled
    'Wizards': [10, 30, 30, 20, 10],        # Values shuffled
    'Trolls': [35, 5, 25, 15, 20],          # Values shuffled
    'Dragons': [5, 50, 20, 15, 10]          # Values shuffled
}
