...
width = 0.4
ax1.bar(x, average_concentration, width, label='Mean Values', color='#4682B4')
...
ax1.legend(title="Key Elements", fontsize=9, title_fontsize=10)
ax1.grid(axis='y', linestyle='--', alpha=0.5)

# Create a horizontal boxplot
bp = ax2.boxplot(data, patch_artist=True, notch=False, vert=False,
...
ax2.set_yticklabels(["Obs A", "Obs B", "Obs C", "Obs D", "Obs E"],
                    fontsize=10)
ax2.xaxis.grid(True, linestyle='--', which='major', color='grey', alpha=0.5)
