...
axs[1].plot(years, solar_share, label='Solar', color='#1F77B4', marker='o')
axs[1].plot(years, hydro_share, label='Hydro', color='#FF7F0E', marker='^')
axs[1].plot(years, battery_storage_share, label='Battery', color='#2CA02C', marker='D')
