...
for i, yields in enumerate(data):
    ...
    bp = ax.boxplot(yields, positions=pos, widths=0.6, patch_artist=True, notch=True, vert=False)
...
ax.set_yticklabels(['Carrots', 'Potatoes', 'Tomatoes', 'Cabbages'], fontsize=12)
