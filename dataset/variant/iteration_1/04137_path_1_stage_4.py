...
# Applying a single color to both data groups
common_color = 'green'

ax1.plot(years, corn_yield, color=common_color, linestyle='-.', marker='^', linewidth=2, markersize=10, label='Bountiful Corn')
ax1.plot(years, soybean_yield, color=common_color, linestyle='-', marker='d', linewidth=2, markersize=10, label='Soybean Surprise')
