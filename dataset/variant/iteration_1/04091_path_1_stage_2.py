...
ax1.legend(loc='upper right', title='Energy Source', shadow=True, fancybox=True)
ax1.grid(visible=False)
ax1.annotate('Rise of Renewables', xy=(2015, 150), xytext=(2012, 300),
             arrowprops=dict(facecolor='black', shrink=0.05), fontsize=12)

ax2.fill_between(years, 0, total, label='Total Energy Generation',
                 color='#A1CAF1', hatch='/', alpha=0.5)
ax2.fill_between(years, 0, renewable, label='Renewable Energy',
                 color='#90EE90', hatch='\\', alpha=0.8)
...
ax2.legend(loc='lower center', title='Energy Type', frameon=False)
