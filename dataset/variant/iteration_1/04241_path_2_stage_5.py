...
single_color = '#66b3ff'
ax.bar(x - bar_width, games_played, bar_width, color=single_color)
ax.bar(x, won_games, bar_width, color=single_color)
ax.bar(x + bar_width, draw_games, bar_width, color=single_color)
