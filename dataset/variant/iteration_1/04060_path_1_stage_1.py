...
ax2.plot(years, solar_growth, marker='o', linestyle='-', linewidth=2, color='#FFD700')
ax2.plot(years, wind_growth, marker='s', linestyle='--', linewidth=2, color='#87CEEB')
ax2.plot(years, hydro_growth, marker='^', linestyle='-.', linewidth=2, color='#32CD32')
ax2.plot(years, geo_growth, marker='d', linestyle=':', linewidth=2, color='#FF8C00')
ax2.plot(years, bio_growth, marker='x', linestyle='-', linewidth=2, color='#8B4513')
