...
colors = ['#87CEEB']
ax.stackplot(years, energy_data, labels=['Fossil', 'Solar', 'Wind', 'Hydro', 'Nuclear'], colors=colors * 5, alpha=0.85)

total_energy = energy_data.sum(axis=0)
ax.plot(years, total_energy, color='black', linewidth=2.5, marker='o', label='Total')
...
ax.legend(loc='upper left', bbox_to_anchor=(1, 1), fontsize=10, title='Sources')
