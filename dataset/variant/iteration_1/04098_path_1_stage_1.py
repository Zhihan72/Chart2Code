...
# Data for the bar chart with an additional metric
...
market_penetration = [30, 40, 50, 35]  # Market penetration in percentage
...
# Updated bars to include Market Penetration
bars1 = ax1.bar(bar_l - 1.5 * bar_width, user_growth, width=bar_width, color='skyblue', label='User Growth (%)')
bars2 = ax1.bar(bar_l - 0.5 * bar_width, customer_satisfaction, width=bar_width, color='lightgreen', label='Customer Satisfaction (%)')
bars4 = ax1.bar(bar_l + 0.5 * bar_width, market_penetration, width=bar_width, color='orange', label='Market Penetration (%)')

ax2 = ax1.twinx()
bars3 = ax2.bar(bar_l + 1.5 * bar_width, revenue, width=bar_width, color='coral', label='Revenue ($M)')
