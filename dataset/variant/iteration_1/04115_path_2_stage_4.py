...
ax1.stackplot(years, moon_landings, mars_landings, venus_landings, jupiter_landings, saturn_landings,
              colors=['#FFD700', '#FF6347', '#1E90FF', '#32CD32', '#8A2BE2'], alpha=0.8)
...
ax2.plot(years, jupiter_growth_rate, color='#32CD32', marker='o')
ax2.plot(years, saturn_growth_rate, color='#8A2BE2', marker='o')
