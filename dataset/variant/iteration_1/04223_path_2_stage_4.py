...
ax1.set_ylabel('Categories', fontsize=12)  # Changed from 'Book Genres'
ax1.set_xlabel('Avg Yearly Check-Outs', fontsize=12)  # Changed from 'Average Yearly Check-Outs'

plt.tight_layout()
plt.title('Library Book Checkout Summary', fontsize=14, pad=20)  # Added random title
plt.show()