...
# Scatter plot 
scatter = ax1.scatter(screen_time, sleep_quality, c='orange', edgecolor='k', s=100, alpha=0.7, label='Sleep Quality (1-10)')
...
ax2 = ax1.twinx()
ax2.plot(screen_time, sleep_disturbances, color='skyblue', linewidth=2, linestyle='--', label='Sleep Disturbances')
...
# Add legend
scatter_legend = plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='orange', markersize=10, linestyle='None', label='Sleep Quality (1-10)')
line_legend = plt.Line2D([0], [0], color='skyblue', linewidth=2, linestyle='--', label='Sleep Disturbances')
