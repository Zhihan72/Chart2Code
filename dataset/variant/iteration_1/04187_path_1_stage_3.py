...
# Apply a single color to all groups
single_color = ['#66b3ff']  # Consistent color for all groups

plt.figure(figsize=(12, 8))
plt.stackplot(decades, data, labels=age_groups, colors=single_color * len(age_groups), alpha=0.8)
