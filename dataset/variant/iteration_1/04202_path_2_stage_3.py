...
hr_hours = [39, 40, 42, 41, 43, 42, 40, 41, 42, 40, 39, 38, 40, 41]

working_hours_data = [
    software_dev_hours, product_mgmt_hours, 
    marketing_hours, sales_hours, hr_hours
]

fig, (ax1, ax2) = plt.subplots(ncols=2, figsize=(15, 7))

box1 = ax1.boxplot(working_hours_data, vert=False, patch_artist=True, notch=True, widths=0.7)
