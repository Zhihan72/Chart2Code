...
ax1.plot(years, solar_energy, color='orange', linestyle='-', linewidth=2, marker='o', label='Sunshine Power')
ax1.plot(years, wind_energy, color='blue', linestyle='--', linewidth=2, marker='s', label='Breeze Power')
...
ax2 = ax1.twinx()
ax2.plot(years, total_renewable, color='green', linestyle='-', linewidth=2, marker='x', label='Aggregate Green Energy')
