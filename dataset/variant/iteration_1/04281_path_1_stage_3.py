...
# Altering the styles for the average temperatures plot
...
ax1.grid(axis='x', linestyle=':', alpha=0.5)  # Changed to x-axis grid with different style
ax1.legend(loc='lower right', fontsize=10)  # Changed location and size of legend

# Altering the styles for the temperature range bar plot
...
ax2.grid(axis='x', linestyle='-', alpha=0.3)  # Changed to x-axis grid with lighter lines
