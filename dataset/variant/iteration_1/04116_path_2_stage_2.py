...
lake_green = [30, 40, 60, 55]  # New data series for Lake Green
...
ax.fill_between(quarters, lake_blue_cumulative, lake_silver_cumulative, color='lightcoral', alpha=0.7)
ax.fill_between(quarters, total_water_levels, lake_blue_cumulative, color='lightgrey', alpha=0.7)  # New color for Lake Green
