...
san_francisco_temps = np.array([12, 13, 14, 16, 17, 17, 16, 18, 19, 18, 15, 13])

fig, ax = plt.subplots(figsize=(12, 7))

# Changed the colors for each city's temperature line
ax.plot(months, new_york_temps, marker='x', linestyle='--', color='green', label='NYC')
ax.plot(months, los_angeles_temps, marker='D', linestyle='-', color='orange', label='LA')
ax.plot(months, chicago_temps, marker='*', linestyle=':', color='cyan', label='Chi-Town')
ax.plot(months, san_francisco_temps, marker='o', linestyle='-', color='magenta', label='SF')
