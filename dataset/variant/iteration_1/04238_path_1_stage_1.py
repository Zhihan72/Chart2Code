...
bar_width = 0.35
bar1 = ax1.bar(years - bar_width/2, gardens_created, bar_width, label='Gardens Created', color='#ff9999', edgecolor='black', hatch='/')

ax2 = ax1.twinx()
bar2 = ax2.bar(years + bar_width/2, volunteers_joined, bar_width, label='Volunteers Joined', color='#66b3ff', edgecolor='black', hatch='\\')

line = ax2.plot(years, average_area, color='green', marker='s', linestyle='--', label='Avg Garden Area', lw=2, markerfacecolor='yellow')
