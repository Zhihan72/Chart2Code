...
# Steps walked each day by each of the six friends (artificial data)
...
for i, steps in enumerate(steps_data):
    ax.plot(days, steps, marker='o', linestyle='-', color=new_colors[i], label=f'Friend {i + 1}')

# Title and labels
ax.set_title("Weekly Activity Tracking:\nDaily Steps Taken by Six Friends", fontsize=16, fontweight='bold')
...
# Customizing the grid, ticks, and layout
...
annotations = [
    ...
    ("Friend 5 maintained consistency throughout the week.", 3, 5100)
]
