...
teams = ["NLP", "Vision", "Robotics", "Ethics", "Systems", "Security"]
projects = ["Chatbot", "Face Rec", "Self-drive", "Ethics", "Cloud AI", "Secure AI"]
...
team_patch = plt.Line2D([0], [0], marker='o', color='w', label='Teams', markersize=10, markerfacecolor='cornflowerblue', markeredgecolor='black')
project_patch = plt.Line2D([0], [0], marker='s', color='w', label='Projects', markersize=10, markerfacecolor='lightcoral', markeredgecolor='black')
