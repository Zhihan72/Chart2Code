...
comic_series = [
    'Mystery Sleuth',         # Position changed
    'Valiant Avenger',
    'Dark Knight',            # Position changed
    'Cosmic Defender',        # Position changed
    'Fast & Fearless',
    'Captain Marvelous',
    'Spectrum Enigma'
]
annual_profits = [60, 85, 95, 75, 70, 50, 65]  # Corresponding profits shuffled

fig, ax = plt.subplots(figsize=(12, 8))

colors = ['#8A2BE2', '#6495ED', '#00CED1', '#FF69B4', '#FFD700', '#32CD32', '#4169E1']  # Color order changed
