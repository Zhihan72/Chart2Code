...
# Changed colors: shuffling the color assignments
ax.barh(bar1, ai_assistants, height, label='AI Assistants', color='lightgreen', edgecolor='black')
ax.barh(bar2, smart_homes, height, label='Smart Homes', color='lightcoral', edgecolor='black')
ax.barh(bar3, electric_vehicles, height, label='Electric Vehicles', color='skyblue', edgecolor='black')
