...
all_challengers = np.concatenate([market_share_challengers, forecast_challengers])
...
ax.plot(years, market_share_challengers, label='Challengers Ltd.', marker='d', linestyle='-', color='tab:purple', alpha=0.85)
