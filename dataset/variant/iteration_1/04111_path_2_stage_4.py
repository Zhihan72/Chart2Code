...
cities = ['PAR', 'NY', 'SYD', 'LDN', 'TKYO']  # Sorted cities
cuisines = ['Mex.', 'Ital.', 'Ind.', 'Chin.', 'Frn.']  # Sorted cuisines based on specific criteria

data = np.array([
    [85, 75, 75, 70, 60],  # Sorted data for 'Mex.' cuisine
    [120, 110, 100, 90, 95],  # Sorted data for 'Ital.' cuisine
    [110, 95, 90, 80, 95],  # Sorted data for 'Ind.' cuisine
    [100, 95, 90, 90, 80],  # Sorted data for 'Chin.' cuisine
    [90, 85, 80, 70, 65]  # Sorted data for 'Frn.' cuisine
])
...
ax.legend(title='Cuisines', loc='upper left', fontsize=10, edgecolor='grey')
