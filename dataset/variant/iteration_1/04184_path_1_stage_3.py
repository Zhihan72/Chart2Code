...
width = 0.25
ax1.bar(months - width, coffee_sales, width=width, color='skyblue', edgecolor='black', linestyle='-.', label='Coffee')
ax1.bar(months, tea_sales, width=width, color='orange', edgecolor='black', linestyle='--', label='Tea')
ax1.bar(months + width, juice_sales, width=width, color='green', edgecolor='black', linestyle='-', label='Juice')

ax1.set_title('Monthly Beverage Sales (2022)', fontsize=14, fontweight='normal', style='italic')
ax1.set_xlabel('Month', fontsize=12)
ax1.set_ylabel('Sales (K Units)', fontsize=12)
ax1.set_xticks(months)
ax1.set_xticklabels(['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], rotation=45)
ax1.legend(loc='upper right', fontsize=10, title='Beverages', title_fontsize='12')
...
ax2.set_title('2022 Market Share', fontsize=14, fontweight='normal', style='italic')
