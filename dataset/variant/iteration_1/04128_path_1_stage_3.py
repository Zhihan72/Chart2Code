...
ax1.set_title('Total Ticket Sales for All Genres Combined', fontsize=13)
ax1.set_xlabel('Year', fontsize=12)
ax1.set_ylabel('Total Ticket Sales (in millions)', fontsize=12)
ax1.grid(axis='both', linestyle=':', alpha=0.5)

ax2.plot(years, action_sales, marker='s', linestyle='--', color='purple', label='Action', linewidth=2.5)
ax2.plot(years, comedy_sales, marker='^', linestyle='-.', color='darkgreen', label='Comedy', linewidth=2.5)
ax2.plot(years, drama_sales, marker='D', linestyle=':', color='navy', label='Drama', linewidth=2.5)
ax2.plot(years, scifi_sales, marker='*', linestyle='-', color='coral', label='Sci-Fi', linewidth=2.5)
...
ax2.set_title('Ticket Sales Trend for Each Genre', fontsize=13)
ax2.set_xlabel('Year', fontsize=12)
ax2.set_ylabel('Ticket Sales (in millions)', fontsize=12)
