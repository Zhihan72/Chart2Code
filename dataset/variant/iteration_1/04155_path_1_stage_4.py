...
plt.plot(years, solar_energy, color='purple', linestyle='-', linewidth=2, marker='o')
plt.plot(years, wind_energy, color='brown', linestyle='-', linewidth=2, marker='s')
plt.plot(years, hydro_energy, color='grey', linestyle='-', linewidth=2, marker='^')
plt.plot(years, geothermal_energy, color='pink', linestyle='-', linewidth=2, marker='d')
plt.plot(years, biomass_energy, color='orange', linestyle='-', linewidth=2, marker='x')
