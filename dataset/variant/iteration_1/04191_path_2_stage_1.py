...
ax1.plot(years, solar_energy, label='Solar', marker='o', linestyle='-', linewidth=2, color='gold')
ax1.plot(years, wind_energy, label='Wind', marker='s', linestyle='--', linewidth=2, color='skyblue')
ax1.plot(years, hydro_energy, label='Hydro', marker='^', linestyle='-.', linewidth=2, color='mediumseagreen')

# Add titles and labels with shortened text
...
ax2 = ax1.twinx()
ax2.plot(years, total_energy, label='Total', color='purple', linestyle=':', linewidth=2, marker='x')
