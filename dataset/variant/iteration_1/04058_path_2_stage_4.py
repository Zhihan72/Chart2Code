...
ax.plot(decades, coal, label='Charred Rocks', color='navy', marker='D', linestyle='--', linewidth=1.5)
ax.plot(decades, oil, label='Black Gold', color='olive', marker='o', linestyle='-', linewidth=2.5)
ax.plot(decades, natural_gas, label='Methane Rush', color='skyblue', marker='P', linestyle=':', linewidth=2)
ax.plot(decades, nuclear, label='Atomic Age', color='magenta', marker='x', linestyle='-.', linewidth=1)
ax.plot(decades, renewables, label='Green Revolution', color='forestgreen', marker='^', linestyle='-', linewidth=2)

ax.plot(decades, hydrogen, label='Future Fuel', color='teal', marker='s', linestyle='-', linewidth=2)
ax.plot(decades, geothermal, label='Earth Heat', color='darkkhaki', marker='v', linestyle='-', linewidth=2)
