...
sns.kdeplot(y=months, x=temperatures_alpha_norm, ax=ax[0], fill=True, color=common_color_temperature, alpha=0.6, label='Alpha')
sns.kdeplot(y=months, x=temperatures_beta_norm, ax=ax[0], fill=True, color=common_color_temperature, alpha=0.6, label='Beta')
sns.kdeplot(y=months, x=temperatures_gamma_norm, ax=ax[0], fill=True, color=common_color_temperature, alpha=0.6, label='Gamma')
ax[0].set_title("Temperature Density Comparison", fontsize=14, fontweight='bold')
ax[0].set_xlabel("Normalized Temperature", fontsize=12)
ax[0].legend()

# Rainfall density plot
common_color_rainfall = 'green'
sns.kdeplot(y=months, x=rainfall_alpha_norm, ax=ax[1], fill=True, color=common_color_rainfall, alpha=0.6, label='Alpha')
sns.kdeplot(y=months, x=rainfall_beta_norm, ax=ax[1], fill=True, color=common_color_rainfall, alpha=0.6, label='Beta')
sns.kdeplot(y=months, x=rainfall_gamma_norm, ax=ax[1], fill=True, color=common_color_rainfall, alpha=0.6, label='Gamma')
ax[1].set_title("Rainfall Density Comparison", fontsize=14, fontweight='bold')
