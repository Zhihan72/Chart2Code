...
strawberries = np.array([15, 16, 16, 17, 17, 16, 15, 15, 14, 13, 12, 11, 11, 12, 13, 13, 14, 14, 15, 16, 15])
blueberries = 100 - (apples + bananas + oranges + grapes + strawberries)

fig, ax = plt.subplots(figsize=(12, 7))

ax.stackplot(years, apples, bananas, oranges, grapes, strawberries, blueberries,
             colors=['#ff9999', '#66b3ff', '#99ff99', '#ffcc99', '#c2c2f0', '#ffb366'], alpha=0.8)
...
ax.legend(['Apples', 'Bananas', 'Oranges', 'Grapes', 'Strawberries', 'Blueberries'], loc='upper right', 
