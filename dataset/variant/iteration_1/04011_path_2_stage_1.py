...
scooters_usage = [0, 0, 20, 30, 50, 110, 130, 150, 160, 180]  # New data series for scooters
...
ax.plot(years, scooters_usage, label='Scooters', marker='x', linestyle='-', linewidth=2, color='purple')  # Plot new data series
