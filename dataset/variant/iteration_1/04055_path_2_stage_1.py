...
hydro_energy = [80, 82, 85, 90, 95, 100, 100, 105, 110, 115, 120]  # New hydro power data

# Total renewable energy production (Solar + Wind + Hydro)
total_renewable = [s + w + h for s, w, h in zip(solar_energy, wind_energy, hydro_energy)]

# Initialize the plot
fig, ax1 = plt.subplots(figsize=(14, 9))

# Plot Solar, Wind, and Hydro energy on the primary y-axis
...
ax1.plot(years, hydro_energy, color='cyan', linestyle='-.', linewidth=2, marker='^', label='Hydro Energy')
...
ax1.plot(years, p_hydro(years), color='cyan', linestyle=':', alpha=0.5, linewidth=1)
