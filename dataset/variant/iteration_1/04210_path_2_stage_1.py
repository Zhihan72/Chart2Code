...
plt.plot(months, area1_aqi, linestyle='-.', color='purple', marker='x', label='Residential Area')
plt.plot(months, area2_aqi, linestyle='-', color='orange', marker='D', label='Industrial Area')
plt.plot(months, area3_aqi, linestyle='--', color='cyan', marker='*', label='Commercial Area')
