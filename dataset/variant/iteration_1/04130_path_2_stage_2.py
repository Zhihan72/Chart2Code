...
# Plot data
plt.plot(years, country_a_adoption, color='blue', marker='o', linewidth=2, markersize=6)
plt.plot(years, country_b_adoption, color='green', marker='s', linewidth=2, markersize=6)
plt.plot(years, country_c_adoption, color='red', marker='^', linewidth=2, markersize=6)
