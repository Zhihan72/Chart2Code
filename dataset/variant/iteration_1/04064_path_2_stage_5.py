...
ax.bar(sorted_months_north, sorted_north_trees, width=0.3, label='Northern Woods', color='darkcyan', linestyle='dotted', edgecolor='black', align='center')
ax.bar(sorted_months_south, sorted_south_trees, width=0.3, label='Southern Plains', color='lightcoral', linestyle='dashed', edgecolor='black', align='edge')
ax.bar(sorted_months_central, sorted_central_trees, width=0.3, label='Heartland', color='goldenrod', linestyle='dashdot', edgecolor='black', align='center')
...
ax.legend(title='Plantation Areas', title_fontsize='13', fontsize='12', loc='upper left', bbox_to_anchor=(1.1, 1))
