...
# Bar Plot on the left now
x = np.arange(len(elements))
width = 0.4

ax1.bar(x, average_concentration, width, color='#DA70D6')
...
# Horizontal Box Plot on the right now
...
ax2.set_ylabel("Core Samples", fontsize=12)
ax2.set_yticklabels(["Sample A", "Sample B", "Sample C", "Sample D", "Sample E"], fontsize=10, rotation=0)
