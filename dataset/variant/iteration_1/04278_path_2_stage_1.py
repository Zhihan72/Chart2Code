...
# Define a single color for all sectors
single_color = '#99cc99'  # Light green
...
ax1 = axes[0]
ax1.stackplot(decades, area_data, labels=['Residential Solar', 'Commercial Solar', 'Industrial Solar'], colors=[single_color]*3, alpha=0.8)
