...
ax.plot(years, new_york_green_spaces, marker='o', linestyle='-', color='purple', linewidth=2, label='NYC')
ax.plot(years, tokyo_green_spaces, marker='s', linestyle='--', color='orange', linewidth=2, label='Tokyo City')
ax.plot(years, berlin_green_spaces, marker='^', linestyle='-.', color='cyan', linewidth=2, label='Berlin Urban Areas')
