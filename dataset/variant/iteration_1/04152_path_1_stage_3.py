...
months = ['Winter', 'Summer', 'Autumn']
extents = [march_extent, june_extent, september_extent]
markers = ['o', 's', 'D']
...
ax.set_title('Polar Ice Cap Dimensions:\nConsequences of Environmental Shifts (2000-2020)', 
              fontsize=16, fontweight='bold', pad=20)
ax.set_xlabel('Years of Study', fontsize=12)
ax.set_ylabel('Ice Coverage (Million km²)', fontsize=12)

ax.grid(True, linestyle='--', which='major', color='grey', alpha=0.6)
ax.axhline(y=10.0, color='r', linestyle='-', linewidth=1.5, alpha=0.7)
ax.text(2000.5, 10.2, 'Critical Line: 10M km²', color='r', fontsize=10)

ax.legend(title='Seasons', title_fontsize='13', loc='upper right', frameon=False)
