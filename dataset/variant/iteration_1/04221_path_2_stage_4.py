...
# Shuffled colors to assign to the data groups
ax.stackplot(years, data, colors=['#FFCC99', '#FF9999', '#CCD1FF', '#99FF99', '#66B2FF'], alpha=0.8)

ax.set_title('Gadget Invasion (2020-2030)', fontsize=16, fontweight='bold', pad=20)
ax.set_xlabel('Timeline', fontsize=12)
ax.set_ylabel('Usage Share (%)', fontsize=12)
ax.set_xticks(years)
ax.set_xticklabels(years)

ax.annotate('Apex of Alpha', xy=(2021, 37), xytext=(2023, 52),
             arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=10, color='black')
ax.annotate('Surge of Echo', xy=(2020, 24), xytext=(2020, 44),
             arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=10, color='black')
