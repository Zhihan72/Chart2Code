...
categories = ['Electronics', 'Clothing', 'Groceries', 'Household Items', 'Books', 'Sporting Goods']
...
sales_data = np.array([
    ...
    [70, 75, 65, 80],      
    [50, 55, 60, 65],      
    [40, 45, 50, 55],      # Newly added data for "Sporting Goods"
])
...
ax2.barh(categories, annual_sales, color=['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b'])
