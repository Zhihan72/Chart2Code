...
# Data for average monthly rainfall (in mm) for five continents over a year
continents = ['Afr', 'Asia', 'Eur', 'N. Am', 'S. Am']
...
ax.plot(x + 2 * width, yearly_avg, marker='o', color='black', label='Avg', linestyle='-')
