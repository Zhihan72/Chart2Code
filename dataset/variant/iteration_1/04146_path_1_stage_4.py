...
ax.stackplot(years, renewable_energy, carbon_capture_investment, carbon_emissions, 
             colors=['#FF4500', '#32CD32', '#1E90FF'], alpha=0.85)

ax.legend(['Renewable Energy', 'Carbon Capture Investment', 'Carbon Emissions'],
          loc='lower right', frameon=True, facecolor='lightgrey', edgecolor='black')

ax.grid(linestyle=':', linewidth=1.2, color='gray', alpha=0.7)
