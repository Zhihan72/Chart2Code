...
ax.plot(months, la_temps, marker='o', linestyle='-', color='orange', linewidth=2)
ax.plot(months, ny_temps, marker='o', linestyle='-', color='blue', linewidth=2)
ax.plot(months, chicago_temps, marker='o', linestyle='-', color='green', linewidth=2)
