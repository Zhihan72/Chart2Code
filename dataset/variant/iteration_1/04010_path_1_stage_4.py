...
agricultural = [0.2, 0.25, 0.3, 0.35, 0.5, 0.7, 0.9, 1.2, 1.5, 1.9, 2.3, 2.8, 3.4, 4, 4.7, 5.4, 6.2, 7.1, 8, 9, 10.1]

fig, ax = plt.subplots(figsize=(14, 8))

ax.stackplot(years, residential, commercial, industrial, transportation, agricultural,
             colors=['#66c2a5', '#8da0cb', '#fc8d62', '#e78ac3', '#a6d854'], alpha=0.8)
