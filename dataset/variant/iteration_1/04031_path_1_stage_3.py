...
ax1.bar(x_pos - 0.5*bar_width, industrial_devices, width=bar_width, label='Industrial Devices', hatch='\\', color='#FF5733')
ax1.bar(x_pos + 0.5*bar_width, healthcare_devices, width=bar_width, label='Healthcare Devices', hatch='x', color='#FF5733')
ax1.bar(x_pos + 1.5*bar_width, automotive_devices, width=bar_width, label='Automotive Devices', hatch='-', color='#FF5733')
...
ax2.bar(x_pos - 0.5*bar_width, industrial_growth, width=bar_width, label='Industrial Growth', color='#FF5733', linestyle='--', linewidth=2)
ax2.bar(x_pos + 0.5*bar_width, healthcare_growth, width=bar_width, label='Healthcare Growth', color='#FF5733', linestyle='-.', linewidth=2)
ax2.bar(x_pos + 1.5*bar_width, automotive_growth, width=bar_width, label='Automotive Growth', color='#FF5733', linestyle='-', linewidth=2)
