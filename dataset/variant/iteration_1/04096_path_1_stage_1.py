...
# Altered Backstory: Evaluation of Sales Approaches for H1 2023

# Shuffled sales strategies
strategies = [
    'Field Sales', 'Refer-a-Friend', 'Online Marketing', 
    'Telemarketing', 'Email Campaigns', 'Retail Partnerships'
]

# Altered sales percentages data
sales_percentages = [20, 15, 40, 10, 10, 5]

# Revenues adapted to match shuffled strategies (constructed data)
