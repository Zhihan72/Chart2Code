...
ax.stackplot(
    ...
    colors=['#9467bd', '#d62728', '#1f77b4', '#ff7f0e', '#2ca02c'], # Changed colors
    alpha=0.7
)

ax2 = ax.twinx()
ax2.plot(years, cumulative_ai, 'm-.', linewidth=2, label='Total AI Development') # Changed line style and color
...
ax2.set_ylabel('Total AI Development', fontsize=14, color='m') # Changed color
