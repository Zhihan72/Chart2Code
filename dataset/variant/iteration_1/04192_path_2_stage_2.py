...
# Popularity scores (out of 100) for seven different board games
...
ax.plot(years, gloomhaven, label='HAVEN', color='brown', linewidth=2)
ax.plot(years, azul, label='AZUL', color='pink', linewidth=2)
