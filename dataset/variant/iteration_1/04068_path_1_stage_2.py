...
colors = ['#FFD700', '#87CEFA', '#2E8B57', '#FF6347', '#8A2BE2', '#FF4500']

fig, ax = plt.subplots(figsize=(12, 8))

ax.stackplot(years, company_a, company_b, company_c, company_d, company_e, company_f, labels=companies, colors=colors, alpha=0.8)
