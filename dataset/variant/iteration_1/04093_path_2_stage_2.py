...
box = ax.boxplot(water_usage_data, vert=False, patch_artist=True, labels=household_types, notch=False, whis=[10, 90])
...
ax.set_title('Monthly Water Consumption:\nComparison Across Different Types of Households', fontsize=14, fontweight='regular')
