...
for idx, region in enumerate(regions):
    ax[idx].bar(years - width, solar_projects[region], width=width, color=single_color)
    ax[idx].bar(years, wind_projects[region], width=width, color=single_color)
    ax[idx].bar(years + width, hydro_projects[region], width=width, color=single_color)
