...
# Shuffle the assigned colors: swap 'blue' for 'green' and 'green' for 'blue'
ax.plot(years, revenue, marker='o', linestyle='-', linewidth=2, color='green')
ax.plot(years, profit, marker='^', linestyle=':', linewidth=2, color='blue')
