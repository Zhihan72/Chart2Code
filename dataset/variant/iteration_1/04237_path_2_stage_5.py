...
colors_2015 = ['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b']
colors_2020 = ['#e377c2', '#7f7f7f', '#bcbd22', '#17becf', '#ffbf00', '#aec7e8']

bar_width = 0.4
bar_locs_2015 = np.arange(len(countries))

bars_2015 = ax[0].bar(bar_locs_2015, choco_consumption_2015_sorted, bar_width, color=colors_2015, edgecolor='black')
...
bars_2020 = ax[1].bar(bar_locs_2015, choco_consumption_2020_sorted, bar_width, color=colors_2020, edgecolor='black')
...
fig.text(0.5, 0.02, 'Nations', ha='center', fontsize=12)
