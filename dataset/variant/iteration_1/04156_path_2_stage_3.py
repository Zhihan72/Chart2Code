...
ax2.bar(x - 1.5*width, mean_scores[0], width, label='Trad', color='#FF69B4')
ax2.bar(x - 0.5*width, mean_scores[1], width, label='Inter', color='#87CEFA')
ax2.bar(x + 0.5*width, mean_scores[2], width, label='Online', color='#FFD700')
ax2.bar(x + 1.5*width, mean_scores[3], width, label='Hybrid', color='#FFA07A')
