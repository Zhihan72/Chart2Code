...
geothermal = np.array([2, 4, 8, 12, 18, 25, 33, 42, 52, 63, 75])  # New dataset added
...
ax1.stackplot(years, solar, wind, hydro, geothermal, fossil,
              labels=['Sun', 'Windy', 'Water', 'Geothermal', 'Traditional'],
              colors=['#FF5733', '#33FF57', '#3357FF', '#FFCC33', '#FF33F6'], alpha=0.7)
