...
ax1.set_ylabel("Average Temperature (°C)", fontsize=14, color='tab:green')
ax1.plot(months, avg_temp, color='forestgreen', label='Average Temperature', linestyle='--', marker='o', markersize=8)
