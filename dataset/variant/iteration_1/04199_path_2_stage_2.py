...
handles = [
    plt.Line2D([0], [0], marker='s', color='w', label='Voyager 1', markerfacecolor='#1f77b4', markersize=12),
    plt.Line2D([0], [0], marker='^', color='w', label='Voyager 2', markerfacecolor='#ff7f0e', markersize=12),
    plt.Line2D([0], [0], marker='D', color='w', label='Cassini', markerfacecolor='#2ca02c', markersize=12),
    plt.Line2D([0], [0], marker='v', color='w', label='Juno', markerfacecolor='#d62728', markersize=12),
    plt.Line2D([0], [0], marker='H', color='w', label='New Horizons', markerfacecolor='#9467bd', markersize=12),
    plt.Line2D([0], [0], marker='p', color='w', label='Mariner 10', markerfacecolor='#8c564b', markersize=12),
    plt.Line2D([0], [0], marker='X', color='w', label='Galileo', markerfacecolor='#e377c2', markersize=12),
