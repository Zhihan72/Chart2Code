...
ax1.plot(years, solar_energy, color='purple', linestyle='-', linewidth=2, marker='o', label='Solar Energy')
ax1.plot(years, wind_energy, color='darkgreen', linestyle='--', linewidth=2, marker='s', label='Wind Energy')
ax1.plot(years, hydro_energy, color='magenta', linestyle='-.', linewidth=2, marker='^', label='Hydro Energy')

ax1.grid(True, linestyle='--', linewidth=0.5, alpha=0.7)

ax2 = ax1.twinx()
ax2.plot(years, total_renewable, color='darkred', linestyle='-', linewidth=2, marker='x', label='Total Renewable')

ax1.set_title('Decade-long Progress in Renewable Energy Production\nFocus on Solar, Wind, and Hydro Energy (2010-2020)', fontsize=16, weight='bold')
...
ax1.text(highlight_year + 0.2, 250, 'Milestone in 2018', color='red', fontsize=12, rotation=90)
