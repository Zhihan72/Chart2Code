...
plt.plot(months, area1_aqi, linestyle='-', color='purple', marker='o', label='Living Zone')
plt.plot(months, area2_aqi, linestyle='--', color='orange', marker='s', label='Factory Region')
plt.plot(months, area3_aqi, linestyle=':', color='magenta', marker='^', label='Shopping District')
