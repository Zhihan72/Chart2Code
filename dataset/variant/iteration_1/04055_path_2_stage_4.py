...
ax1.plot(years, solar_energy, color='purple', linestyle='-', linewidth=2, marker='o')
ax1.plot(years, wind_energy, color='darkgreen', linestyle='--', linewidth=2, marker='s')
ax1.plot(years, hydro_energy, color='magenta', linestyle='-.', linewidth=2, marker='^')

ax2 = ax1.twinx()
ax2.plot(years, total_renewable, color='darkred', linestyle='-', linewidth=2, marker='x')
