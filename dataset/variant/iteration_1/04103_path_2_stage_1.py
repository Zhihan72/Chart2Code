...
# Plot each celestial body's flight path
for body, distances in distance_to_planets.items():
    ax.plot(time, distances, label=body, marker='o', linestyle='-', linewidth=2, alpha=0.7)
