...
axes[0].plot(years, python_popularity, label='Python', color='#FF5733', marker='o', linestyle='-', linewidth=2)
axes[0].plot(years, javascript_popularity, label='JavaScript', color='#33FF57', marker='s', linestyle='--', linewidth=2)
axes[0].plot(years, java_popularity, label='Java', color='#3357FF', marker='^', linestyle='-.', linewidth=2)
axes[0].plot(years, csharp_popularity, label='C#', color='#F7DC6F', marker='D', linestyle=':', linewidth=2)
axes[0].plot(years, ruby_popularity, label='Ruby', color='#AF7AC5', marker='*', linestyle='-', linewidth=2)
...
# New colors for bars
axes[1].bar(years, python_diff, label='Python', color='#FF5733', alpha=0.6)
axes[1].bar(years, javascript_diff, label='JavaScript', color='#33FF57', alpha=0.6, bottom=python_diff)
axes[1].bar(years, java_diff, label='Java', color='#3357FF', alpha=0.6, bottom=python_diff + javascript_diff)
axes[1].bar(years, csharp_diff, label='C#', color='#F7DC6F', alpha=0.6, bottom=python_diff + javascript_diff + java_diff)
axes[1].bar(years, ruby_diff, label='Ruby', color='#AF7AC5', alpha=0.6, bottom=python_diff + javascript_diff + java_diff + csharp_diff)
