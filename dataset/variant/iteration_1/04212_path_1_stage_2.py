...
ax.stackplot(years, red_dwarf, yellow_dwarf, blue_giant, white_dwarf, neutron_stars, black_holes, supernovae,
             labels=['Red Dwarf', 'Yellow Dwarf', 'Blue Giant', 'White Dwarf', 'Neutron Stars', 'Black Holes', 'Supernovae'],
             colors=['#1e90ff']*7)

ax.set_title('Galactic Energy Distribution (2100 - 2115)', fontsize=16)
