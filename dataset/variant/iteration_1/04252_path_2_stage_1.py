...
# Primary y-axis for carbon emissions with altered style
color1 = 'tab:purple'
...
# Secondary y-axis for cost with altered style
ax2 = ax1.twinx()
color2 = 'tab:cyan'
...
# Third y-axis for capacity with altered style
ax3 = ax1.twinx()
...
# Altered legend position and grid
