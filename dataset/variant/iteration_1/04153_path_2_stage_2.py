...
# Shuffled data within each category to preserve their means but alter their order
...
# Recalculate cumulative_ai to reflect the changes
...
ax2 = ax.twinx()
ax2.plot(years, cumulative_ai, 'm-.', linewidth=2, label='Total AI Development')
...
ax2.set_ylabel('Total AI Development', fontsize=14, color='m')
