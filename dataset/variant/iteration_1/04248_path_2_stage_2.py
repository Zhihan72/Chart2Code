...
ax.fill(angles, berries, color='blue', alpha=0.25)
ax.plot(angles, berries, color='blue', linewidth=2)

ax.fill(angles, citrus, color='orange', alpha=0.25)
ax.plot(angles, citrus, color='orange', linewidth=2)

ax.fill(angles, tropical, color='green', alpha=0.25)
ax.plot(angles, tropical, color='green', linewidth=2)

ax.fill(angles, stone_fruits, color='red', alpha=0.25)
ax.plot(angles, stone_fruits, color='red', linewidth=2)

ax.fill(angles, melons, color='purple', alpha=0.25)
ax.plot(angles, melons, color='purple', linewidth=2)

ax.fill(angles, pomaceous, color='brown', alpha=0.25)
