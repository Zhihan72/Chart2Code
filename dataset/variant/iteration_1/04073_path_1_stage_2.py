...
# Apply a single color '#228B22' consistently across all data groups
ax.plot(years, forest_population, label='Forest', color='#228B22', linewidth=2, marker='o')
ax.plot(years, grassland_population, label='Grassland', color='#228B22', linewidth=2, marker='s')
ax.plot(years, wetland_population, label='Wetland', color='#228B22', linewidth=2, marker='^')
