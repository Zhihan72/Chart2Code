...
avg_books_read = [4, 3, 2, 2.5, 3.5, 4.5]  # Average books read per month

# Percentage of people in each age group who enjoy reading
enjoy_reading_percentages = [75, 65, 55, 60, 70, 80]  # in %

# Define a single consistent color for the bars
single_color = '#4682B4'
...
# Plot bar chart with a single color
