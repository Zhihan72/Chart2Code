...
ax.plot(years, new_york_green_spaces, marker='o', linestyle='-', color='purple', linewidth=2, label='New York')
ax.plot(years, tokyo_green_spaces, marker='s', linestyle='--', color='orange', linewidth=2, label='Tokyo')
ax.plot(years, berlin_green_spaces, marker='^', linestyle='-.', color='cyan', linewidth=2, label='Berlin')
