...
ax.boxplot(data, vert=False, patch_artist=True, labels=fruit_labels, notch=True,
...
ax.set_ylabel("Types of Fruits", fontsize=12)
ax.set_xlabel("Vitamin C Content (mg)", fontsize=12)
