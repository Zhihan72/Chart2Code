...
ax2.plot(years, moon_growth_rate, label='Luna', color='#FFD700', marker='o')
ax2.plot(years, mars_growth_rate, label='Ares', color='#FF6347', marker='o')
ax2.plot(years, venus_growth_rate, label='Aphrodite', color='#1E90FF', marker='o')
