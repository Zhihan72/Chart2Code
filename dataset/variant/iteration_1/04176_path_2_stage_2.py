...
for i, data in enumerate([smart_thermostats, smart_lighting, voice_assistants]):
    city1 = axs[i].bar(position - bar_width/2, data[0], bar_width, label=cities[0], color=colors[0])
    city2 = axs[i].bar(position + bar_width/2, data[1], bar_width, label=cities[1], color=colors[1])
