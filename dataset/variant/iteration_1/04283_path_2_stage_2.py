...
axs[0].spines['top'].set_visible(False)  # Hide top border
axs[0].spines['right'].set_visible(False)  # Hide right border
...
axs[1].spines['top'].set_visible(False)  # Hide top border
axs[1].spines['right'].set_visible(False)  # Hide right border
