...
axs.plot(density_pre_industrial(x_range_pre), x_range_pre, label="Pre-Industrial Era", color='blue')
axs.fill_betweenx(x_range_pre, 0, density_pre_industrial(x_range_pre), color='blue', alpha=0.2)
