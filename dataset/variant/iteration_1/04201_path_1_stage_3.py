...
# Additional data for two more months
...
# Plotting additional data for September
axs[2].bar(brightness_bins, stars_sep, color='lightblue', edgecolor='black')
axs[2].set_title('Star Brightness in Sep')
axs[2].set_xlabel('Brightness Range (Magnitude)')
axs[2].grid(axis='y', linestyle='--', alpha=0.7)

# Plotting additional data for March
axs[3].bar(brightness_bins, stars_mar, color='lightyellow', edgecolor='black')
