...
width = 0.3  # Adjusted width for the remaining grouped bars

fig, ax1 = plt.subplots(figsize=(14, 8))

# Grouped bar plots with exotic sales removed
ax1.bar(x - width / 2, classic_sales, width, label='Classic', color='#1f77b4', edgecolor='black')
ax1.bar(x + width / 2, seasonal_sales, width, label='Seasonal', color='#2ca02c', edgecolor='black')
