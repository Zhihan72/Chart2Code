...
# Manually shuffle colors by changing their order
colors = plt.cm.viridis(
    np.array([0.5, 0.8, 0.3, 0.7, 0.1, 0.2, 0.9, 0.4, 1.0, 0.0, 0.6, np.random.rand(), np.random.rand(), np.random.rand(), np.random.rand()])
)
