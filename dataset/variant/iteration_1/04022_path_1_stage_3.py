...
def create_comparison_chart():
    ...
    wedges, texts, autotexts = ax1.pie(
        ...
        colors=new_colors, explode=explode, shadow=True, wedgeprops=dict(linestyle=':', linewidth=1.5)
    )
...
create_pie(title, clean_energy_sources, market_share, new_colors, explode)
