...
sales_grapes = np.array([3, 4, 4, 5, 3, 4, 5, 6, 4, 3, 4, 4])  # New fruit in positive group
...
sales_honeydew = np.array([2, 2, 2.5, 3, 2.5, 3, 3.5, 3, 2.5, 3, 3.5, 3])  # New fruit in positive group
sales_jackfruit = np.array([0.8, 1, 1.2, 1.5, 1.3, 1.6, 2, 1.8, 2, 2.2, 1.8, 2]) # New fruit in negative group
...
positive_colors = ['#FF9999', '#FFE4B5', '#E37222', '#DA70D6', '#87CEFA']
...
bottom = np.zeros(n_months)
negative_colors = ['#8B4513', '#8FBC8F', '#DB7093', '#FFD700']
