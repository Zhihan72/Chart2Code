...
sns.kdeplot(y=researcher_density, ax=ax, fill=True, color="mediumseagreen", label="Scholar Abundance")
sns.kdeplot(y=patents_filed, ax=ax, fill=True, color="mediumvioletred", label="Inventions Created")
