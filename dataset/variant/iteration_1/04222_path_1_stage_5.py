...
# Switch the positions of 'Wizard' and 'Orc' within the layout
new_order = ['Elf', 'Orc', 'Dragon', 'Wizard']
new_colors = ['#FF1493', '#FFD700', '#B22222', '#228B22']

fig, axs = plt.subplots(nrows=2, ncols=2, figsize=(9, 9), subplot_kw=dict(polar=True))
fig.subplots_adjust(hspace=0.35, wspace=0.35)

for ax, (creature, color) in zip(axs.flat, zip(new_order, new_colors)):
