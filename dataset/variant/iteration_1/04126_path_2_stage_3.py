...
# New data series for video games and ebooks
video_games = np.array([2, 2, 3, 5, 7, 10, 13, 15, 18, 20, 22])
ebooks = np.array([1, 1, 2, 3, 3, 4, 5, 6, 7, 8, 9])

# Update media_data to include new data series
media_data = np.vstack([streaming_services, social_media, online_news, podcasts, video_games, ebooks])

fig, ax = plt.subplots(figsize=(14, 8))

# Update labels and colors for the new dataset
ax.stackplot(years, media_data, labels=['Podcasts', 'Online News', 'Social Media', 'Streaming Services', 'Video Games', 'E-books'], 
