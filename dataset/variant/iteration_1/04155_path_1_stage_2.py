...
plt.plot(years, solar_energy, color='purple', linestyle='-', linewidth=2, marker='o', label='Solar Energy')
plt.plot(years, wind_energy, color='brown', linestyle='-', linewidth=2, marker='s', label='Wind Energy')
plt.plot(years, hydro_energy, color='grey', linestyle='-', linewidth=2, marker='^', label='Hydro Energy')
plt.plot(years, geothermal_energy, color='pink', linestyle='-', linewidth=2, marker='d', label='Geothermal Energy')
plt.plot(years, biomass_energy, color='orange', linestyle='-', linewidth=2, marker='x', label='Biomass Energy')
