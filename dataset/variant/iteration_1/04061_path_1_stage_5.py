...
# Histogram placed in the first subplot
axs[0].hist(all_ages_usage, bins=np.arange(0, 6, 0.5), color='mediumaquamarine', edgecolor='black', alpha=0.7)
axs[0].yaxis.grid(True, linestyle='--', which='major', color='grey', alpha=0.5)

# Boxplot placed in the second subplot
boxplot = axs[1].boxplot(smartphone_usage, patch_artist=True, notch=True, vert=False, showmeans=True)
...
axs[1].xaxis.grid(True, linestyle='--', which='major', color='grey', alpha=0.5)
