...
ax.plot(range(1, len(academies) + 1), averages, marker='*', linestyle='--', color='green', label='Average Score')
...
ax.set_xlabel('Academy of Magic', fontsize=14, fontweight='light')
ax.set_ylabel('Trial Scores', fontsize=14, fontweight='light')
