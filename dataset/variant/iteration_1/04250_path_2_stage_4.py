...
model_epsilon_sales = np.array([7, 8, 10, 11, 13, 14, 16, 17, 19, 22, 24, 28])

fig, ax = plt.subplots(figsize=(14, 8))

# Updated set of colors
new_colors = ['#FF6699', '#66FF66', '#6699FF', '#FF9933', '#CC66FF']
linestyles = ['-', '--', '-.', ':', '-']
markers = ['o', 'v', 's', 'd', '^']

for sales, color, linestyle, marker in zip(
    [model_alpha_sales, model_beta_sales, model_gamma_sales, model_delta_sales, model_epsilon_sales],
