...
ax.stackplot(years, tubers, legumes, leafy_greens, fruits,
             labels=['Tubers', 'Legumes', 'Leafy', 'Fruits'],
             colors=['#FFD700', '#98FB98', '#20B2AA', '#FF6347'], alpha=0.7)

# Set the title and labels
ax.set_title("Mars Food Production (2040-2070)", fontsize=18, fontweight='bold', pad=20)
...
ax.legend(loc='upper left', title="Crops", fontsize=12, title_fontsize='13', frameon=False)
...
ax.annotate('Advanced Agri Tech', xy=(2055, 240), xytext=(2045, 400),
            arrowprops=dict(facecolor='black', arrowstyle='->', lw=1.5),
            fontsize=12, color='darkred')

# Add a description box detailing the trend
props = dict(boxstyle='round', facecolor='lightblue', alpha=0.2)
textstr = ('Increasing production\n'
           'in the Mars colony,\n'
           'impacted by tech advances.')
