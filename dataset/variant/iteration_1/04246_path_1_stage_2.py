...
sns.kdeplot(researcher_density, ax=ax, fill=True, color="steelblue", label="Density of Researchers")
sns.kdeplot(patents_filed, ax=ax, fill=True, color="steelblue", label="Filed Patents")
...
scatter_ax.scatter(researcher_density, patents_filed, color='steelblue', edgecolor='black', s=80, alpha=0.7)
