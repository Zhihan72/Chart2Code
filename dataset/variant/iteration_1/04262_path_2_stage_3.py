...
axes[0, 0].bar(sorted_genres_downtown, sorted_popularity_downtown, color='lavender', edgecolor='red', linestyle='-.')
...
axes[0, 1].bar(sorted_genres_uptown, sorted_popularity_uptown, color='beige', edgecolor='black', linewidth=1.5)
...
axes[1, 0].bar(sorted_genres_revenue_downtown, sorted_revenue_downtown, color='lavender', edgecolor='red', linestyle='--')
...
axes[1, 1].bar(sorted_genres_revenue_uptown, sorted_revenue_uptown, color='beige', edgecolor='brown', linewidth=2, linestyle=':')
