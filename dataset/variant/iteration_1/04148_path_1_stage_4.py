...
operational_costs = np.array([0.3, 1.0, 1.8, 3.5, 6.0, 7.5, 10.0, 13.0, 18.0, 25.0])

fig, ax = plt.subplots(figsize=(12, 6))

ax.plot(years, revenue, marker='o', linestyle='-', color='#FF6347', lw=2, markersize=8)
ax.plot(years, operational_costs, marker='s', linestyle='--', color='#4682B4', lw=2, markersize=8)
...
for i in range(len(years)):
    ...
    ax.text(years[i], operational_costs[i] + 1, f'{operational_costs[i]:.1f}', ha='center', fontsize=10, color='royalblue')
