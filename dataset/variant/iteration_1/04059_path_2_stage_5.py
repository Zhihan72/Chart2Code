...
# Data
genres = ['Drama', 'Adventure', 'Horror', 'Comedy', 'Thriller', 'Autobiography']
...
# Shuffled Colors for genres
colors = ['#99ff99', '#ffb3e6', '#c2c2f0', '#66b3ff', '#ff9999', '#ffcc99']

# Create a figure with a subplot
fig, ax = plt.subplots(figsize=(12, 8))

# Bar Chart
bars = ax.bar(genres, average_annual_sales, color=colors)
...
ax_inset.pie(percentage_sales, autopct='%1.1f%%', startangle=140, colors=colors, pctdistance=0.85,
