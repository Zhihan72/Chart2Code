...
ax.plot(days, children_steps, marker='o', linestyle='-', linewidth=2, label='Kids', color='#E377C2')
ax.plot(days, adults_steps, marker='s', linestyle='--', linewidth=2, label='Adults', color='#17BECF')
ax.plot(days, elderly_steps, marker='^', linestyle='-.', linewidth=2, label='Elders', color='#BCBD22')
...
ax.legend(title='Group', fontsize=10, loc='upper left')
