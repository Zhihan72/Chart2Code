...
consistent_color = '#ff7f0e'  # Using a single consistent color

ax.stackplot(years, sales_data, labels=['Printed Books', 'Digital Volumes', 'Spoken Editions'], 
             colors=[consistent_color, consistent_color, consistent_color], alpha=0.9, linestyle='-.')
...
ax_inset.plot(years, audiobooks_sales, marker='s', color=consistent_color, linestyle='--')
