...
# Remaining agencies after removal
agencies = ['Sherlock Holmes & Co.', 'Poirot Detective Services', 'Columbo Association']

# Solve rate data for the remaining agencies (with Marple Investigations removed)
