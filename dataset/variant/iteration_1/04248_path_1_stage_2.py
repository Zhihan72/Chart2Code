...
ax.fill(angles, berries, color='purple', alpha=0.25)
ax.plot(angles, berries, color='purple', linewidth=2)

ax.fill(angles, citrus, color='yellow', alpha=0.25)
ax.plot(angles, citrus, color='yellow', linewidth=2)

ax.fill(angles, tropical, color='brown', alpha=0.25)
ax.plot(angles, tropical, color='brown', linewidth=2)

ax.fill(angles, stone_fruits, color='pink', alpha=0.25)
