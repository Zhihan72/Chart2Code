...
# Title and Labels
ax.set_title('Book Sales Overview (2011-2021)', fontsize=16, fontweight='bold')
ax.set_xlabel('Genres of Books', fontsize=12)
ax.set_ylabel('Annual Sales Average', fontsize=12)
