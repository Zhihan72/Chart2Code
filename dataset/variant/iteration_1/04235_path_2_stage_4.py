...
fruits = ['Apricots', 'Blueberries', 'Cranberries', 'Dragonfruit', 'Emu Apples', 'Feijoas', 'Guavas', 'Huckleberries']
...
for idx, total in enumerate(total_sales):
    ax.annotate(f'Bundle: {total:.1f}', xy=(idx, total + 1), fontsize=10, ha='center', color='black')
