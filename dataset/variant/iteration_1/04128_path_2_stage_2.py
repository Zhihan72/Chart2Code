...
ax1.plot(years, action_sales, marker='o', linestyle='-', color='red', linewidth=2)
ax1.plot(years, comedy_sales, marker='o', linestyle='-', color='blue', linewidth=2)
ax1.plot(years, drama_sales, marker='o', linestyle='-', color='green', linewidth=2)
ax1.plot(years, scifi_sales, marker='o', linestyle='-', color='purple', linewidth=2)

annotations = {
    'Act': (years[np.argmax(action_sales)], max(action_sales)),
    'Com': (years[np.argmax(comedy_sales)], max(comedy_sales)),
