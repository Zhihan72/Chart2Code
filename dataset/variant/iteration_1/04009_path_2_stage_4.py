...
ax1.bar(years, solar_energy, label='Solar', color='#FFC300')          # Color changed
...
ax1.legend(title='Energy Source', loc='upper right')  # Changed legend location
ax1.grid(True, axis='y', linestyle='-.', alpha=0.5)   # Changed grid style

ax2.plot(years, total_energy_usage, marker='s', linestyle='--', color='teal', label='Total Energy Usage')  # Changed marker and line style
...
ax2.legend(loc='upper left')                          # Changed legend location
