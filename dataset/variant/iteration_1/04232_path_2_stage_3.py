...
box = ax.boxplot(solve_rates, vert=True, patch_artist=True, labels=agencies, notch=False, showfliers=True, whis=1.0)

colors = ['#32CD32', '#8A2BE2', '#FF4500']
patterns = ['/', 'o', '\\']
...
for i, mean in enumerate(means):
    ax.text(i + 1, mean, f'{mean:.1f}%', ha='center', va='bottom', fontsize=10, fontweight='bold', color='brown')
...
plt.ylabel('Resolution Rate (%)', fontsize=11)
plt.xlabel('Detective Organizations', fontsize=11)
