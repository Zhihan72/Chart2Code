...
axs[0].set_title('Lunar Rover Activities by Analyst Teams\nMonthly Rover Hours in Unique Zones', fontsize=14, fontweight='bold', color='#1a535c')
axs[0].set_xlabel('Hours Operated per Month', fontsize=12, fontweight='bold')
...
axs[1].set_title('Monthly Aggregated Hours by Team Category', fontsize=14, fontweight='bold', color='#1a535c')
axs[1].set_xlabel('Aggregate Hours', fontsize=12, fontweight='bold')
