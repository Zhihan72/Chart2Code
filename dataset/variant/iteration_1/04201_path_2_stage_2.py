...
# Modified styles and elements
axs[0].bar(brightness_bins, stars_dec, color='mediumseagreen', edgecolor='orange', hatch='/')
...
axs[1].bar(brightness_bins, stars_jan, color='steelblue', edgecolor='yellow', hatch='\\')
axs[1].set_title('Star Brightness in Jan')
axs[1].set_xlabel('Brightness Range')
axs[1].grid(axis='x', linestyle='-', alpha=0.3)

axs[2].bar(brightness_bins, stars_jun, color='sandybrown', edgecolor='purple', hatch='|')
