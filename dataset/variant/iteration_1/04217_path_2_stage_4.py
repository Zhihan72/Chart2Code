...
ax.barh(years_shifted, laptops, height=bar_height, color='#2ca02c', alpha=0.8, label='Laptops')
ax.barh(years_shifted + bar_height, desktops, height=bar_height, color='#d62728', alpha=0.8, label='Desktops')
