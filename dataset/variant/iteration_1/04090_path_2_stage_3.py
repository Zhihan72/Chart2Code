...
ax[0].plot(x_range_pre, density_pre_industrial(x_range_pre), label="Era of Stable CO2", color='blue')
ax[0].fill_between(x_range_pre, density_pre_industrial(x_range_pre), color='blue', alpha=0.2)

# Plot 2: Post-Industrial Era
ax[1].plot(x_range_post, density_post_industrial(x_range_post), label="CO2 Surge Era", color='blue')
ax[1].fill_between(x_range_post, density_post_industrial(x_range_post), color='blue', alpha=0.2)

# Plot 3: Hypothetical Future Era
ax[2].plot(x_range_future, density_future(x_range_future), label="Future Speculation Era", color='blue')
ax[2].fill_between(x_range_future, density_future(x_range_future), color='blue', alpha=0.2)
