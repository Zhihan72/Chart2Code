...
# Altering styles with different colors and markers
ax.plot(day_indices, solar_temps, marker='^', markersize=7, color='blue', label='Solaris', linestyle='--', linewidth=2)
ax.plot(day_indices, rain_temps, marker='s', markersize=6, color='purple', label='Rainfall', linestyle='-.', linewidth=2)
