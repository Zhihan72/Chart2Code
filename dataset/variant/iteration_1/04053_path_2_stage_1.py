...
orbital_radius_planet_d = np.cos(years / 3) * 0.6 + 1.1 # New data series for Planet D
orbital_radius_planet_e = np.cos((years - 1) / 4) * 0.2 + 2.5 # New data series for Planet E
...
# Plotting the data for Planet D
ax.plot(years, orbital_radius_planet_d, linestyle='-', marker='D', color='purple', label='Planet D')
# Plotting the data for Planet E
ax.plot(years, orbital_radius_planet_e, linestyle='-', marker='x', color='orange', label='Planet E')
