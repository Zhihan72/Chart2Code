...
ax1.bar(x_pos - 1.5*bar_width, smart_home_devices, width=bar_width, label='Gadgetry Devices', color='#FF5733')
ax1.bar(x_pos - 0.5*bar_width, industrial_devices, width=bar_width, label='Factory Devices', color='#33FF57')
ax1.bar(x_pos + 0.5*bar_width, healthcare_devices, width=bar_width, label='Health Gadgets', color='#3357FF')
ax1.bar(x_pos + 1.5*bar_width, automotive_devices, width=bar_width, label='Vehicle Gear', color='#FF33FF')
