...
bars_summer = ax.bar(x_positions - bar_width / 2, sorted_summer_harvest, bar_width, label='Summer', color='#FFA07A', linestyle='-', edgecolor='purple')
bars_winter = ax.bar(x_positions + bar_width / 2, sorted_winter_harvest, bar_width, label='Winter', color='#20B2AA', linestyle='-.', edgecolor='brown')
...
ax.set_xlabel('Veggies', fontsize=13, fontstyle='italic')
ax.set_ylabel('Harvest (kg)', fontsize=13, fontweight='light')
ax.set_title('Seasonal Harvest', fontsize=15, fontstyle='oblique')
