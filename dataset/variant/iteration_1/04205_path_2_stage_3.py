...
sources = ['Fossil Commodities', 'Sunshine', 'Breeze', 'Water']
colors = ['#FF6347', '#FF8C00', '#4682B4', '#3CB371']

fig, ax = plt.subplots(figsize=(14, 8))
ax.stackplot(years, energy_data, labels=sources, colors=colors, alpha=0.85)

total_energy = energy_data.sum(axis=0)
ax.plot(years, total_energy, color='black', linewidth=2.5, marker='o', label='Overall Energy Output')

ax.set_title("World Energy Output Patterns (1970-2020)\nTransition from Fossil Consumption to Renewables", 
...
ax.legend(loc='upper left', bbox_to_anchor=(1, 1), fontsize=10, title='Energy Mediums')

ax.annotate('Initiation of Solar Growth', xy=(1980, 100), xytext=(1985, 15000),
            arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=10)
ax.annotate('Wind Power Rise', xy=(2000, 700), xytext=(2005, 20000),
            arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=10)
ax.annotate('Hydro Equilibrium', xy=(1995, 4500), xytext=(2000, 15000),
            arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=10)
