...
axes[0, 1].bar(genres, monthly_revenue_downtown, color='skyblue', edgecolor='grey')
axes[0, 1].set_title('Monthly Revenue by Genre in Downtown Branch', fontsize=14, weight='bold')
axes[0, 1].set_ylabel('Revenue ($1000s)', fontsize=12)
axes[0, 1].set_xticklabels(genres, rotation=45, ha='right')
axes[0, 1].grid(axis='y', linestyle='--', alpha=0.7)

# Bar Chart for Popularity (Uptown Branch)
axes[1, 0].bar(genres, popularity_uptown, color='lightgreen', edgecolor='grey')
axes[1, 0].set_title('Book Genre Popularity in Uptown Branch', fontsize=14, weight='bold')
