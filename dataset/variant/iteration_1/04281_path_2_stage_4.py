...
ax1.plot(months, avg_temperatures_2022, marker='o', linestyle='-', color='#ff7f0e', linewidth=2)
ax1.plot(months, avg_temperatures_2021, marker='s', linestyle='--', color='#2ca02c', linewidth=2)

ax1.set_title('Avg Temp Monthly: AquaTown (Year2021 vs Yr22)', fontsize=16, fontweight='bold')
...
ax2.bar(months, temperature_range_2022, color='#1f77b4', alpha=0.7)
