...
# Prepare data
# Using the flexibility of the boxplot to show each year's distribution
# Note: We're showcasing hypothetical variations across years for example.
...
ax1.set_yticklabels(['2019', '2020', '2021', '2022', '2023'])
ax1.set_title("E-commerce Revenue Distribution (2019-2023)", fontsize=18, fontweight='bold')
