...
ax.plot(years, geothermal, label='Geothermal Energy', marker='o', color='orange', linewidth=1.5, linestyle='-')
...
for i, txt in enumerate(geothermal):
    ax.text(years[i], geothermal[i] + 1.5, str(txt), fontsize=8, ha='center', color='orange')
