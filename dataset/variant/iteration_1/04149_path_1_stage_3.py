...
ax1.barh(y_indices - height*1.5, agriculture_gdp, height=height, color=single_color)
ax1.barh(y_indices - height/2, manufacturing_gdp, height=height, color=single_color)
ax1.barh(y_indices + height/2, technology_gdp, height=height, color=single_color)
ax1.barh(y_indices + height*1.5, services_gdp, height=height, color=single_color)
