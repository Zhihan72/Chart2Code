...
ax.bar(x - bar_width, games_played, bar_width, color='#ff9999', edgecolor='black', linestyle='-.')
ax.bar(x, won_games, bar_width, color='#66b3ff', edgecolor='orange', hatch='/')
ax.bar(x + bar_width, lost_games, bar_width, color='#99ff99', edgecolor='purple', linestyle=':')
ax.bar(x + 2 * bar_width, draw_games, bar_width, color='#ffcc99', edgecolor='green', hatch='\\')

# Enable customized grid
ax.yaxis.grid(True, linestyle='-', linewidth=1.0, color='grey', alpha=0.5)

# Display legends for various bars
