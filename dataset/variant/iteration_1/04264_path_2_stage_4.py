...
ax.plot(years, north_region_temp, 'o-', color='green', linewidth=2.5)
ax.plot(years, south_region_temp, 's-', color='green', linewidth=2.5)
...
for year, n_temp, s_temp in zip(years, north_region_temp, south_region_temp):
    ...
    ax.annotate(f'{s_temp:.1f}', xy=(year, s_temp), textcoords="offset points", xytext=(0,5), ha='center', fontsize=8, color='green')
