...
# Consolidate consumption data without the delta group
data = []
...
# Histogram for fruit consumption on different planets
ax1 = axs[0]
...
# Subplot for average sweetness level of each fruit
ax2 = axs[1]
