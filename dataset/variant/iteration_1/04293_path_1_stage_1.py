...
age_groups = np.array(['10-20', '21-30', '31-40', '41-50', '51-60'])  # Removed '61-70'
physical_activity_level = np.array([45, 60, 55, 40, 30])  # Removed 20
happiness_index = np.array([70, 85, 80, 65, 50])  # Removed 40
