...
ax.plot(years, solar, marker='o', color='#FFD700', linewidth=2, linestyle='-')
ax.plot(years, wind, marker='^', color='#00BFFF', linewidth=2, linestyle='--')
ax.plot(years, hydro, marker='s', color='#32CD32', linewidth=2, linestyle='-.')
ax.plot(years, geothermal, marker='D', color='#8B4513', linewidth=2, linestyle=':')
ax.plot(years, nuclear, marker='x', color='#800080', linewidth=2, linestyle='-')
