...
# Bar chart
ax1.bar(np.arange(len(company_a_revenue)), company_a_revenue, width=0.4, color='orange', alpha=0.8, label='Firm Alpha Earnings')
ax1.bar(np.arange(len(company_a_revenue)) + 0.4, company_b_revenue, width=0.4, color='purple', alpha=0.8, label='Biz B Revenue')
...
# Line chart
ax2.plot(years, company_a_stock, label='Firm Alpha Stock', color='orange', marker='v', linestyle='-.', linewidth=3)
ax2.plot(years, company_b_stock, label='Business B Share', color='purple', marker='^', linestyle=':', linewidth=1)
