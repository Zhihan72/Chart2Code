...
new_colors = ['#FFA07A', '#20B2AA', '#9370DB']
...
species = ['Elves', 'Dwarves', 'Humans']  # Adjusted the list of species displayed.
population_totals = [sum(elves_population), sum(dwarves_population), sum(humans_population)]  # Removed Orcs count.
