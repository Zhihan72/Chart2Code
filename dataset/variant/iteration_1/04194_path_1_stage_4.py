...
# Apply consistent color to all country plots
for (country, marker) in zip(country_data.keys(), markers):
    ax1.plot(years, country_data[country], color=single_color, linewidth=2.5, marker=marker, markersize=5)
