...
ax.plot(years, avg_temps, marker='o', linestyle='-', color='blue', label='Mean Temp')
ax.plot(years, high_temps, marker='s', linestyle='--', color='red', label='Peak Temp')
...
ax2 = ax.twinx()
ax2.plot(years, anomalies, color='purple', marker='x', linestyle='-.', label='Anomaly')
ax2.set_ylabel('Anomaly (°C)', fontsize=14, color='purple')
