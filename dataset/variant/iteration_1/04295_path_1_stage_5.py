...
scenarios = ['Entertainment', 'Health', 'Research', 'Education', 'Business']
categories = ['Machine Learning', 'Statistics', 'Python', 'Excel', 'Graphics']
...
ax1.set_ylabel('Tool Usage (%)', fontsize=12)
...
ax2.set_xlabel('Accumulated Growth (%)', fontsize=12)
ax2.set_ylabel('Applications', fontsize=12)
