...
# Plot horizontal temperature density with shuffled colors
sns.kdeplot(y=months, x=temperatures_alpha_norm[:12], ax=ax[0], fill=True, color='lime', alpha=0.5, label='Alpha', linestyle='--', marker='o')
sns.kdeplot(y=months, x=temperatures_alpha_norm[12:], ax=ax[0], fill=True, color='cyan', alpha=0.5, label='Beta', linestyle='-.', marker='s')
sns.kdeplot(y=months, x=temperatures_gamma_norm[:12], ax=ax[0], fill=True, color='magenta', alpha=0.5, label='Gamma', linestyle=':', marker='^')
...
# Plot horizontal rainfall density with shuffled colors
sns.kdeplot(y=months, x=rainfall_alpha_norm[:12], ax=ax[1], fill=True, color='darkred', alpha=0.5, label='Alpha', linestyle='-', marker='x')
sns.kdeplot(y=months, x=rainfall_alpha_norm[12:], ax=ax[1], fill=True, color='gold', alpha=0.5, label='Beta', linestyle=':', marker='+')
sns.kdeplot(y=months, x=rainfall_gamma_norm[:12], ax=ax[1], fill=True, color='darkorange', alpha=0.5, label='Gamma', linestyle='-', marker='d')
