...
ax1.plot(months, new_york_temps, label="NY", linestyle='--', color='orange', marker='^')  # Changed color
ax1.plot(months, tokyo_temps, label="Tokyo", linestyle='-.', color='blue', marker='*')    # Changed color
ax1.plot(months, paris_temps, label="Paris", linestyle='-', color='green', marker='p')    # Changed color
ax1.plot(months, sydney_temps, label="Sydney", linestyle=':', color='red', marker='h')    # Changed color

# Updated annotation colors to match the changed plot colors
