...
# Randomly altered data values within each demographic group
data = {
    'Women': [31, 30, 36, 37, 39],
    'Men': [49, 47, 44, 42, 36],
    'Non-Binary': [3, 5, 7, 8, 9],
    'Underrepresented Minorities': [14, 15, 19, 21, 20],
    'Others': [2, 4, 3.5, 5, 4.8]
}
