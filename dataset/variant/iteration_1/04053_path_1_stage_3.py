...
ax.plot(years, orbital_radius_planet_a, linestyle='--', marker='D', color='green', label='Planet A')
ax.plot(years, orbital_radius_planet_b, linestyle=':', marker='^', color='red', label='Planet B')
ax.plot(years, orbital_radius_planet_c, linestyle='-.', marker='v', color='yellow', label='Planet C')
ax.plot(years, orbital_radius_planet_d, linestyle='-', marker='*', color='brown', label='Planet D')
ax.plot(years, orbital_radius_planet_e, linestyle='-', marker='h', color='pink', label='Planet E')
