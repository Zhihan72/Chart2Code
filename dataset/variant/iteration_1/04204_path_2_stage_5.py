...
mangoes = [36.4, 37.1, 39.2, 34.8, 35.6, 36.9, 34.3, 35.7, 37.3, 36.8]
papayas = [60.9, 62.4, 61.0, 63.5, 59.1, 60.5, 62.8, 61.9, 60.7, 62.1]

data = [oranges, strawberries, kiwis, lemons, pineapples, mangoes, papayas]
