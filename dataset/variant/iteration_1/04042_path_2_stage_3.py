...
ax.plot(years, avg_temps, marker='o', linestyle='-', color=consistent_color, label='Mean Temp')
ax.plot(years, high_temps, marker='s', linestyle='--', color=consistent_color, label='Peak Temp')
ax.plot(years, low_temps, marker='v', linestyle=':', color=consistent_color, label='Low Temp')
...
ax2 = ax.twinx()
ax2.plot(years, anomalies, color=consistent_color, marker='x', linestyle='-.', label='Anomaly')
