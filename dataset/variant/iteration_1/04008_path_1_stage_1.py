...
ax.plot(years, expenses, marker='s', linestyle='--', linewidth=2, color='red', label='Exp')
...
ax.set_title("Startup Growth: Rev, Exp, Prof (2018-22)", fontsize=14, fontweight='bold', pad=20)
...
ax.annotate('Expense Control', xy=(2021, expenses[3]), xytext=(2020, expenses[3] + 30),
            arrowprops=dict(facecolor='black', arrowstyle='->'), fontsize=10)
