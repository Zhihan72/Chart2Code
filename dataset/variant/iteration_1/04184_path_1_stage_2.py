...
# New set of colors for the charts
bar_colors = ['#FF5733', '#33FF57', '#3375FF']
pie_colors = ['#FF5733', '#33FF57', '#3375FF']

fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(20, 8))

# First subplot: Bar chart for monthly sales
width = 0.25
ax1.bar(months - width, coffee_sales, width=width, color=bar_colors[0], label='Coffee')
ax1.bar(months, tea_sales, width=width, color=bar_colors[1], label='Tea')
ax1.bar(months + width, juice_sales, width=width, color=bar_colors[2], label='Juice')
...
# Second subplot: Donut chart for cumulative sales
ax2.pie(cumulative_sales, labels=beverages, colors=pie_colors, autopct='%1.1f%%', startangle=140, 
        explode=(0.1, 0, 0), wedgeprops=dict(width=0.3))
