...
# Changed the style of box plots and outliers
...
colors = ['#FFB6C1', '#FF9999', '#99FF99', '#FFD700', '#66B2FF']
for patch, color in zip(bp['boxes'], colors):
    patch.set_facecolor(color)
    patch.set_alpha(0.5)

# Changed marker styles for scatter plot
...
# Different style for mean lines
