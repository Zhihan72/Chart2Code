...
ax1.bar(np.arange(len(company_a_revenue)) + 0.4, company_b_revenue, width=0.4, color='orange', alpha=0.8, label='Biz B Revenue')
...
ax2.plot(years, company_b_stock, label='Business B Share', color='orange', marker='^', linestyle=':', linewidth=1)
