...
ax1.plot(decades, atlantic_data, label='Atlantic Ocean', marker='x', linestyle=':', linewidth=2.5, color='blue')
ax1.plot(decades, pacific_data, label='Pacific Zone', marker='d', linestyle='-', linewidth=1.5, color='red')
ax1.plot(decades, indian_data, label='India\'s Waters', marker='p', linestyle='--', linewidth=2, color='purple')
ax1.plot(decades, southern_data, label='Southern Hemisphere', marker='h', linestyle='-.', linewidth=3, color='brown')
ax1.plot(decades, arctic_data, label='Frozen North', marker='*', linestyle='-', linewidth=1, color='olive')
