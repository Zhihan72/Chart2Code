...
ax.plot(years, hydro_energy, label='Hydro', color='green', linewidth=2, marker='+')
...
ax.plot(projection_years, hydro_projection, label='Hydro Projection', color='green', linestyle='--', linewidth=2)
