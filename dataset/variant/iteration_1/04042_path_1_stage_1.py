...
# Plot the data
ax.plot(years, avg_temps, marker='o', linestyle='-', color='blue')
ax.plot(years, high_temps, marker='s', linestyle='--', color='red')
ax.plot(years, low_temps, marker='v', linestyle=':', color='green')
...
ax2 = ax.twinx()
ax2.plot(years, anomalies, color='purple', marker='x', linestyle='-.')
