...
city_zones = ["Tech Hub", "Commercial", "University", "Downtown", "Suburbs", "Residential", "Parks", "Industrial", "Art District"]
...
activity_data = np.array([
    ...
    [90, 95, 100, 105, 110, 130, 120]  # New data series for "Art District"
])
