...
def plot_creature(ax, years, data_north, data_east, data_west):
    ax.plot(years, data_north, marker='o')
    ax.plot(years, data_east, marker='s')
    ax.plot(years, data_west, marker='^')
...
plot_creature(axes[0], years, dragons_north, dragons_east, dragons_west)
plot_creature(axes[1], years, unicorns_north, unicorns_east, unicorns_west)
plot_creature(axes[2], years, phoenixes_north, phoenixes_east, phoenixes_west)
plot_creature(axes[3], years, griffins_north, griffins_east, griffins_west)
