...
# Data representing average monthly measurements for different river health parameters
...
# Plot the line chart for dissolved oxygen and pH level with new colors
ax1.plot(years, dissolved_oxygen, label='Dissolved Oxygen (mg/L)', color='cyan', marker='o', linewidth=2)
ax1.plot(years, ph_level, label='pH Level', color='orange', marker='^', linewidth=2)

# Plot the nitrate concentration on a secondary y-axis with a new color
ax2.plot(years, nitrate_concentration, label='Nitrate Concentration (mg/L)', color='purple', marker='s', linewidth=2)
