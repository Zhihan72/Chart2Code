...
plt.plot(years, country_a_adoption, label='Region X', color='red', marker='o', linewidth=2, markersize=6)
plt.plot(years, country_b_adoption, label='Nation Y', color='blue', marker='s', linewidth=2, markersize=6)
plt.plot(years, country_c_adoption, label='State Z', color='green', marker='^', linewidth=2, markersize=6)
