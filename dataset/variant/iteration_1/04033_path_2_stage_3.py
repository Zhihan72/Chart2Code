...
bars = ax1.bar(activities, frequencies, color='skyblue', alpha=0.8, label='Frequency of Participation')
...
ax2 = ax1.twinx()
ax2.plot(activities, well_being_impact, color='red', marker='s', linestyle='--', linewidth=2, markersize=8, label='Well-being Impact')
