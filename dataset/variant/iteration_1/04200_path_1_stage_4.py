...
scatter_a = ax.scatter(matches, player_a_runs, color='magenta', label='Athlete X', s=80, marker='o', edgecolor='black')
scatter_b = ax.scatter(matches, player_b_runs, color='cyan', label='Athlete Y', s=80, marker='^', edgecolor='purple')
scatter_c = ax.scatter(matches, player_c_runs, color='lime', label='Athlete Z', s=80, marker='s', edgecolor='gray')
...
for i, txt in enumerate(match_types):
    ax.annotate(txt, (matches[i], player_a_runs[i]), textcoords="offset points", xytext=(0, 10), ha='center', fontsize=9, color='magenta')
    ax.annotate(txt, (matches[i], player_b_runs[i]), textcoords="offset points", xytext=(0, 10), ha='center', fontsize=9, color='cyan')
    ax.annotate(txt, (matches[i], player_c_runs[i]), textcoords="offset points", xytext=(0, 10), ha='center', fontsize=9, color='lime')
