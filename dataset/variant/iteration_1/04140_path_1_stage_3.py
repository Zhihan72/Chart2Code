...
ax.plot(years, solar_energy, marker='o', linestyle='-', color='#FFA07A', linewidth=2)
ax.plot(years, wind_energy, marker='s', linestyle='-', color='#8FBC8F', linewidth=2)
ax.plot(years, hydro_energy, marker='^', linestyle='-', color='#6495ED', linewidth=2)
ax.plot(years, geothermal_energy, marker='D', linestyle='-', color='#FFD700', linewidth=2)
