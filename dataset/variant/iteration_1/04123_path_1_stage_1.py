...
axes[0].plot(times, pop_bands, '-o', label='Pop Bands', color=common_color)
axes[0].plot(times, rock_bands, '-s', label='Rock Bands', color=common_color)
axes[0].plot(times, indie_bands, '-^', label='Indie Bands', color=common_color)
...
axes[1].plot(times, audience_attendance, '-D', label='Audience Attending (x100)', color=common_color)
