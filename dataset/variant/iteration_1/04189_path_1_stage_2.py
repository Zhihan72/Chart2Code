...
# Plotting the bars using the same color for both data groups
bar_color = 'skyblue'
ax.bar(bar1, ai_assistants, width, label='AI Assistants', color=bar_color, edgecolor='black')
ax.bar(bar2, smart_homes, width, label='Smart Homes', color=bar_color, edgecolor='black')
