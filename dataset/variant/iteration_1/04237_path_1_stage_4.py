...
bars_2015 = ax[0].bar(locs_2015, sorted_choco_2015, color='saddlebrown', edgecolor='sienna', label='2015')
...
bars_2020 = ax[1].bar(locs_2020, sorted_choco_2020, color='chocolate', edgecolor='brown', label='2020')
...
ax[1].set_xticklabels(sorted_countries_2020, rotation=30, ha='right', fontsize=12)
