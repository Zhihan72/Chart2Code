...
ax1.plot(years, drone_deliveries, color='darkorange', marker='s', linestyle='-', linewidth=2, markersize=8)

# Plot Hyperloop Pods
ax1.plot(years, hyperloop_pods, color='purple', marker='^', linestyle='-', linewidth=2, markersize=8)
