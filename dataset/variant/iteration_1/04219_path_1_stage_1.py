...
# Second plot: Donut pie chart outlining the category distribution of ideas
...
# Create a new figure for the donut pie chart
fig2, ax2 = plt.subplots(figsize=(8, 8))

# Create donut pie chart by setting a width for the wedges
