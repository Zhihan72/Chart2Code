...
ax1.bar(x_indices - width*1.5, agriculture_gdp, width=width, color='tab:green')
ax1.bar(x_indices - width/2, manufacturing_gdp, width=width, color='tab:blue')
ax1.bar(x_indices + width/2, technology_gdp, width=width, color='tab:purple')
ax1.bar(x_indices + width*1.5, services_gdp, width=width, color='tab:orange')
