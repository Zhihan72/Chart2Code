...
departments = [
    "Outreach", "Innovations", "Transactions", 
...
customer_service_scores = [4, 5, 3, 3, 4, 5, 3, 4, 5, 5, 3, 4]

# Rearranging the dictionary to match the new order
satisfaction_data = {
    ...
    "Customer Service": customer_service_scores
}
