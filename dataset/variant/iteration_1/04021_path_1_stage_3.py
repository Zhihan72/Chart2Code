...
# Altered legend properties
ax.legend(loc='upper right', title='Age Groups', fontsize=12, frameon=True, edgecolor='grey')

# Altered grid properties
ax.grid(True, linestyle='-.', alpha=0.3, color='#777777')

# Manually changed y-axis major locator style
