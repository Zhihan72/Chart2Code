...
# Updated energy sources and their respective usage percentages
energy_sources = ['Hydropower', 'Biomass', 'Geothermal', 'Solar', 'Wind']
usage_percentages = [20, 10, 15, 30, 25]

# Years and growth rates remain unchanged
...
# Plot lines remain the same but changing order of the axes labels
