...
ax.plot(years, north_region_temp, 'o-', label='Nordic Zone', color='blue', linewidth=2.5)
ax.plot(years, south_region_temp, 's-', label='Equatorial Zone', color='red', linewidth=2.5)
ax.plot(years, central_region_temp, '^-', label='Middle Belt', color='green', linewidth=2.5)
...
ax.legend(title="Territories", fontsize=12, title_fontsize=14, loc='upper left')
...
annotations = [
    ...
    (2020, central_region_temp[years == 2020][0], 'Arid Phase')
]
