...
precipitation_changes = np.array([0.1, 0.2, -0.1, -0.05, 0, 0.05, 0.1, 0.15, 0.2, 0.25, 
...
# Random changes applied to the plot styles
ax.plot(years, temperature_anomalies, marker='v', linestyle='-.', color='purple', linewidth=3, markersize=10, label='Temperature Anomalies')
ax.plot(years, precipitation_changes, marker='s', linestyle=':', color='red', linewidth=2, markersize=8, label='Precipitation Changes')
