...
temp_data = np.array([
    [30, 26, 21, 15, 11, 5, 3, 6, 10, 18, 24, 29],  # NY data shuffled
    [24, 23, 20, 22, 15, 17, 16, 18, 24, 20, 17, 15],  # LA data shuffled
    [17, 11, 7, 5, 23, 2, 26, 1, 14, 27, 21, -1],  # Chi data shuffled
    [32, 13, 12, 14, 18, 19, 27, 24, 32, 23, 29, 30]  # Hou data shuffled
])
