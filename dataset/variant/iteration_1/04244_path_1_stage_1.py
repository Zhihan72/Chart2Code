...
# Define the randomly shuffled data for different cuisines
cuisine_italian = [6, 2, 9, 7, 3, 8]  # Shuffled
cuisine_japanese = [4, 9, 5, 7, 3, 8]  # Shuffled
cuisine_indian = [5, 8, 9, 4, 7, 7]    # Shuffled
cuisine_french = [5, 6, 3, 7, 9, 3]   # Shuffled
