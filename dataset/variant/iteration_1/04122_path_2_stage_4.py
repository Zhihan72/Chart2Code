...
scatter_original = ax.scatter(libraries_original, literacy_rates_original, color='darkorange', edgecolor='navy', s=130, alpha=0.7, marker='^')
scatter_additional = ax.scatter(libraries_additional, literacy_rates_additional, color='forestgreen', edgecolor='crimson', s=130, alpha=0.7, marker='s')
...
ax.plot(x_smooth_original, y_smooth_original, linestyle='-.', color='indigo', linewidth=2.5)
...
ax.plot(x_smooth_additional, y_smooth_additional, linestyle=':', color='darkslategray', linewidth=2.5)

ax.grid(visible=True, linestyle=':', alpha=0.8)

# Add legend with altered location and labels
ax.legend(['Original Fit', 'Additional Fit'], loc='lower right')
