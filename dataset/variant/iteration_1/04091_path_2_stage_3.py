...
ax1.set_xlabel('Timeline', fontsize=14)  # Altered
ax1.set_ylabel('Power Production (GWh)', fontsize=14)  # Altered
ax1.set_title('Shift in Energy Production over a Decade', fontsize=18, fontweight='bold')  # Altered
...
ax2.set_xlabel('Timeline', fontsize=14)  # Altered
ax2.set_ylabel('Aggregate Energy Production (GWh)', fontsize=14)  # Altered
ax2.set_title('Annual Energy Yield Totals', fontsize=18, fontweight='bold')  # Altered
