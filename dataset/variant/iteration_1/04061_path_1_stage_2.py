...
smartphone_usage = [
    [2.7, 2.2, 4, 3.2, 2, 3.5, 2.5, 3, 2.8],  # random shuffle within group
    [3.5, 4.1, 5, 4.7, 3.9, 3, 4.5, 4.2, 3.8],  # random shuffle within group
    [2.4, 2.3, 3, 2.8, 2, 1.5, 2.6, 2.5, 2.2],  # random shuffle within group
    [1.5, 1.9, 2, 1.4, 1.6, 1.8, 1.2, 1.7, 1],  # random shuffle within group
    [1.4, 1.3, 1, 1.1, 1.2, 0.8, 1.5, 1.1, 0.5],  # random shuffle within group
    [0.9, 0.6, 0.7, 1, 0.8, 0.5, 0.7, 0.6, 0.5]   # random shuffle within group
]
