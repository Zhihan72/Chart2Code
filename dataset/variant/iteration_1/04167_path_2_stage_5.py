...
axs[0].set_title('Rover Usage by Teams', fontsize=14, fontweight='bold', color='#1a535c')
axs[0].set_xlabel('Op Hours', fontsize=12, fontweight='bold')
axs[0].set_yticks(np.arange(1, len(teams)+1))
axs[0].set_yticklabels(teams, fontsize=12, fontweight='bold')
axs[0].grid(axis='x', linestyle='--', alpha=0.7)

axs[1].barh(teams, total_hours, color=single_color, edgecolor='navy')
axs[1].set_title('Monthly Total Hours by Team', fontsize=14, fontweight='bold', color='#1a535c')
