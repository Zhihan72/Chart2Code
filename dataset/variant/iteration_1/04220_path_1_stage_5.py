...
consistent_color = 'olive'  # Changed: Use the same color for all data groups
...
for class_data, label in zip(data, classes):
    plot_fill_area_radar_chart(ax, class_data, consistent_color, label)  # Changed: Apply consistent color
