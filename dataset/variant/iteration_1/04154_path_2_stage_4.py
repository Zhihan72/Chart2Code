...
ax[0].barh(y_pos_grapes, grape_preferences, color=grape_colors, edgecolor='black')
...
ax[1].barh(y_pos_fruits, preferences_percentages, color=colors, edgecolor='black')
