...
# Plot lines for each age group with the same color
same_color = '#FF5733'
ax.plot(days, children_steps, marker='o', linestyle='-', linewidth=2, label='Children (5-12 years)', color=same_color)
ax.plot(days, adults_steps, marker='s', linestyle='--', linewidth=2, label='Adults (20-40 years)', color=same_color)
ax.plot(days, elderly_steps, marker='^', linestyle='-.', linewidth=2, label='Elderly (65+ years)', color=same_color)
...
# Annotate peak days consistently using red for the arrows
