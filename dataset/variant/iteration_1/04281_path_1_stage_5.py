...
ax1.plot(months, avg_temperatures_2022, marker='D', linestyle='-', color='#9467bd', linewidth=1, label='2022')
ax1.plot(months, avg_temperatures_2021, marker='*', linestyle=':', color='#8c564b', linewidth=2, label='2021')
...
ax2.bar(months, temperature_range_2022, color='#d62728', label='Temp Variation', edgecolor='black', alpha=0.85)
