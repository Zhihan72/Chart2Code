...
colors = ['#FA8072', '#1E90FF', '#3CB371', '#FFD700', '#DA70D6']

# Changing styles for each bar set
...
# Adding grid lines with random style
...
fig.tight_layout()
ax.set_frame_on(False)  # Remove the chart border
plt.show()