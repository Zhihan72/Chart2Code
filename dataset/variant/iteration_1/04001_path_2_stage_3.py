...
ax.plot(years, wheat_yield, color='saddlebrown', marker='o', linewidth=2, linestyle='-')
ax.plot(years, corn_yield, color='gold', marker='s', linewidth=2, linestyle='-.')
ax.plot(years, soybean_yield, color='green', marker='^', linewidth=2, linestyle='--')
