...
bars1 = ax.bar(x - width, sales_q1_sorted, width, color='navy', edgecolor='black', label='Q1')
bars2 = ax.bar(x, sales_q2_sorted, width, color='darkorange', edgecolor='black', label='Q2')
bars3 = ax.bar(x + width, sales_q3_sorted, width, color='forestgreen', edgecolor='black', label='Q3')
