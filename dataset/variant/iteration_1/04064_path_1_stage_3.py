...
# Drawing bars using sorted data
bars1 = ax.bar(x - width, north_trees_sorted, width, color='skyblue', edgecolor='blue', linestyle=':', label='North Region')
bars2 = ax.bar(x, south_trees_sorted, width, color='gold', edgecolor='orange', linestyle='--', label='South Region')
bars3 = ax.bar(x + width, central_trees_sorted, width, color='salmon', edgecolor='red', linestyle='-.', label='Central Region')
...
# Xticks - using sorted month data from any region since positions are consistent
ax.set_xticks(x)
