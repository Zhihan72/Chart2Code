...
# Removed "Crewed" from the missions and its corresponding discoveries value
missions = ["Voyager", "Galileo", "Cassini", "New Horizons", "Pioneer", "Rosetta", "Juno"]
discoveries = [15, 22, 30, 10, 18, 8, 13]
...
# Removed the color for "Crewed"
colors = ['lightsalmon', 'lightcoral', 'lightgreen', 'skyblue', 'orchid', 'orange', 'lightsteelblue']
