...
ax[0].barh(y_pos, grape_preferences, color=grape_colors)
...
ax[0].set_title('Varieties of Grapes Consumption Comparison', fontsize=14, fontweight='bold')
...
ax[1].bar(x_pos, sorted_preferences, color=sorted_colors)
...
ax[1].set_title('Sorted Popular Fruit Choices at Local Bazaar', fontsize=14, fontweight='bold')
