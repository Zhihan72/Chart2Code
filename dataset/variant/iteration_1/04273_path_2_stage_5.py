...
axs[0].set_title('Fluctuations in CO2 Air Content (1990-2020)', fontsize=16, fontweight='bold', color='navy')
axs[0].set_xlabel('Timeline', fontsize=12, fontweight='bold')
axs[0].set_ylabel('Carbon Dioxide (ppm)', fontsize=12, fontweight='bold')

# Temperature Trend
axs[1].plot(years, avg_temperature, color='orange', marker='o', linestyle='-', linewidth=2)
axs[1].set_title('Climate Temperature Changes (90s-20s)', fontsize=16, fontweight='bold', color='darkorange')
axs[1].set_xlabel('Decades', fontsize=12, fontweight='bold')
axs[1].set_ylabel('Heat Levels (°C)', fontsize=12, fontweight='bold')

annotations = ['Growth Boom', 'Eco-Friendly Start', 'Heat Regulation', 'Tech Era']
