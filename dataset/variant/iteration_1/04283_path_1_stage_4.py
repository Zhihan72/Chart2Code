...
axs[0].stackplot(years, solar, hydro, battery_storage, colors=['#8E44AD', '#3498DB', '#E74C3C'], alpha=0.85)
...
axs[1].plot(years, solar_share, color='#8E44AD', marker='s', linestyle='--')
axs[1].plot(years, hydro_share, color='#3498DB', marker='p', linestyle='-.')
axs[1].plot(years, battery_storage_share, color='#E74C3C', marker='*', linestyle=':')
