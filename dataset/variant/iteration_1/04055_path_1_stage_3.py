...
# Change colors and marker types
...
# Alter grid settings, change to dash-dot with different alpha
...
# Add trend lines with different linestyles and colors
