...
nx.draw_networkx_edges(
    G, pos, edgelist=edges, arrows=True, arrowstyle='-|>', arrowsize=20, width=2.0, edge_color='gray', alpha=0.6
)
...
edge_patch = plt.Line2D([0], [0], linestyle='-', color='gray', lw=2, alpha=0.6, label='Collaboration')
