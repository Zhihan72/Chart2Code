...
# Changed color assignments for data groups
ax1.plot(months, avg_temperatures_2022, marker='o', linestyle='-', color='#ff7f0e', linewidth=2, label='Yr2022')
ax1.plot(months, avg_temperatures_2021, marker='s', linestyle='--', color='#2ca02c', linewidth=2, label='Yr2021')

ax1.set_title('Avg Temp Monthly: AquaTown (Year2021 vs Yr 22)', fontsize=16, fontweight='bold')
...
ax2.bar(months, temperature_range_2022, color='#1f77b4', label='Temp Diff', alpha=0.7)

ax2.set_title('Temp Diff in Aqua (Yr22)', fontsize=16, fontweight='bold')
ax2.set_xlabel('Mnth', fontsize=14)
ax2.set_ylabel('Temp Diff (°C)', fontsize=14)
