...
# Adding the new data series: number of companies
num_companies = [
...
# Plotting the number of tourists
color1 = 'tab:blue'
ax1.set_xlabel('Year')
...
# Plotting the average ticket price
ax2 = ax1.twinx()
color2 = 'tab:red'
ax2.set_ylabel('Price (M USD)', color=color2)
ax2.plot(years, avg_ticket_price, color=color2, linewidth=2.5, linestyle='dashed', marker='s')
...
# Plotting the number of space tourism companies
ax3 = ax1.twinx()
ax3.spines['right'].set_position(('outward', 60))  # Move the spine outwards to make room
color3 = 'tab:green'
ax3.set_ylabel('Number of Companies', color=color3)
ax3.plot(years, num_companies, color=color3, linewidth=2.5, linestyle='dotted', marker='^')
