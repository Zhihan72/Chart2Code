...
ax.stackplot(years, scores, labels=['Sci', 'Hist', 'Eng', 'Math'],
             colors=['#66B2FF'], alpha=0.7)

ax.set_title("Evolution in Education Scores 2010-2020", fontsize=16, fontweight='bold', pad=20)
...
ax.legend(loc='lower right', title='Courses', fontsize=10)
