...
plt.plot(months, city_a_temperatures, color='green', marker='o', linestyle='-', linewidth=2, markersize=6)
plt.plot(months, city_b_temperatures, color='purple', marker='s', linestyle='--', linewidth=2, markersize=6)

heatwave_months = np.array(['Jul', 'Aug'])
heatwave_temps = city_b_temperatures[6:8]
plt.plot(heatwave_months, heatwave_temps, color='yellow', marker='*', linestyle='-', linewidth=2, markersize=10)
