...
ax.plot(years, temp_atlantis, label='Atlantis', marker='*', linestyle='-', color='green', linewidth=3)
ax.plot(years, temp_el_dorado, label='El Dorado', marker='D', linestyle='-', color='purple', linewidth=2)
