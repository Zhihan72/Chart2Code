...
departments = ['CS', 'MechEng', 'BioChem', 'Psych', 'Business', 'FineArts']
...
ax1.set_title('Study Hours vs GPA', fontsize=16, fontweight='bold')
ax1.set_xlabel('Study Hours', fontsize=12, labelpad=10)
ax2.set_xlabel('GPA', fontsize=12, labelpad=10)
