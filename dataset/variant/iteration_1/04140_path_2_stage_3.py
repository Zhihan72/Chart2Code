...
ax.plot(years, solar_energy, marker='*', linestyle=':', color='#4682B4', linewidth=2, label='Solar Energy')
ax.plot(years, wind_energy, marker='D', linestyle='--', color='#CD5C5C', linewidth=2, label='Wind Energy')
ax.plot(years, hydro_energy, marker='x', linestyle='-.', color='#FFD700', linewidth=2, label='Hydro Energy')
ax.plot(years, geothermal_energy, marker='+', linestyle='-', color='#2E8B57', linewidth=2, label='Geothermal Energy')
...
plt.legend(title='Energy Sources', title_fontsize='13', fontsize='12', loc='lower right')
