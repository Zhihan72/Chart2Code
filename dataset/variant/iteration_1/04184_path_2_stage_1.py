...
# Data: Monthly sales in thousands of units
...
width = 0.25
ax1.bar(months - width, coffee_sales, width=width, color='#8B4513', label='Cof')
ax1.bar(months, tea_sales, width=width, color='#006400', label='Tea')
ax1.bar(months + width, juice_sales, width=width, color='#FFD700', label='Jui')
...
ax1.legend(loc='upper left', fontsize=12, title='Types')
