...
missions = {
    ...
    # Added made-up missions
    "Discovery": ["Cassini", "Solar Sys"],
    "Challenger": ["Rosetta", "Jupiter", "Voyager 2"],
    "Pioneer": ["Discovery", "Voyager 1"]
}
...
handles = [
    ...
    # Legend entries for made-up missions
    plt.Line2D([0], [0], marker='o', color='w', label='Discovery', markerfacecolor='#3498db', markersize=12),
    plt.Line2D([0], [0], marker='s', color='w', label='Challenger', markerfacecolor='#e74c3c', markersize=12),
    plt.Line2D([0], [0], marker='d', color='w', label='Pioneer', markerfacecolor='#9b59b6', markersize=12)
]
