...
ax.plot(day_indices, solar_temps, marker='x', markersize=7, color='orange', label='Sol', linestyle='-.', linewidth=2)
ax.plot(day_indices, rain_temps, marker='s', markersize=7, color='blue', label='Rain', linestyle='--', linewidth=2)
