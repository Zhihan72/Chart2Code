...
# Changed colors from 'skyblue' to new colors for downtown
axes[0, 0].bar(genres, popularity_downtown, color='coral')
axes[0, 0].set_ylabel('Pop', fontsize=12)
axes[0, 0].set_xticklabels(genres, rotation=45, ha='right')

axes[0, 1].bar(genres, monthly_revenue_downtown, color='gold')
axes[0, 1].set_ylabel('Rev ($K)', fontsize=12)
axes[0, 1].set_xticklabels(genres, rotation=45, ha='right')

# Changed colors from 'lightgreen' to new colors for uptown
axes[1, 0].bar(genres, popularity_uptown, color='cyan')
axes[1, 0].set_ylabel('Pop', fontsize=12)
axes[1, 0].set_xticklabels(genres, rotation=45, ha='right')

axes[1, 1].bar(genres, monthly_revenue_uptown, color='orchid')
