...
ax.set_ylabel('Deviation from Mean Participants', fontsize=12, labelpad=10, fontweight='bold', color='purple')
ax.set_title('Diverging Participation in Public Coding Workshops (2015-2022)', fontsize=16, fontweight='bold', color='darkred', pad=20)
...
ax.legend(title='Languages', loc='upper left', bbox_to_anchor=(1, 1), frameon=False)
