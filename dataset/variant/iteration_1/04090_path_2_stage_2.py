...
ax[1].plot(x_range_post, density_post_industrial(x_range_post), label="CO2 Surge Era", color='red')
ax[1].fill_between(x_range_post, density_post_industrial(x_range_post), color='red', alpha=0.2)

# Plot 3: Hypothetical Future Era
ax[2].plot(x_range_future, density_future(x_range_future), label="Future Speculation Era", color='green')
