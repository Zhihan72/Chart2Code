...
# Updated Categories and their budget percentages
categories = [
    ...
    'Field Missions', 
    'Miscellaneous',
    'Public Relations'  # New category added
]
budgets = [22, 12, 18, 11, 20, 4, 13]  # Adjusted percentages for each category

# Define colors for each slice (added a new color for the new category)
colors = ['#6b8e23', '#20b2aa', '#ff6347', '#ffa07a', '#ba55d3', '#ffd700', '#4682b4']
