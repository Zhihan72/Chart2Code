...
fruits = ['Cherries', 'Bananas', 'Apples', 'Elderberries']  # 'Dates' removed

sales_data = {
    'Cherries': [10, 12, 8, 14, 9],
    'Bananas': [15, 20, 13, 18, 22],
    'Apples': [25, 30, 22, 28, 35],
    # 'Dates': [5, 3, 4, 7, 6],  # Removed 'Dates'
    'Elderberries': [8, 10, 9, 6, 11]
}

colors = ['#1f77b4', '#ff7f0e', '#2ca02c', '#9467bd']  # Removed color for 'Dates'
...
for idx, (fruit, sales) in enumerate(sales_data.items()):
    ax1.bar(year_positions, sales, bar_width, bottom=bottoms, color=colors[idx])
