...
nutrient_labels = ['Fats', 'Carbohydrates', 'Vitamins', 'Fibers', 'Proteins']
...
# Remove legend creation as it was incorrect, the legend requires a plot handle to work correctly
