...
ax.plot(years, settlers_of_catan, label='CATAN', color='red', linewidth=2)
ax.plot(years, ticket_to_ride, label='RIDE', color='purple', linewidth=2)
ax.plot(years, pandemic, label='DEMIC', color='brown', linewidth=2)
ax.plot(years, carcassonne, label='CARCAS', color='green', linewidth=2)
ax.plot(years, terraforming_mars, label='MAR', color='blue', linewidth=2)
ax.plot(years, gloomhaven, label='HAVEN', color='pink', linewidth=2)
ax.plot(years, azul, label='AZUL', color='orange', linewidth=2)
...
ax_bar = ax.twinx()
ax_bar.barh(x - width/2, popularity_2010, width, label='2010 Status', color='navy', alpha=0.7)
ax_bar.barh(x + width/2, popularity_2020, width, label='2020 Status', color='skyblue', alpha=0.7)
