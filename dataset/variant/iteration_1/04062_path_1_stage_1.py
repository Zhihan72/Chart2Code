...
# Changed colors for each group
bars1 = ax.bar(r1, apples_production, color='orange', width=bar_width, edgecolor='grey', label='Apples')
bars2 = ax.bar(r2, bananas_production, color='red', width=bar_width, edgecolor='grey', label='Bananas')
bars3 = ax.bar(r3, oranges_production, color='yellow', width=bar_width, edgecolor='grey', label='Oranges')
