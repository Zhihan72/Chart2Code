...
for i, year in enumerate(years):
    ax.plot(months, monthly_temps[i], marker='o', linestyle='-', linewidth=2, markersize=6)

ax.plot(months, average_temps, marker='D', linestyle='--', color='black', linewidth=2, markersize=8)
...
# Grid and annotations are removed
# Legend is removed; hence, no label argument is provided for the plot
ax.set_xlim(1, 12)
ax.set_ylim(-5, 30)
