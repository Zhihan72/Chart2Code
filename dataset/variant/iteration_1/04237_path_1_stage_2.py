...
# Data Initialization
countries = ['Switzerland', 'Germany', 'UK', 'USA', 'France']
choco_consumption_2015 = [9.0, 8.4, 8.2, 5.5, 6.5]
choco_consumption_2020 = [10.1, 9.2, 8.5, 6.2, 7.0]
...
bars_2015 = ax[0].bar(bar_locs_2015, choco_consumption_2015, bar_width, color='saddlebrown', edgecolor='sienna', label='2015')
...
bars_2020 = ax[1].bar(bar_locs_2020, choco_consumption_2020, bar_width, color='chocolate', edgecolor='brown', label='2020')
