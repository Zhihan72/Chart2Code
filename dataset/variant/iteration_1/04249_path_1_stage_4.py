...
# Data for the bar chart after sorting by work_hours in ascending order
...
# Plotting the sorted bar chart for work hours
...
# Plotting the sorted bar chart for productivity
