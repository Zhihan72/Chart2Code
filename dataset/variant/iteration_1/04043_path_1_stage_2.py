...
bars1 = ax.bar(x - width/2, sales_q1, width, label='Q1 2023', color='seagreen', edgecolor='black')
bars2 = ax.bar(x + width/2, sales_q2, width, label='Q2 2023', color='darkorange', edgecolor='black')
