...
plt.title('Annual Avg Ratings (18-22)', fontsize=14, pad=20)
plt.ylabel('Yr', fontsize=12)
plt.xlabel('Avg Rat', fontsize=12)
plt.yticks(y_pos + bar_height * (len(genres) / 2 - 0.5), years)
plt.legend(title="Gnrs")
