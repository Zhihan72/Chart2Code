...
# Shuffle node colors: Assign different colors arbitrarily
shuffled_node_colors = ['lightgreen', 'skyblue', 'lightcoral', 'lightyellow', 'lightblue', 'lightpink', 'lightgray']
nx.draw_networkx_nodes(G, pos, node_color=shuffled_node_colors, node_size=2500, edgecolors='k')
