...
# Reduced datasets by removing last three robots
robot_ids = np.arange(1, 13)
operational_speeds = np.array([40, 50, 55, 70, 80, 90, 100, 110, 120, 125, 130, 135])
items_processed = np.array([320, 400, 450, 560, 640, 720, 800, 880, 960, 1025, 1080, 1120])
...
sc = plt.scatter(operational_speeds, items_processed, 
                 ...
                 alpha=0.7, edgecolors='gray', linewidth=0.8, cmap='plasma', marker='^')
