...
# New data for additional academies of magic
...
# Updated dataset with additional academies
data = [
...
# Assign colors for the new academies
...
# Updated chart title to reflect the addition of new academies
