...
ax.set_title('Growth of SunPower in Lightville (2000-2020)', fontsize=18, fontweight='bold', pad=20)
ax.set_xlabel('Timeline', fontsize=14, labelpad=10)
ax.set_ylabel('Output Volume (GWh)', fontsize=14, labelpad=10)
ax.set_xticks(years[::2])
ax.set_yticks(np.arange(0, 551, 50))
ax.yaxis.grid(True, linestyle='--', alpha=0.7)

ax.legend(loc='upper left', fontsize=12, title='Divisions', title_fontsize='12')

ax.annotate('Initial Solar Setup', xy=(2000, 4), xytext=(2003, 100),
            arrowprops=dict(facecolor='black', arrowstyle='->'),
            fontsize=12, color='blue', fontweight='bold')

ax.annotate('Home Energy Expansion', xy=(2010, 19), xytext=(2014, 240),
            arrowprops=dict(facecolor='black', arrowstyle='->'),
