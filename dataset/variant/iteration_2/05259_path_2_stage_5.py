...
ax2.plot(years, per_capita_emissions, color='blue', linestyle='-', linewidth=2, marker='o')
ax1.plot(years, co2_levels, color='blue', linestyle='-', linewidth=2, marker='o')
ax1_secondary = ax1.twinx()
ax1_secondary.plot(years, global_temps, color='blue', linestyle='--', linewidth=2, marker='s')
ax3.plot(years, renewable_energy_adoption, color='blue', linestyle='-', linewidth=2, marker='^')
