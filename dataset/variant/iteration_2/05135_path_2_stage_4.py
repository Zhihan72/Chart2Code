...
ax.scatter(range(1, 7), median_values, color='firebrick', marker='*', s=150, zorder=3, label='Median')
...
ax.text(1, 9.5, 'High', fontsize=10, color='indigo', ha='center')
ax.text(2, 7.5, 'Low', fontsize=10, color='crimson', ha='center')
ax.text(3, 9.5, 'Excel', fontsize=10, color='forestgreen', ha='center')
ax.text(4, 8.3, 'Avg', fontsize=10, color='teal', ha='center')
ax.text(5, 8.5, 'Smooth', fontsize=10, color='royalblue', ha='center')
ax.text(6, 7, 'Mild', fontsize=10, color='saddlebrown', ha='center')
