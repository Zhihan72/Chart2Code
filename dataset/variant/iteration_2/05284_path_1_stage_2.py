...
rects1 = ax.bar(x_positions - bar_width/2, weekday_hours, width=bar_width, label='Workday', color='lightgreen', edgecolor='navy')
rects2 = ax.bar(x_positions + bar_width/2, weekend_hours, width=bar_width, label='Offday', color='orange', edgecolor='navy')
