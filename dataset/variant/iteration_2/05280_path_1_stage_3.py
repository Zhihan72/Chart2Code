...
plt.plot([], [], color='grey', linewidth=1, label='Up to 2 trips/week')
plt.plot([], [], color='grey', linewidth=3, label='3 or 4 trips/week')
plt.plot([], [], color='grey', linewidth=5, label='Over 5 trips/week')
