...
# Updated sectors with additional entries
sectors = ['Neural Computing', 'Cyber Defense', 'Quantum AI', 'Clean Energy', 'Interstellar Tech', 'Space Robotics', 'Bioinformatics']

# Updated expenditure data with new sectors
expenditure_data = [
    ...
    [110, 115, 120, 125, 130, 135, 140, 145, 150, 155], # New made-up data for Space Robotics
    [170, 175, 180, 185, 190, 195, 200, 205, 210, 215]  # New made-up data for Bioinformatics
]
...
ax2 = axes[0]
# Updated growth rates with new sectors
growth_rates = [
    ...
    [7, 9, 14, 10, 12, 15, 13, 10, 11, 14],   # New made-up growth for Space Robotics
    [11, 13, 9, 7, 14, 10, 8, 12, 13, 9]    # New made-up growth for Bioinformatics
]
marker_styles = ['o', '^', 's', 'd', 'v', '*', 'x']  # Added new markers for new sectors
