...
# Use a single color, e.g., 'skyblue' for all data groups
consistent_color = 'skyblue'

axs[0, 0].bar(species, birth_rates_region_A, color=consistent_color, edgecolor='black', alpha=0.7)
axs[0, 0].bar(species, birth_rates_region_B, color=consistent_color, edgecolor='black', alpha=0.7, bottom=birth_rates_region_A)
...
for i in range(len(species)):
    axs[1, 1].plot(weeks, weekly_birth_rates_region_A[:, i], marker='o', color=consistent_color)
...
for i in range(len(species)):
    axs[1, 0].plot(weeks, weekly_birth_rates_region_B[:, i], marker='o', color=consistent_color)
...
for i in range(len(species)):
    axs[0, 1].plot(weeks, weekly_birth_rate_ratio[:, i], marker='x', color=consistent_color)
