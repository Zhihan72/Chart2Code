...
# Data for Plant-based food consumption in kilotons
...
ax.plot(years, north_america, marker='o', linestyle='-', color='blue', linewidth=2, label='USA and Allies')
ax.plot(years, europe, marker='s', linestyle='--', color='green', linewidth=2, label='Eastern Lands')
ax.plot(years, asia, marker='^', linestyle='-.', color='red', linewidth=2, label='Rising Sun')
ax.plot(years, oceania, marker='d', linestyle=':', color='purple', linewidth=2, label='Down Under')
