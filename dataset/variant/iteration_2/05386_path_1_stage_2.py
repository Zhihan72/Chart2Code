...
ax[0].set_title('Food Distribution', fontsize=14, fontweight='bold', pad=20)
ax[0].axis('equal')

ax[1].bar(colonies, sweet_consumption, color='#FFDA79', edgecolor='black')
ax[1].set_title('Sweet Consumption', fontsize=14, fontweight='bold')
ax[1].set_ylabel('Sweet Items', fontsize=12)
