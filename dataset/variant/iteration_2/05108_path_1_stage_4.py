...
new_colors = ['#FF4500', '#32CD32', '#4682B4', '#8A2BE2', '#FFD700']
...
for i, age_group in enumerate(age_groups):
    ...
    ax.bar(years, pos_vals, bottom=midpoint_consumption, color=new_colors[i], label=f'{age_group}+')
    ax.bar(years, -neg_vals, bottom=midpoint_consumption, color=new_colors[i], label=f'{age_group}-', hatch='//')
