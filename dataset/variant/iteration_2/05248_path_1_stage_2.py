...
solar_data = [8, 7, 9, 8, 7]  # Shuffled data
wind_data = [9, 6, 7, 8, 8]   # Shuffled data
hydro_data = [6, 8, 7, 9, 8]  # Shuffled data
geothermal_data = [7, 8, 6, 6, 7]  # Shuffled data
biomass_data = [6, 7, 6, 7, 7]  # Shuffled data
