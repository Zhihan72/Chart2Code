...
internet_users = [
    [500, 800, 1100, 1500],  # Americas
    [400, 700, 1000, 1200],  # Europe
    [1000, 1600, 2300, 2500], # Asia
    [200, 400, 700, 1000],    # Africa
    [50, 100, 200, 300],      # Oceania
    [5, 10, 20, 30],          # Antarctica (fictitious data)
    [15, 25, 35, 45]          # Atlantis (fictitious data)
]
...
ax.set_title('User Uprise Globally (2005-2020)', fontsize=16, fontweight='bold')
