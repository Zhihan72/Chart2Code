...
# Applying a single color (darkblue) across all regions.
plt.plot(years_smooth, coastal_temp_smooth, label='Region 1 - Coast', color='darkblue', linewidth=2)
plt.plot(years_smooth, inland_temp_smooth, label='Region B - Inland', color='darkblue', linewidth=2)
plt.plot(years_smooth, mountain_temp_smooth, label='Zone Alpha - Mountains', color='darkblue', linewidth=2)
