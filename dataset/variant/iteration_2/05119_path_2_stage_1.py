...
cybersecurity_exhibitors = [8, 10, 13, 17, 22, 28, 33, 36]  # New category
...
ax.bar(years, cybersecurity_exhibitors, bottom=quantum_cumulative, label='Cybersecurity', color='gold', alpha=0.8)  # New category
