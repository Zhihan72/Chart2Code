...
# Single color applied
single_color = '#4682B4'

fig, ax = plt.subplots(figsize=(14, 9))

ax.fill_between(years, 0, cumulative_data[0], color=single_color, alpha=0.85)
ax.fill_between(years, cumulative_data[0], cumulative_data[1], color=single_color, alpha=0.85)
ax.fill_between(years, cumulative_data[1], cumulative_data[2], color=single_color, alpha=0.85)
ax.fill_between(years, cumulative_data[2], cumulative_data[3], color=single_color, alpha=0.85)
