...
# Switched this subplot to position [1, 1]
axs[1, 1].plot(years, recycling_boomers, label='Repurposing', marker='o', color=colors[1])
axs[1, 1].plot(years, volunteering_boomers, label='Community Service', marker='o', color=colors[2])
axs[1, 1].plot(years, fitness_boomers, label='Exercise Routines', marker='o', color=colors[0])
...
# Switched this subplot to position [0, 0]
axs[0, 0].plot(years, np.array(recycling_boomers) + np.array(recycling_genx), 
               label='Overall Repurposing', marker='o', color=colors[1])
axs[0, 0].plot(years, np.array(volunteering_boomers) + np.array(volunteering_genx), 
               label='Overall Community Service', marker='o', color=colors[2])
axs[0, 0].plot(years, np.array(fitness_boomers) + np.array(fitness_genx), 
