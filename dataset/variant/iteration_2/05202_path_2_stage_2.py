...
bar1 = ax1.bar(x - 1.5*width, org_A, width, label='Org Alpha', color='#79C753', edgecolor='black')
bar2 = ax1.bar(x - 0.5*width, org_B, width, label='Org Beta', color='#4CAF50', edgecolor='black')
bar3 = ax1.bar(x + 0.5*width, org_C, width, label='Org Gamma', color='#2E7D32', edgecolor='black')
bar4 = ax1.bar(x + 1.5*width, org_D, width, label='Org Delta', color='#1B5E20', edgecolor='black')

ax1.set_title('Conservation Initiatives\nby Groups (2018-2022)', fontsize=16, fontweight='bold', pad=20)
ax1.set_xlabel('Annual Period', fontsize=12)
ax1.set_ylabel('Planted Count (Thou.)', fontsize=12)
ax1.set_xticks(x)
