...
ax1.bar(x[1:] - width, north_america_growth, width, label='North America', color='lightblue')
ax1.bar(x[1:], europe_growth, width, label='Europe', color='salmon')
ax1.bar(x[1:] + width, asia_growth, width, label='Asia', color='olive')

ax1.set_xlabel('Year', fontsize=12)
ax1.set_ylabel('Growth Rate (%)', fontsize=12, weight='bold')
ax1.set_title('YoY Growth Rate in Books per Person', fontsize=14, weight='bold', pad=15)
ax1.set_xticks(x[1:])
