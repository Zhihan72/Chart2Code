...
# New set of colors for the stack plot
new_colors = ['#ff9999', '#66b3ff', '#99ff99', '#ffcc99']
ax1.stackplot(years, hydropower, solar, wind, fossil_fuels, labels=['Hydropower', 'Solar', 'Wind', 'Fossil Fuels'], colors=new_colors, alpha=0.85)
