...
plt.plot(years, efficiency_model_A, '*-', label='Electric Vehicle Variant 1', color='red')
plt.plot(years, efficiency_model_B, '^--', label='Battery Car Model Z', color='cyan')
plt.plot(years, efficiency_model_C, 'h-.', label='Model C Efficiency Curve', color='magenta')
plt.plot(years, efficiency_model_D, 'p:', label='Version D Mileage', color='yellow')
