...
ax.bar(sorted_years_tomatoes - width * 1.5, sorted_tomatoes, width, color='tomato', hatch='x')
ax.bar(sorted_years_carrots - width / 2, sorted_carrots, width, color='orange', hatch='o')
ax.bar(sorted_years_cucumbers + width / 2, sorted_cucumbers, width, color='green', hatch='//')
ax.bar(sorted_years_lettuce + width * 1.5, sorted_lettuce, width, color='lightgreen', hatch='\\')
