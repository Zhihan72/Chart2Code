...
ax1.plot(days, panel_A, color='#1f77b4', marker='o', linestyle='-', linewidth=2, label='Panel A')
ax1.plot(days, panel_B, color='#ff7f0e', marker='s', linestyle='--', linewidth=2, label='Panel B')
ax1.plot(days, panel_C, color='#2ca02c', marker='^', linestyle='-.', linewidth=2, label='Panel C')
ax1.plot(days, panel_D, color='#d62728', marker='D', linestyle=':', linewidth=2, label='Panel D')
ax1.plot(days, panel_E, color='#9467bd', marker='>', linestyle='-', linewidth=2, label='Panel E')
ax1.plot(days, panel_F, color='#8c564b', marker='<', linestyle='--', linewidth=2, label='Panel F')
