...
for idx, sector_growth in enumerate(growth_rates):
    ax1.scatter(years, sector_growth, s=100, alpha=0.7, edgecolors='w',
                c=[['yellow', 'red', 'blue', 'green', 'purple'][idx]])

ax1.yaxis.grid(True, linestyle='--', alpha=0.7)
ax1.set_xticks(years)
ax1.set_xticklabels([str(yr) for yr in years], rotation=45, ha='right')

# Box plot on the right (horizontal orientation)
ax2 = axes[1]
ax2.boxplot(expenditure_data, vert=False, patch_artist=True, showmeans=True, notch=True,
