...
ax.plot(years, esports_revenue, marker='o', linestyle='-', color='orange', linewidth=2)
ax.plot(years, robot_combat_revenue, marker='^', linestyle='-', color='cyan', linewidth=2)
ax.plot(years, drone_racing_revenue, marker='s', linestyle='-', color='magenta', linewidth=2)
ax.plot(years, ar_sports_revenue, marker='d', linestyle='-', color='brown', linewidth=2)
