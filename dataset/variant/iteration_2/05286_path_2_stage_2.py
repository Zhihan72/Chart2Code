...
# Changed marker types, and adjusted border and grid styles
ax.stackplot(years, energy_data, labels=['Solar', 'Wind', 'Hydro', 'Geothermal', 'Bioenergy'],
             colors=['#ffd700', '#1e90ff', '#32cd32', '#ff7f50', '#9370db'], alpha=0.7, edgecolor='darkgrey', linewidth=1.5)
