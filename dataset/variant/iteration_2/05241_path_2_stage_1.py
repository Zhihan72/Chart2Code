...
ax1.fill_between(years, 0, solar_power, color='#FFA07A', alpha=0.7, label='Solar Power')
ax1.fill_between(years, solar_power, cumulative_wind, color='#7B68EE', alpha=0.7, label='Wind Power')
ax1.fill_between(years, cumulative_wind, cumulative_hydropower, color='#3CB371', alpha=0.7, label='Hydropower')
ax1.fill_between(years, cumulative_hydropower, cumulative_geothermal, color='#FFD700', alpha=0.7, label='Geothermal')
ax1.fill_between(years, cumulative_geothermal, cumulative_biomass, color='#8A2BE2', alpha=0.7, label='Biomass')
...
ln1 = ax2.plot(years, CO2_reduction, color='darkorange', linewidth=2.5, marker='o', label='CO2 Reduction (in MMT)')
ln2 = ax2.plot(years, deforestation_prevented, color='deepskyblue', linewidth=2.5, marker='s', label='Deforestation Prevented (in 1000 hectares)')
