...
# Box plot creation with altered styles
box = ax.boxplot(river_qualities, patch_artist=True, notch=True, vert=True,
...
# Grid adjustments
ax.xaxis.grid(True, linestyle='-.', color='lightgrey', alpha=0.7)
