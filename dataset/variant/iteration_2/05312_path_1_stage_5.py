...
creatures = ['Sphinx', 'Goblin', 'Mermaid', 'Phoenix', 'Yeti', 'Dragon', 'Unicorn']
...
scores = {
    ...
    'Yeti': [75, 80, 70, 75, 85],
    'Dragon': [88, 92, 85, 95, 90],
    'Unicorn': [70, 75, 80, 65, 68]
}
...
box_colors = ['lightcyan', 'lightgrey', 'lightgreen', 'lightblue', 'lightpink', 'lightyellow', 'lavender']
