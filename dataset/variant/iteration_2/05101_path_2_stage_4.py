...
fruit_labels = ['Mng', 'Pine', 'Bana', 'Coco', 'Papa', 'Duri', 'Lychee']

colors = ['lightcoral', 'lightgreen', 'lightyellow', 'lightpink', 'lightsalmon', 'lightsteelblue', 'lightskyblue']
...
ax.set_title('Plantation Area Dist.', fontsize=16, fontweight='bold', pad=20)
