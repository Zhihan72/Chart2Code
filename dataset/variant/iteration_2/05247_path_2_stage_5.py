...
# Data sorted by vitamin content in ascending order
fruits = ["Banana", "Orange", "Grapes", "Strawberry", "Watermelon", "Apple", "Kiwi", "Blueberry"]
vitamin_content = [6, 8, 9, 10, 10, 32, 70, 92]  # Sorted
avg_rating = [8.5, 7.0, 9.5, 8.0, 8.5, 9.0, 7.0, 7.5]  # Corresponding ratings
