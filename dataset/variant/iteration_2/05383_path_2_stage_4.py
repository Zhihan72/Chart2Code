...
# Plot each region's data with shuffled colors
ax.plot(years, north_america, marker='o', linestyle='-', color='red', linewidth=2)  # Changed from 'blue' to 'red'
ax.plot(years, europe, marker='s', linestyle='--', color='blue', linewidth=2)       # Changed from 'green' to 'blue'
ax.plot(years, asia, marker='^', linestyle='-.', color='green', linewidth=2)        # Changed from 'red' to 'green'
