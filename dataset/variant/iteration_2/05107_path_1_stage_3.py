...
box = plt.boxplot(data, patch_artist=True, notch=True, vert=False)  # Set vert to False for horizontal plot
...
plt.grid(axis='x', linestyle='--', alpha=0.7)  # Change grid axis to 'x'
plt.tight_layout()
plt.show()