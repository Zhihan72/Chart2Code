...
aquatera_investment = [4, 9, 11, 18, 28, 38]  # New data series
...
aquatera_impact = [1.5, 5, 9, 13, 22, 33]  # New data series
...
ax1.plot(years, aquatera_investment, marker='*', linestyle='-', color='#8A2BE2', linewidth=2, label='Aquatera')  # New country
...
ax2.plot(years, aquatera_impact, marker='*', linestyle='-', color='#8A2BE2', linewidth=2, label='Aquatera')  # New country
