...
# Colors are manually shuffled for visualization
...
bars1 = ax1.bar(index, new_constructions, bar_width, color=color_sequence, edgecolor='black', linestyle=':', hatch='/', label='New Constructions')
