...
# Data for five glaciers in gigatons of ice lost per year
...
glacier_d = np.array([1.7, 1.8, 1.9, 2.0, 2.1, 2.2, 2.4, 2.5, 2.6, 2.8, 2.9])  # New data
glacier_e = np.array([2.0, 2.1, 2.2, 2.4, 2.6, 2.7, 2.8, 3.0, 3.1, 3.3, 3.5])  # New data
...
axs[0].plot(years, glacier_b, marker='s', label='Glacier B', color='#ff7f0e')
axs[0].plot(years, glacier_c, marker='^', label='Glacier C', color='#2ca02c')
axs[0].plot(years, glacier_d, marker='*', label='Glacier D', color='#d62728')  # New plot
axs[0].plot(years, glacier_e, marker='x', label='Glacier E', color='#9467bd')  # New plot
...
axs[1].plot(years, cumulative_b, marker='s', label='Glacier B', color='#ff7f0e')
axs[1].plot(years, cumulative_c, marker='^', label='Glacier C', color='#2ca02c')
axs[1].plot(years, cumulative_d, marker='*', label='Glacier D', color='#d62728')  # New plot
axs[1].plot(years, cumulative_e, marker='x', label='Glacier E', color='#9467bd')  # New plot
