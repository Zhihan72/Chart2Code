...
scenarios = ['Resi Day', 'Resi Night', 'Comm Day', 'Comm Night', 
             'Ind Day', 'Ind Night', 'Hub Day', 'Hub Night']
...
ax.set_title("Urban Noise: Day/Night", fontsize=18, fontweight='bold')
ax.set_xlabel("Levels (dB)", fontsize=14)
ax.set_ylabel("Scenario", fontsize=14)
ax.set_yticks(np.arange(1, len(scenarios) + 1))
ax.set_yticklabels(scenarios, rotation=45, fontsize=12)
