...
ax.plot(years, geothermal_energy, color='red', marker='D', linestyle='-', linewidth=2, label='Geothermal Energy')
ax.plot(years, biomass_energy, color='purple', marker='x', linestyle='-', linewidth=2, label='Biomass Energy')
