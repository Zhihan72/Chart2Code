...
ax[0].plot(days, low_temps, label='Min Temp', color='purple', linestyle=':', marker='x', markersize=3)
ax[0].fill_between(days, low_temps, high_temps, facecolor='lightblue', alpha=0.4)
...
ax[1].grid(False)  # Removed grid from the rainfall chart for contrast
