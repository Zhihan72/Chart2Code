...
# Plotting each media type's usage over the decades with new colors
ax.plot(decades, vhs_usage, label='VHS', marker='o', linestyle='-', linewidth=2, color='#800000')  # Maroon
ax.plot(decades, dvd_usage, label='DVD', marker='^', linestyle='--', linewidth=2, color='#1A237E')  # Indigo
ax.plot(decades, bluray_usage, label='Blu-ray', marker='s', linestyle=':', linewidth=2, color='#388E3C')  # Green
ax.plot(decades, digital_usage, label='Digital', marker='D', linestyle='-.', linewidth=2, color='#D32F2F')  # Red
