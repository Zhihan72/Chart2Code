...
# Manually altered sleep data within each age group while preserving original length
child_sleep = [9, 11, 9.5, 10.5, 8, 9, 10, 11, 12, 8.5]
teen_sleep = [6, 8, 7, 7.5, 6.5, 8, 7, 8, 6, 8.5]
adult_sleep = [7, 6, 7, 5.5, 6.5, 7.5, 6, 8, 5, 6.5]
senior_sleep = [6, 5.5, 6, 5, 6.5, 7, 5, 6, 5.5, 6]
