...
ax.stackplot(years, activities, colors=['#FF6347', '#9ACD32', '#DAA520'], alpha=0.8)
...
ax.plot(years, reading, marker='o', linestyle='-', color='#FF6347')
ax.plot(years, learning_skills, marker='o', linestyle='-', color='#9ACD32')
ax.plot(years, relaxation, marker='o', linestyle='-', color='#DAA520')
