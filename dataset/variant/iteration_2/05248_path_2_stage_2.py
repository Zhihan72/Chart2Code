...
# New made-up data for Nuclear Energy
...
data_entries = {
    ...
    'Nuclear': np.array(nuclear_data + [nuclear_data[0]])  # Added new data series
}

angles = np.linspace(0, 2 * np.pi, len(categories), endpoint=False).tolist()
angles += angles[:1]

colors = ['#FF6347', '#4682B4', '#32CD32', '#FFD700', '#9370DB', '#FF1493']  # Added color for Nuclear
