...
ax[0].plot(density_luminosity1, luminosity_grid1, label='Luminosity Density', color='blue')
ax[0].plot(density_temperature1, temperature_grid1, label='Temperature Density', color='green')
ax[0].set_title("Star System 1: Density Profiles", fontsize=12, fontweight='bold', pad=10)
...
ax[1].plot(density_luminosity2, luminosity_grid2, label='Luminosity Density', color='red')
ax[1].plot(density_temperature2, temperature_grid2, label='Temperature Density', color='orange')
ax[1].set_title("Star System 2: Density Profiles", fontsize=12, fontweight='bold', pad=10)
ax[1].set_xlabel("Density", fontsize=10)
ax[1].legend()
ax[1].grid(True, linestyle='--', linewidth=0.6, alpha=0.7)

# Main title
fig.suptitle("Stellar Wonders: Density Distribution in Star Systems", fontsize=16, fontweight='bold')
