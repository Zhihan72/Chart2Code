...
efficiency_scores = {
    ...
    "A4": efficiency_scores_A4,  # Switch A1 with A4
    "A3": efficiency_scores_A3,
    "A2": efficiency_scores_A2  # Switch A2 with A3
}
...
titles = ["Algorithm A4 Efficiency", "Algorithm A3 Efficiency", "Algorithm A2 Efficiency", "Algorithm A1 Efficiency"]  # Reordered titles
