...
ax1.plot(years, campaign_D, marker='d', linestyle='-', color='green', label='Campaign D', linewidth=2)
ax1.plot(years, campaign_E, marker='*', linestyle='-', color='red', label='Campaign E', linewidth=2)
...
ax2.plot(years, cumulative_D, marker='d', linestyle='-', color='green', label='Cumulative Campaign D', linewidth=2)
ax2.plot(years, cumulative_E, marker='*', linestyle='-', color='red', label='Cumulative Campaign E', linewidth=2)
