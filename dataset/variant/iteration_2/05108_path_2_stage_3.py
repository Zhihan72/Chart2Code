...
colors = ['#9370DB', '#1E90FF', '#90EE90', '#FFD700', '#FF6347']  # Rearranged colors

fig, ax = plt.subplots(figsize=(10, 7))  # Changed figsize

bar_width = 0.12  # Adjusted bar_width
...
ax.legend(loc='best', fontsize=10)  # Changed legend position
ax.grid(False)  # Removed grid
ax.spines['top'].set_visible(False)  # Modified border visibility
