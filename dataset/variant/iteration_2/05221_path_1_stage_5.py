...
ax.bar(sorted_tools, sorted_active_users, color=new_colors, edgecolor='black', linewidth=1.5)

ax.set_xlabel('Program App', fontsize=12, style='italic')
ax.set_ylabel('Total Users Over Time (in Thousands)', fontsize=12, style='italic')
...
ax.legend(['User Count'], loc='upper right', fontsize=10, frameon=False)
