...
# Changed line styles and marker types
...
plt.plot(years, efficiency_model_C, '<-', label='EV Model C', color='cyan')
...
# Changed annotation positions and text colors
...
# Adjusted grid style and transparency
plt.grid(linestyle='-', alpha=0.8, color='lightgray')

# Changed legend location and font size
