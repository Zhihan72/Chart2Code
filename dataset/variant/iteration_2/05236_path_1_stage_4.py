...
audience_counts = [60000, 50000, 30000, 16000, 8000, 4000, 2000, 1000]
# Shuffled manually: Original color order: ['#aec7e8', '#98df8a', '#ffbb78', '#ff9896', '#c5b0d5', '#c49c94', '#c7c7c7', '#8c564b']
colors = ['#ff9896', '#c49c94', '#c5b0d5', '#8c564b', '#ffbb78', '#c7c7c7', '#aec7e8', '#98df8a']
...
ax.set_xticks([])
ax.set_yticks([])
ax.set_title('Extended Marketing Voyage Series\nUser Navigation Across Phases', 
