...
ax1.plot(years, aquatera_investment, marker='*', linestyle='-', color='#8A2BE2', linewidth=2, label='Aquatera')
...
ax2.plot(years, aquatera_impact, marker='*', linestyle='-', color='#8A2BE2', linewidth=2, label='Aquatera')
