...
ax.bar(positions, germany_farms, width=bar_width, color='cornflowerblue')
ax.bar(positions + bar_width, france_farms, width=bar_width, color='cornflowerblue')
ax.bar(positions + 2 * bar_width, italy_farms, width=bar_width, color='cornflowerblue')
ax.bar(positions + 3 * bar_width, spain_farms, width=bar_width, color='cornflowerblue')
ax.bar(positions + 4 * bar_width, sweden_farms, width=bar_width, color='cornflowerblue')
