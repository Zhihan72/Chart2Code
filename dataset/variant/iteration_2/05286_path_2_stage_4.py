...
# Shuffled colors: Keeping the colors same but swapping their order
ax.stackplot(years, energy_data, labels=['Solar', 'Wind', 'Hydro', 'Geothermal', 'Bioenergy', 'Wave', 'Tidal'],
             colors=['#1e90ff', '#ff7f50', '#9370db', '#32cd32', '#4682b4', '#ffd700', '#00ced1'], alpha=0.7, edgecolor='darkgrey', linewidth=1.5)
