...
# Use the same color 'blue' for all data lines
ax.plot(years, opening_price, marker='o', color='blue', linewidth=2)
ax.plot(years, closing_price, marker='o', color='blue', linewidth=2)
ax.plot(years, highest_price, marker='o', color='blue', linewidth=2)
ax.plot(years, lowest_price, marker='o', color='blue', linewidth=2)
