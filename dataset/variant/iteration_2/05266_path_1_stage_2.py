...
# Added a new stage and corresponding values
...
average_durations = [4, 8, 16, 10, 14, 24, 30]  # Added duration for new stage

widths = [count / max(startup_counts) for count in startup_counts]
colors = ['#3498db', '#1abc9c', '#9b59b6', '#e74c3c', '#f1c40f', '#e67e22', '#34495e']  # Added additional color
...
# Loop updated to include the new stage
...
ax1.set_xticks([])
ax1.set_xlim(0, 1)
ax1.set_title("Startup Progression Funnel:\nFrom Idea to Scaling", fontsize=18, fontweight='bold', pad=20)

# Updated barh function for incorporating new data
