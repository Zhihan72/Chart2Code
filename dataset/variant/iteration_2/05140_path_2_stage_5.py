...
plum_yield = [22, 19, 21, 23, 22, 20, 25, 24, 20, 21]
peach_yield = [29, 27, 30, 28, 33, 31, 32, 30, 31, 34]

data = [apple_yield, orange_yield, pear_yield, cherry_yield, plum_yield, peach_yield]
fruit_labels = ['Apple', 'Orange', 'Pear', 'Cherry', 'Plum', 'Peach']

fig, ax = plt.subplots(figsize=(11, 7))

boxplot = ax.boxplot(data, vert=False, patch_artist=True, labels=fruit_labels, widths=0.7, notch=False)

colors = ['#FFD700', '#FF4500', '#1E90FF', '#32CD32', '#8A2BE2', '#FF69B4']
...
ax.set_ylabel('Type of Fruit', fontsize=12)
ax.set_xlabel('Yield (in tons)', fontsize=12)
