...
# Shuffled color assignment for each region
plt.plot(years, ev_us, color='green', marker='o', linestyle='-', linewidth=2, markersize=5, label='USA')
plt.plot(years, ev_europe, color='red', marker='s', linestyle='-', linewidth=2, markersize=5, label='Europe')
plt.plot(years, ev_china, color='purple', marker='d', linestyle='-', linewidth=2, markersize=5, label='China')
plt.plot(years, ev_japan, color='magenta', marker='p', linestyle='-', linewidth=2, markersize=5, label='Japan')
plt.plot(years, ev_india, color='cyan', marker='*', linestyle='-', linewidth=2, markersize=5, label='India')
plt.plot(years, ev_korea, color='orange', marker='x', linestyle='-', linewidth=2, markersize=5, label='South Korea')
plt.plot(years, ev_australia, color='blue', marker='^', linestyle='-', linewidth=2, markersize=5, label='Australia')
