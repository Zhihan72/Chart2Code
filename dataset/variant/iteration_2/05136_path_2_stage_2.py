...
ax.plot(years, red_giant_magnitudes, label='Red Giant', color='red', marker='v', linestyle=':', linewidth=2)
ax.plot(years, white_dwarf_magnitudes, label='White Dwarf', color='blue', marker='x', linestyle='-', linewidth=2)
ax.plot(years, main_sequence_magnitudes, label='Main Seq', color='green', marker='D', linestyle='--', linewidth=2)

# Added a different effect in fill_between for variation
ax.fill_between(years, red_giant_magnitudes, color='red', alpha=0.2)
ax.fill_between(years, white_dwarf_magnitudes, color='blue', alpha=0.2)
ax.fill_between(years, main_sequence_magnitudes, color='green', alpha=0.2)
...
# Adjusted smooth trendline appearance
ax.plot(rg_x, rg_smooth, color='red', linestyle='-', alpha=0.5)
ax.plot(wd_x, wd_smooth, color='blue', linestyle='-', alpha=0.5)
ax.plot(ms_x, ms_smooth, color='green', linestyle='--', alpha=0.5)
