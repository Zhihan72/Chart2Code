...
ax1.barh(y - 1.5*height, org_A, height, color='#79C753')
ax1.barh(y - 0.5*height, org_B, height, color='#4CAF50')
ax1.barh(y + 0.5*height, org_C, height, color='#2E7D32')
ax1.barh(y + 1.5*height, org_D, height, color='#1B5E20')
