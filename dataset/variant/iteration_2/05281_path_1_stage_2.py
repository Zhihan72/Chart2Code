...
ax.bar(r1, store_a_sales, color='#5DA5DA', width=bar_width, edgecolor='grey')
ax.bar(r2, store_b_sales, color='#FAA43A', width=bar_width, edgecolor='grey')
ax.bar(r3, store_c_sales, color='#60BD68', width=bar_width, edgecolor='grey')
ax.bar(r4, store_d_sales, color='#F17CB0', width=bar_width, edgecolor='grey')
