...
# Data for the bar chart (sorted by sales in descending order)
instruments = ['Guitars', 'Drums', 'Pianos', 'Flutes']
sales = [150, 90, 80, 45]  # Sales in thousands of units

# Corresponding growth rates (reordered to match the sorted instruments)
growth_rates = [7, 3, 5, 8]  # Year-over-year growth rates in percentage
...
# Bar chart for sales
bars = ax1.bar(instruments, sales, color=bar_colors, edgecolor='black')
