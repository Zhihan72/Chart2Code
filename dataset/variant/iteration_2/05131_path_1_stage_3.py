...
hbo_max_popularity = np.array([0, 0, 0, 0, 0, 20, 50, 70, 75])  # New data series
...
plt.plot(years, hbo_max_popularity, marker='h', linestyle='-', color='orange', label='HBO Max')  # New plot
