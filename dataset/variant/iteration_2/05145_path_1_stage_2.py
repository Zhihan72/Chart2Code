...
# Modified markers, line styles, and colors
ax1.plot(years, fps_viewership, color='orange', linestyle=':', linewidth=2, marker='v', label='FPS Games')
ax1.plot(years, moba_viewership, color='purple', linestyle='-.', linewidth=2, marker='d', label='MOBA Games')
ax1.plot(years, rts_viewership, color='cyan', linestyle='-', linewidth=2, marker='x', label='RTS Games')

# Changed grid style
ax1.grid(True, linestyle='-', linewidth=0.75, alpha=0.5)

# Titles and labels with modified properties
...
# Keeping the highlights as similar core information is desired
...
# Re-organized annotation text and arrow style
key_events = {
    '2013': 'Arena\nExpansion',
    '2015': 'Shooter\nBoom',
    '2018': 'Public\nInterest'
...
# Legend modified position and font size
