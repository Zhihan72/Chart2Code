...
ax.plot(months, consumption_current_year, label='Current', marker='o', markersize=8, linestyle='-', color='green')
ax.plot(months, consumption_previous_year, label='Previous', marker='s', markersize=8, linestyle='--', color='blue')
