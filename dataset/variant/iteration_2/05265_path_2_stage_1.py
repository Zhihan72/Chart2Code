...
# Updated colors: Green for Self-Driving Cars, Orange for Accidents Reduction
...
ax2 = ax1.twinx()
ax2.plot(years, accidents_reduction_percentage, color='orange', linewidth=2, label='Accidents Reduction (%)')
for (x, y) in zip(years, accidents_reduction_percentage):
    ax2.text(x, y - 2, f'{y:.1f}%', ha='center', va='top', fontsize=10, color='orange')

ax2.set_ylabel('Accidents Reduction (%)', fontsize=12, color='orange')
