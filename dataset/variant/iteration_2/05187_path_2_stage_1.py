...
# Create data
cities = ['Town1', 'District2', 'Metropolis3', 'Village4', 'Capital5', 'Borough6', 'Hamlet7', 'Region8', 'Locality9', 'Urban10']
populations = [50000, 150000, 300000, 450000, 600000, 850000, 1200000, 1500000, 2000000, 3000000]
park_counts = [20, 35, 50, 75, 90, 150, 200, 250, 300, 350]
