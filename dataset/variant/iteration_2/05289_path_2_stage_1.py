...
ax.bar(weeks - 0.3, mystery_readings, width=0.3, color='#1f77b4')
ax.bar(weeks, fantasy_readings, width=0.3, color='#ff7f0e')
ax.bar(weeks + 0.3, science_fiction_readings, width=0.3, color='#2ca02c')
