...
# Changed node and edge colors to new colors
nx.draw_networkx_nodes(G, pos, node_color='limegreen', node_size=1800)
...
plt.plot([], [], color='navy', linewidth=1, label='Up to 2 trips/week')
plt.plot([], [], color='navy', linewidth=3, label='3 or 4 trips/week')
plt.plot([], [], color='navy', linewidth=5, label='Over 5 trips/week')
plt.legend(title='Transport Load', bbox_to_anchor=(1.15, 1))
