...
it_infrastructure = np.array([8, 10, 12, 14, 16])  # New data for IT Infrastructure
training = np.array([3, 4, 5, 6, 7])  # New data for Training & Development

# Stack the data
data = np.vstack([
    salaries, marketing, research, operational, miscellaneous, 
    it_infrastructure, training
])
...
# Define color palette with additional colors
colors = [
