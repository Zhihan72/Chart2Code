...
ax.plot(weeks, spring_park_visitors, marker='^', color='blue', linestyle='-', label='Spring', linewidth=2)
ax.plot(weeks, ocean_park_visitors, marker='x', color='green', linestyle='-.', label='Ocean', linewidth=2)
...
for i in range(0, len(weeks), 6):
    ax.annotate(f'{spring_park_visitors[i]}k', (weeks[i], spring_park_visitors[i]), textcoords="offset points", xytext=(-10,10), ha='center', fontsize=9, color='blue')
    ax.annotate(f'{ocean_park_visitors[i]}k', (weeks[i], ocean_park_visitors[i]), textcoords="offset points", xytext=(10,-15), ha='center', fontsize=9, color='green')
