...
delta_advancement = np.array([5, 12, 18, 25, 35, 45, 55, 65, 80, 90])
...
delta_cumulative = np.cumsum(delta_advancement)

fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(14, 7), sharey=True)

ax1.barh(years - 0.4, alpha_cumulative, height=0.2, color='green', alpha=0.7, label='Alpha Model')
ax1.barh(years - 0.1, beta_cumulative, height=0.2, color='purple', alpha=0.7, label='Beta Model')
ax1.barh(years + 0.2, gamma_cumulative, height=0.2, color='orange', alpha=0.7, label='Gamma Model')
ax1.barh(years + 0.5, delta_cumulative, height=0.2, color='brown', alpha=0.7, label='Delta Model')
...
ax2.barh(years - 0.4, alpha_advancement, height=0.2, color='green', alpha=0.7, label='Alpha Model')
ax2.barh(years - 0.1, beta_advancement, height=0.2, color='purple', alpha=0.7, label='Beta Model')
ax2.barh(years + 0.2, gamma_advancement, height=0.2, color='orange', alpha=0.7, label='Gamma Model')
ax2.barh(years + 0.5, delta_advancement, height=0.2, color='brown', alpha=0.7, label='Delta Model')
