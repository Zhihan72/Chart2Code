...
fig, ax = plt.subplots(2, 1, figsize=(10, 12))  # Changed to 2 rows, 1 column
...
wedges, _, autotexts = ax[0].pie(
    ...
    pctdistance=0.78,
    colors=colors_food, 
    wedgeprops={'width': 0.3, 'linewidth': 2, 'edgecolor': 'gray', 'alpha': 0.9},
    textprops=dict(color="navy", fontsize=9, weight='light')
)

centre_circle = plt.Circle((0, 0), 0.62, fc='lightgrey', alpha=0.85)
