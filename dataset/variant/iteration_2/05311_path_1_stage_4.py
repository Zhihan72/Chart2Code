...
axs[0].plot(decades, transportation_emissions, marker='x', linestyle=':', linewidth=2, color='red', label='Transportation')
axs[0].plot(decades, industry_emissions, marker='o', linestyle='--', linewidth=2, color='orange', label='Industry')
axs[0].plot(decades, agriculture_emissions, marker='s', linestyle='-.', linewidth=2, color='blue', label='Agriculture')
axs[0].plot(decades, residential_emissions, marker='^', linestyle='-', linewidth=2, color='green', label='Residential')
...
axs[0].legend(loc='lower left', fontsize=10, frameon=True, shadow=True)
...
axs[1].plot(decades, average_emissions, marker='d', color='purple', linewidth=2, linestyle='-', label='Average Emissions')
