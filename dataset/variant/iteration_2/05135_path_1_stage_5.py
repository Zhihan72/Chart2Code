...
bplot = ax.boxplot(scores_data, vert=False, patch_artist=True, labels=season_labels,
...
ax.scatter(median_values, range(1, len(scores_data) + 1), color='orange', s=100, zorder=3)
