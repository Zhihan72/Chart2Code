...
for fruit, data, line_style, marker in zip(types_of_fruits, export_data, line_styles, markers):
    ax.plot(years, data, linestyle=line_style, marker=marker, label=fruit)
