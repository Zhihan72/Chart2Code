...
ax.boxplot(sales_data, vert=False, patch_artist=True, labels=['PlayStation', 'Xbox', 'Nintendo'])

ax.set_xlabel('Sales (Millions)', fontsize=14)
ax.set_yticklabels(['PlayStation', 'Xbox', 'Nintendo'], fontsize=12)
ax.set_title('Console Sales Distributions (2010-2020)', fontsize=16, fontweight='bold', pad=20)
