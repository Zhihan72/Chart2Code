...
# Plot for the Eastern Region with new colors
ax.plot(years, hiking_east, marker='o', color='purple', linestyle='-', linewidth=2,
        label='Hiking (East)')
ax.plot(years, cycling_east, marker='s', color='orange', linestyle='-', linewidth=2,
        label='Cycling (East)')
ax.plot(years, running_east, marker='^', color='cyan', linestyle='-', linewidth=2,
        label='Running (East)')
