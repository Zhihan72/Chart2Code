...
books_sales = [10, 12, 15, 18, 20, 22, 27, 30, 35, 40, 45, 50]  # New data series
...
bar_width = 0.2  # Adjusted width for the new group
...
ax1.bar(x_indices + 3 * bar_width, books_sales, bar_width, label='Books', color='slateblue', hatch='x')  # New group

ax1.set_title("Monthly Sales Data", fontsize=16)
ax1.set_xlabel("Month", fontsize=13)
ax1.set_ylabel("Sales (in thousand USD)", fontsize=13)
ax1.set_xticks(x_indices + 1.5 * bar_width)  # Adjusted for centering
