...
# Randomly changed text elements
...
for usage, color in zip([cpu_usage, ram_usage], ['purple', 'orange']):
    ...
    ax.annotate(f'Max Peak: {peak_value}%', xy=(peak_hour, peak_value), xytext=(peak_hour, peak_value+5),
    ...
    ax.annotate(f'Minimum: {low_value}%', xy=(low_hour, low_value), xytext=(low_hour, low_value-10),
                arrowprops=dict(facecolor=color, shrink=0.05), fontsize=12, color=color, ha='center')
