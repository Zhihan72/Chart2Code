...
# Shuffled the assigned colors for each data group
colors = ['#ff7f0e', '#2ca02c', '#d62728', '#9467bd', '#8c564b', '#1f77b4']

ax.stackplot(years, tourism_data, colors=colors, alpha=0.8)
