...
ax.plot(years, solar_energy, color='orange', marker='o', linestyle='-', linewidth=2)
ax.plot(years, wind_energy, color='blue', marker='^', linestyle='-', linewidth=2)
ax.plot(years, hydro_energy, color='green', marker='s', linestyle='-', linewidth=2)
ax.plot(years, geothermal_energy, color='red', marker='D', linestyle='-', linewidth=2)
ax.plot(years, biomass_energy, color='purple', marker='x', linestyle='-', linewidth=2)
