...
# Point accumulation trends for five different hero regions
regions = ['Norland', 'Sunford', 'Eastoria', 'Westreach', 'Shadowvale']
...
ax1.plot(months, points_shadowvale, marker='v', linestyle='-', color='black', linewidth=2, label='Shadowvale')
