...
hubs = {
    ...
    'Tech Park Station': 'train',
    'City Center Terminal': 'bus',
    'Innovation Metro': 'metro',
}
...
connections = [
    ...
    ('Tech Park Station', 'Innovation Metro'),
    ('City Center Terminal', 'Innovation Metro'),
    ('City Center Terminal', 'North Bus Terminal'),
]
