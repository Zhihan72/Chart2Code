...
new_colors = ['#17becf', '#bcbd22', '#7f7f7f', '#e377c2', '#8c564b', '#1f77b4', '#ff7f0e']
...
axes[1].scatter(professions, satisfaction_scores, color=new_colors, s=150, edgecolors='gray', linewidth=1.5,
                marker='*')
