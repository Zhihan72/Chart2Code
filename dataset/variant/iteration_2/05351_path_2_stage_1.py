...
# Create bars with a single consistent color
bars1 = ax.bar(r1, playstation_sales, color='blue', width=bar_width, edgecolor='grey', label='PlayStation')
bars2 = ax.bar(r2, xbox_sales, color='blue', width=bar_width, edgecolor='grey', label='Xbox')
bars3 = ax.bar(r3, nintendo_sales, color='blue', width=bar_width, edgecolor='grey', label='Nintendo')
