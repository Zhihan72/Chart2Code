...
# Data for renewable energy adoption levels
...
ax.stackplot(years, energy_data, labels=['S-Power', 'W-Energy', 'H-Source', 'Geo', 'Bio'],
             colors=['#ffd700', '#1e90ff', '#32cd32', '#ff7f50', '#9370db'], alpha=0.8)

# Add title and labels
ax.set_title('Waves of Green Energy: Tech Growth (2000-2023)', fontsize=16, fontweight='bold', pad=20)
ax.set_xlabel('Timeline', fontsize=12)
ax.set_ylabel('Growth Level', fontsize=12)

# Add legend and grid
ax.legend(loc='upper left', fontsize=10, title='Green Tech', frameon=False)
...
ax.annotate('Solar Shift', xy=(2010, 100), xytext=(2005, 300),
            arrowprops=dict(facecolor='black', arrowstyle='->', lw=1.5), fontsize=10, color='darkgoldenrod')

ax.annotate('Wind Surge', xy=(2015, 250), xytext=(2010, 800),
...
description = ("Expanding clean energy with tech progress.\n"
               "Growth spurred by policies and innovation.")
