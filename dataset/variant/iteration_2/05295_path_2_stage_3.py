...
# Swapped color assignments for each data group
...
ax.fill_between(years, data_stack[2], data_stack[3], linewidth=2, linestyle='-.', color='lightcoral', alpha=0.5)  # amphibians
ax.fill_between(years, data_stack[3], data_stack[4], linewidth=2, linestyle='-', color='skyblue', alpha=0.4)  # insects
