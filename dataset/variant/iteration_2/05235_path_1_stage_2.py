...
ax.stackplot(years, north_region, south_region, west_region,
             labels=['Western Section', 'Southern Territory', 'Northern Bloc'],
             colors=['#FFD700', '#98FB98', '#FF6347'], alpha=0.8)
...
ax.legend(title="Sections", loc="upper left", fontsize=11, frameon=False)
