...
# Randomly altered temperature data for cities while maintaining the dimensional structure
...
ax.plot(years, city_A_temps, marker='o', linestyle='-', color='#1f77b4', linewidth=2, label='A')
ax.plot(years, city_B_temps, marker='s', linestyle='--', color='#ff7f0e', linewidth=2, label='B')
...
ax.legend(title='City', loc='upper left', fontsize=10)

# Adjusted annotations to reflect the shuffled temperature values
annotations = {
