...
ax.stackplot(years, population_data, colors=['#DC143C', '#483D8B', '#2E8B57'], alpha=0.85)

ax.grid(True, linestyle='-.', alpha=0.7)
ax.set_xlim(years[0], years[-1])
ax.set_xticks(years[::3])
ax.set_xticklabels(years[::3], rotation=30, ha='center')

ax.spines['top'].set_color('none')
ax.spines['right'].set_color('none')

ax.legend(['Dwarfs', 'Humans', 'Orcs'], loc='upper left', frameon=False, title='Races', fontsize='large')
