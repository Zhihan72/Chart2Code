...
labels = ['Biomass', 'Hydropower', 'Wind', 'Solar']
linestyles = ['solid', 'dashed', 'dashdot', 'dotted']

ax.stackplot(years, energy_data, labels=labels, colors=colors, alpha=0.9)
ax.set_title('Renewable Energy Market Share (2000-2020)', fontsize=18, fontweight='bold', ha='center')
ax.set_xlabel('Year', fontsize=14)
ax.set_ylabel('Market Share (%)', fontsize=14)

ax.legend(loc='upper right', fontsize=12, title='Renewable Sources', frameon=False)
