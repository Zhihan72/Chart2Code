...
# Create the plots with 1 row and 2 columns
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(16, 8))

# Line Plot (Moved to ax1)
ax1.plot(years, avg_math_scores, label='Math', color='#D4E6F1', marker='o', linestyle='-')
ax1.plot(years, avg_science_scores, label='Science', color='#F9E79F', marker='s', linestyle='--')
ax1.plot(years, avg_english_scores, label='English', color='#FAD7A0', marker='^', linestyle='-.')
ax1.plot(years, avg_history_scores, label='History', color='#D5DBDB', marker='d', linestyle=':')
ax1.plot(years, avg_art_scores, label='Art', color='#A9DFBF', marker='v', linestyle='-')
