...
# Shuffle the colors for the scatter plot and the regression line
# Originally: scatter plot -> 'purple', regression line -> 'blue'
# Swapped: scatter plot -> 'blue', regression line -> 'purple'

# Scatter plot
ax.scatter(energy_flux, crystal_formation, color='blue', edgecolor='black', s=150, marker='*', alpha=0.7)
...
ax.plot(energy_flux, fit_fn(energy_flux), color='purple', linestyle='--', linewidth=2)
