...
colors = ['#69b3a2', '#ffcccb', '#add8e6', '#ffa500', '#9acd32']

ax.stackplot(years, energy_data, labels=['Solar', 'Wind', 'Hydro', 'Geo', 'Bio'], colors=colors, alpha=0.8)
...
ax.legend(loc='upper left', fontsize=10, title='Energy Types', frameon=False)
ax.grid(linestyle='--', alpha=0.6)

plt.xticks(years, rotation=45)
plt.yticks(np.arange(0, 1301, 100))

ax.annotate('Solar Spike', xy=(2010, 100), xytext=(2005, 300),
            arrowprops=dict(facecolor='black', arrowstyle='->', lw=1.5), fontsize=10, color='darkgoldenrod')

ax.annotate('Wind Growth', xy=(2015, 250), xytext=(2010, 800),
...
description = ("Growth in clean energy technologies is surging globally.\n"
               "Advancements and policies are driving the change.")
