...
nx.draw(G, pos, with_labels=True, node_size=1800, node_color='lightcoral', font_size=9, font_color='navy')
nx.draw_networkx_edges(G, pos, width=2, edge_color='brown', style='dashed')
nx.draw_networkx_edge_labels(G, pos, edge_labels=edge_labels, font_color='orange', font_size=8)
