...
plt.plot(years_smooth, coastal_temp_smooth, label='Seaside Zone', color='darkorange', linewidth=2)
plt.plot(years_smooth, inland_temp_smooth, label='Upland Area', color='purple', linewidth=2)
...
plt.title('Long-Term Variation in Monthly Temp Trends by Location', fontsize=16, fontweight='bold', loc='center')
plt.xlabel('Timeline', fontsize=13)
plt.ylabel('Average Temp (Degrees Celsius)', fontsize=13)
