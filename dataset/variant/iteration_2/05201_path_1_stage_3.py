...
ax[0].plot(days, high_temps, label='Max Temp', color='blue')
ax[0].plot(days, low_temps, label='Min Temp', color='red')
...
ax[1].bar(months, rainfall, color='limegreen', edgecolor='black')
