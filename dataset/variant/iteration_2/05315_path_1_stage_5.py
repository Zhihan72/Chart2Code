...
bars_children = ax.bar(children_index, sorted_preferences, width=bar_width, label='Kids', color='#FF6347', edgecolor='black', linestyle='-.', hatch='/')

ax.set_title("Kids' Fruit Prefs", fontsize=18, fontweight='light', pad=10)
ax.set_xlabel("Fruits", fontsize=13, fontstyle='italic')
ax.set_ylabel("Prefs (%)", fontsize=13, fontstyle='italic')
...
ax.legend(title='Grp', fontsize=12, title_fontsize='13', loc='upper left')
