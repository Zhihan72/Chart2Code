...
ax1.plot(months, productivity_software, 'o-', color='tab:blue')
ax1.plot(months, productivity_hardware, 's--', color='tab:green')
...
ax2 = ax1.twinx()
ax2.plot(months, hours_worked, 'd-.', color='tab:red')
ax2.set_ylim(35, 60)
