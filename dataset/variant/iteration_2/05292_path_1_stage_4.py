...
maintenance_checks = np.array([200, 180, 190, 210, 250, 300, 320, 310, 305, 290, 280, 260])
...
ax2.plot(months, maintenance_checks, color='blue', linestyle='--', marker='o', linewidth=2, label='Maintenance Checks')
