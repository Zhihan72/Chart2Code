...
ax1.bar(x_indices, electronics_sales, bar_width, label='Elec', color='darkorange')
ax1.bar(x_indices + bar_width, furniture_sales, bar_width, label='Furn', color='darkviolet')
ax1.bar(x_indices + 2 * bar_width, clothing_sales, bar_width, label='Cloth', color='deepskyblue')

ax1.set_title("Monthly Sales (2023)", fontsize=14, fontweight='bold')
ax1.set_xlabel("Mon", fontsize=12)
ax1.set_ylabel("Sales (k USD)", fontsize=12)
ax1.set_xticks(x_indices + bar_width)
ax1.set_xticklabels(months)
ax1.legend(title="Prod", fontsize=10)
...
ax2.set_title("Sales Dist (2023)", fontsize=14, fontweight='bold')

ax1.annotate('Max Sales', xy=(11, 75), xytext=(8, 80),
             arrowprops=dict(facecolor='black', arrowstyle='->', alpha=0.7), fontsize=11)
ax1.annotate('Summer', xy=(7, 55), xytext=(4, 60),
             arrowprops=dict(facecolor='black', arrowstyle='->', alpha=0.7), fontsize=11)
