...
# New fictional data for Geothermal Energy
geothermal_energy = [1.2, 1.5, 1.8, 2.2, 2.7, 3.0, 3.6, 4.1, 4.8, 5.5, 6.2, 7.0, 7.8, 8.5, 9.3, 10.0, 11.0, 12.5, 13.8, 15.0, 16.5]
...
# Plot the new Geothermal data with distinct representation
ax.plot(years, geothermal_energy, color='orange', marker='o', linestyle='-', linewidth=2, label='Geothermal Energy')
