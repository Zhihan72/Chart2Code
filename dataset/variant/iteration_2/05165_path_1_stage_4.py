...
# Altered Data
north_rivers = [90, 85, 83, 87, 82, 95, 85, 89, 90, 88]  # Random shuffle within the array
east_rivers = [80, 75, 78, 72, 74, 77, 79, 78, 76, 75]  # Random shuffle within the array
south_rivers = [85, 86, 80, 82, 88, 83, 84, 85, 88, 87]  # Random shuffle within the array
west_rivers = [66, 68, 65, 71, 69, 67, 64, 70, 62, 72]  # Random shuffle within the array
central_rivers = [92, 90, 89, 94, 93, 88, 91, 90, 95, 92] # Random shuffle within the array
