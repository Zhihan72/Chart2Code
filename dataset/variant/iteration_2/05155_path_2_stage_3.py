...
countries = ["USA", "China", "India", "Germany", "Brazil"]  # Switch Germany and India
...
india_data = {"Solar": [12, 8, 20, 16, 24], "Wind": [9, 6, 15, 12, 18], "Hydro": [5, 4, 6, 5, 7]}  # Was originally germany_data
germany_data = {"Solar": [10, 5, 20, 15, 25], "Wind": [15, 10, 30, 20, 25], "Hydro": [3, 2, 4, 3, 4]}  # Was originally india_data
brazil_data = {"Solar": [6, 3, 12, 9, 15], "Wind": [5, 4, 7, 6, 8], "Hydro": [6, 5, 8, 7, 9]}

all_data = [usa_data, china_data, india_data, germany_data, brazil_data]  # Rearranged order to match countries
