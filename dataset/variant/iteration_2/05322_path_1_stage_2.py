...
axes[1].set_title('Rice Yields in 2022', fontsize=14, fontweight='bold')
...
# Plot Corn Yields
box_corn = axes[2].boxplot(data_corn, vert=False, patch_artist=True, labels=regions, notch=True)
for patch in box_corn['boxes']:
    patch.set_facecolor('#99FF99')
axes[2].set_xlabel('Yield (tons per hectare)', fontsize=12)
