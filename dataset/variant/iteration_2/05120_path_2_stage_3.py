...
ax[0].barh(sorted_age_groups, sorted_social_media, color='navy', linestyle='solid')
ax[1].barh(sorted_age_groups, sorted_gaming, color='firebrick', linestyle='dotted')
ax[2].barh(sorted_age_groups, sorted_productivity, color='darkgreen', linestyle='dashed')
ax[3].barh(sorted_age_groups, sorted_entertainment, color='orange', linestyle='dashdot')
