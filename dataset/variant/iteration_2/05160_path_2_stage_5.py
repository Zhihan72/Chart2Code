...
decades = ['1990s', '2010s', '2020s']
solar_production = np.array([10, 500, 3000])
...
axs[0].plot(decades, solar_production, marker='o', linestyle='-', linewidth=3, color='blue')
...
axs[1].plot(decades, growth_rates, marker='o', linestyle='-', linewidth=3, color='orange')
