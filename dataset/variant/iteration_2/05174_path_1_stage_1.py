...
# Define a list of colors to shuffle manually
colors = ['blue', 'green', 'red']

# Line plots for each generation with shuffled colors
axs[0, 0].plot(years, recycling_boomers, label='Recycling', marker='o', color=colors[1])
axs[0, 0].plot(years, volunteering_boomers, label='Volunteering', marker='o', color=colors[2])
axs[0, 0].plot(years, fitness_boomers, label='Fitness Activities', marker='o', color=colors[0])
...
axs[0, 1].plot(years, recycling_genx, label='Recycling', marker='o', color=colors[2])
axs[0, 1].plot(years, volunteering_genx, label='Volunteering', marker='o', color=colors[0])
axs[0, 1].plot(years, fitness_genx, label='Fitness Activities', marker='o', color=colors[1])
...
axs[1, 0].plot(years, recycling_millennials, label='Recycling', marker='o', color=colors[0])
axs[1, 0].plot(years, volunteering_millennials, label='Volunteering', marker='o', color=colors[1])
axs[1, 0].plot(years, fitness_millennials, label='Fitness Activities', marker='o', color=colors[2])
