...
season_labels = ['Spring', 'Summer', 'Autumn', 'Winter', 'Monsoon', 'Dry']
...
ax.scatter(range(1, 7), median_values, color='black', marker='*', s=150, zorder=3, label='Median Score')
...
ax.text(1, 9.5, 'Spring\nHighest Scores', fontsize=10, color='purple', ha='center')
ax.text(2, 7.5, 'Summer\nLowest Scores', fontsize=10, color='red', ha='center')
ax.text(3, 9.5, 'Autumn\nExcellent Flavors', fontsize=10, color='olive', ha='center')
ax.text(4, 8.3, 'Winter\nAverage Scores', fontsize=10, color='teal', ha='center')
ax.text(5, 8.5, 'Monsoon\nSmooth Tastes', fontsize=10, color='blue', ha='center')
ax.text(6, 7, 'Dry\nMild Flavors', fontsize=10, color='brown', ha='center')
