...
# Manually altered data series for each educational tool
books = [21, 18, 17, 20, 16, 15, 15, 13, 13, 9, 7]  # Randomly shuffled within the group
online_courses = [3, 5, 2, 4, 8, 7, 9, 14, 10, 16, 18]  # Randomly shuffled within the group
educational_apps = [2, 1, 3, 6, 7, 11, 5, 13, 15, 20, 17]  # Randomly shuffled within the group
videos = [6, 5, 7, 9, 8, 11, 10, 12, 13, 15, 17]  # Randomly shuffled within the group
tutoring = [9, 10, 8, 8, 9, 7, 6, 7, 5, 4, 6]  # Randomly shuffled within the group
