...
ax.bar(r1, store_a_sales, color='#FF5733', width=bar_width)
ax.bar(r2, store_b_sales, color='#33FF57', width=bar_width)
ax.bar(r3, store_c_sales, color='#3357FF', width=bar_width)
ax.bar(r4, store_d_sales, color='#FF33A6', width=bar_width)
