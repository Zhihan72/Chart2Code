...
# Added made-up data for PHP and Swift
php_interest = [25, 28, 30, 28, 25, 23, 20, 18, 17, 16, 15]
swift_interest = [5, 7, 10, 12, 15, 20, 23, 27, 30, 32, 35]

fig, ax = plt.subplots(figsize=(12, 7))

ax.plot(years, python_interest, marker='p', linestyle='--', color='green', linewidth=2.5)
ax.plot(years, java_interest, marker='*', linestyle=':', color='blue', linewidth=2)
ax.plot(years, javascript_interest, marker='o', linestyle='-', color='purple', linewidth=2.5)
ax.plot(years, csharp_interest, marker='s', linestyle='-.', color='red', linewidth=2)
ax.plot(years, ruby_interest, marker='d', linestyle='-', color='orange', linewidth=1.5)

# Plotting additional data series for PHP and Swift
ax.plot(years, php_interest, marker='v', linestyle='--', color='brown', linewidth=2)
ax.plot(years, swift_interest, marker='h', linestyle='-', color='pink', linewidth=2)
