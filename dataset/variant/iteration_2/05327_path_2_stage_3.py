...
scores_data = {
    ...
    'Statistics': [84, 86, 88, 89, 87, 85, 86, 90, 88, 87, 85, 89, 86, 84, 86, 87, 88]
}
...
new_colors = ['skyblue', 'khaki', 'peachpuff', 'lightgrey', 'thistle', 'lightgreen']
...
stats_median = [84, 86, 85, 87, 88, 86]

median_scores_over_weeks = [math_median, bio_median, cs_median, chem_median, phys_median, stats_median]
