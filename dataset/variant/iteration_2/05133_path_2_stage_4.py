...
ax.bar(br1, sorted_labels[1].astype(int), color='brown', width=bar_width, linestyle='dashed', edgecolor='black', label='Drone Dash', hatch='/')
ax.bar(br2, sorted_labels[2].astype(int), color='darkblue', width=bar_width, linestyle='dotted', edgecolor='black', label='Robotics Rumble', hatch='\\')
ax.bar(br3, sorted_labels[3].astype(int), color='lime', width=bar_width, linestyle='dashdot', edgecolor='black', label='A.I. Challenge', hatch='o')
ax.bar(br4, sorted_labels[4].astype(int), color='violet', width=bar_width, linestyle='solid', edgecolor='black', label='Virtual Reality Quest', hatch='*')
