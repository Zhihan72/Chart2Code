...
ax.barh(r1, playstation_sales, color='purple', height=bar_width, edgecolor='orange', linestyle='-.')
ax.barh(r2, xbox_sales, color='orange', height=bar_width, edgecolor='purple', linestyle=':')
ax.barh(r3, nintendo_sales, color='cyan', height=bar_width, edgecolor='black', linestyle='--')
