...
# Define hypothetical data for renewable energy adoption
renewable_energy_adoption = [4.0, 4.2, 4.5, 4.7, 5.0, 5.4, 5.9, 6.5, 7.1, 7.8, 8.6, 9.5, 10.5, 11.6, 12.8, 14.1, 15.5, 17.0, 18.6, 20.3, 22.1] # In percentage

# Initialize the plot with multiple subplots
fig, (ax1, ax2, ax3) = plt.subplots(3, 1, figsize=(14, 15), dpi=100)

# Plot the CO2 levels and global temperature on the first subplot
