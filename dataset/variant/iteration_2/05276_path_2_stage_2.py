...
ax1.plot(years, hiking_west, marker='o', color='green', linestyle='-', linewidth=2,
         label='Hiking W')
ax1.plot(years, cycling_west, marker='s', color='blue', linestyle='-', linewidth=2,
         label='Cycling W')
ax1.plot(years, running_west, marker='^', color='red', linestyle='-', linewidth=2,
         label='Running W')
...
ax2.plot(years, hiking_east, marker='o', color='green', linestyle='-', linewidth=2,
         label='Hiking E')
ax2.plot(years, cycling_east, marker='s', color='blue', linestyle='-', linewidth=2,
         label='Cycling E')
ax2.plot(years, running_east, marker='^', color='red', linestyle='-', linewidth=2,
         label='Running E')
