...
# Remove data for period 1960-1970
decades = np.delete(decades, 4)
temp_changes = np.delete(temp_changes, 4)

plt.figure(figsize=(14, 8))

plt.plot(decades, temp_changes, marker='o', linestyle='-', color='#FF5733', linewidth=2)
