...
node_color_map = ['skyblue' if 'o' in planet.lower() else 'lightcoral' for planet in G.nodes]
...
legend_elements = [
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='skyblue', markersize=10, label='Contains "o" in Name'),
    plt.Line2D([0], [0], marker='o', color='w', markerfacecolor='lightcoral', markersize=10, label='No "o" in Name')
]
