...
ax.plot(months, lunar_rabbits_population, marker='^', linestyle='-.', color='peru', linewidth=2, markersize=8, label='Lunar Rabbits')
ax.plot(months, sun_chameleons_population, marker='D', linestyle=':', color='darkslategray', linewidth=2, markersize=8, label='Sun Chameleons')

# Annotate peak populations with modified text positions
