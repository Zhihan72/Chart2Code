...
weekly_birth_rates_region_A = np.array([
    [30, 70, 15, 50, 150],  # Week 1
    [35, 80, 20, 55, 160],  # Week 2
    [40, 75, 18, 45, 140],  # Week 3
    [45, 75, 27, 50, 150]   # Week 4
])

weekly_birth_rates_region_B = np.array([
    [40, 60, 30, 35, 185],  # Week 1
    [45, 65, 25, 40, 190],  # Week 2
    [50, 60, 35, 30, 185],  # Week 3
    [45, 65, 20, 45, 190]   # Week 4
])
