...
# New colors for the bar chart
new_colors = ['#e6194b', '#3cb44b', '#ffe119', '#0082c8', '#f58231']

for i in range(len(age_groups)):
    axes[0].bar(indices + i * bar_width, data[i], bar_width, label=age_groups[i], color=new_colors[i])
...
# Using a different colormap for the pie chart
colors_pie = plt.cm.plasma(np.arange(5)/5.)
