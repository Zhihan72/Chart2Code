...
age_groups = ['30-49', '65+', '18-29', '50-64']
...
ax.set_xlabel('Recreational Activities', fontsize=12)
ax.set_ylabel('Average Spending Per Week ($)', fontsize=12)
ax.set_title('Weekend Expense on Fun Activities by Age Brackets\n(Year 2023)', fontsize=16, fontweight='bold', pad=20)
ax.set_xticks(indices + bar_width * 1.5)
ax.set_xticklabels(activities)
ax.legend(title='Ages', fontsize='small', loc='upper left')
