...
# Shuffled custom colors for each box
colors = ['#FFA07A', '#98FB98', '#87CEEB']  # Colors manually shuffled
...
# Data for category spending for Household A
...
category_colors = ['#4682B4', '#FF6347', '#ADFF2F', '#FFD700']  # Colors manually shuffled
boxes = ax2.patches
