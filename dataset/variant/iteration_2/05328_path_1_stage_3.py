...
ax1.plot(years, renewable_energy, color='red', linewidth=2, marker='s', linestyle='-', markersize=6)
ax1.grid(True, linestyle='--', alpha=0.5)

ax2.plot(years, co2_emissions, color='green', linewidth=2, marker='o', linestyle='-', markersize=6)
