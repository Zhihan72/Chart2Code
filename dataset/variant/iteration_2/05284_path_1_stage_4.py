...
rects1 = ax.bar(x_positions - bar_width/2, weekday_hours, width=bar_width, label='Weekday', color='skyblue', edgecolor='darkred', hatch='x')
rects2 = ax.bar(x_positions + bar_width/2, weekend_hours, width=bar_width, label='Weekend', color='salmon', edgecolor='darkred', hatch='/')
