...
# Single color for all bird species
single_color = '#87cefa'  # Light sky blue for consistent color

# Create the figure and axis
fig, ax = plt.subplots(figsize=(14, 9))

# Plot the stacked area chart with a single consistent color
ax.stackplot(years, data, labels=['Species A', 'Species B', 'Species C', 'Species D', 'Species E'],
             colors=[single_color] * len(data), alpha=0.7)
