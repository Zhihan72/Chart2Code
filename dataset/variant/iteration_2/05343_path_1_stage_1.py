...
golden_skull_fleet = np.array([200, 500, 900, 1500, 1600])  # New series
...
plt.plot(decades, golden_skull_fleet, marker='x', linestyle='-', linewidth=2, color='gold', label='Golden Skull Fleet')  # New plot
