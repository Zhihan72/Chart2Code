...
bars_fb = ax.barh(y_positions - bar_height, facebook_data, bar_height, label='Facebook', color='mediumseagreen')
bars_tw = ax.barh(y_positions, twitter_data, bar_height, label='Twitter', color='indianred')
bars_ig = ax.barh(y_positions + bar_height, instagram_data, bar_height, label='Instagram', color='cornflowerblue')
