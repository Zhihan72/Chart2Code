...
single_color = '#4682B4'  # A consistent color used for all bars

fig, ax = plt.subplots(figsize=(12, 8))

ax.bar(years, wheat_yield, label='Wheat', hatch='/', color=single_color, edgecolor='black')
ax.bar(years, corn_yield, bottom=wheat_yield, label='Corn', hatch='\\', color=single_color, edgecolor='black')
ax.bar(years, barley_yield, bottom=np.array(wheat_yield) + np.array(corn_yield), label='Barley', hatch='x', color=single_color, edgecolor='black')
ax.bar(years, soybean_yield, bottom=np.array(wheat_yield) + np.array(corn_yield) + np.array(barley_yield), label='Soybeans', hatch='o', color=single_color, edgecolor='black')
