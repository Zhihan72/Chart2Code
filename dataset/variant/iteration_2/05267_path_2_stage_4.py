...
# Increased the tree species and data points
tree_species = ['Elm', 'Ash', 'Cedar', 'Fir', 'Sycamore', 'Aspen', 'Spruce', 'Pine', 'Birch', 'Oak']
sunlight_hours = np.array([4, 6, 5, 8, 2, 9, 3, 7, 3.5, 8.5])
moisture_levels = np.array([800, 600, 700, 500, 1200, 400, 1300, 450, 1150, 550])
prevalence = np.array([250, 320, 180, 220, 270, 200, 300, 230, 310, 210])
