...
plt.title("Magical Transport Network:\nConnections Across Regions", fontsize=16, fontweight='bold')
plt.axis('off')
plt.tight_layout()

plt.legend([plt.Line2D([0], [0], color=node_color, lw=4)], ["Towns"], title="Communities", loc='upper right', bbox_to_anchor=(1.1, 1))
