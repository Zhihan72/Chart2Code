...
# Shuffle colors
axs[0].plot(years, usa_ev_growth, color='green', linestyle='-', marker='o', linewidth=2)  # Changed to 'green'
axs[0].plot(years, china_ev_growth, color='blue', linestyle='-', marker='s', linewidth=2)  # Changed to 'blue'
axs[0].plot(years, norway_ev_growth, color='red', linestyle='-', marker='^', linewidth=2)  # Changed to 'red'
...
# Shuffle colors for relative contributions
...
axs[1].plot(years, usa_contribution, color='green', linestyle='--', marker='o', linewidth=2)  # Changed to 'green'
axs[1].plot(years, china_contribution, color='blue', linestyle='--', marker='s', linewidth=2)  # Changed to 'blue'
axs[1].plot(years, norway_contribution, color='red', linestyle='--', marker='^', linewidth=2)  # Changed to 'red'
