...
ax1.bar(sorted_decades_fiction_books - bar_width, sorted_fiction_books, width=bar_width, color=consistent_color, alpha=0.7)
ax1.bar(sorted_decades_non_fiction_books, sorted_non_fiction_books, width=bar_width, color=consistent_color, alpha=0.7)

ax2 = ax1.twinx()
ax2.bar(sorted_decades_fiction_books - bar_width, sorted_fiction_revenue, width=bar_width, color=consistent_color, alpha=0.3)
ax2.bar(sorted_decades_non_fiction_books, sorted_non_fiction_revenue, width=bar_width, color=consistent_color, alpha=0.3)
