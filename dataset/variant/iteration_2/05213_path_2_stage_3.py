...
ax1.plot(years, ev_sales, color='purple', marker='x', linestyle='-', linewidth=2, label='EV Sales (millions)')
...
ax1.set_ylabel("EV Sales (millions)", fontsize=14, color='purple')
ax1.tick_params(axis='y', labelcolor='purple')

ax2 = ax1.twinx()
ax2.plot(years, charging_stations, color='darkcyan', marker='d', linestyle='-', linewidth=2, label='Charging Stations (thousands)')
ax2.set_ylabel("Charging Stations (thousands)", fontsize=14, color='darkcyan')
ax2.tick_params(axis='y', labelcolor='darkcyan')

ax3 = ax1.twinx()
ax3.spines['right'].set_position(('outward', 60))
ax3.plot(years, renewable_growth, color='gold', marker='p', linestyle=':', linewidth=2, label='Renewable Energy (%)')
ax3.set_ylabel("Renewable Energy (%)", fontsize=14, color='gold')
