...
# Changed colors: original '#FF5733', '#33FFB5', '#3375FF'
ax.plot(months, index_A, marker='D', linestyle='--', linewidth=2.5, color='#3375FF', label='Index A')
ax.plot(months, index_B, marker='*', linestyle=':', linewidth=2.5, color='#FF5733', label='Index B')
ax.plot(months, index_C, marker='x', linestyle='-.', linewidth=2.5, color='#33FFB5', label='Index C')
