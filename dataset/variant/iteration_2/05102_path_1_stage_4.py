...
ax1.stackplot(years, hydropower, solar, wind, fossil_fuels, colors=new_colors, alpha=0.85)
...
ax2 = ax1.twinx()
ax2.plot(years, nuclear, color='purple', marker='o', linestyle='--', linewidth=2.5)
