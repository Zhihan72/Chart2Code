...
# Data for solar energy generation (in gigawatts) for different regions
...
# Plotting each region's data with altered stylistic elements
plt.plot(years, asia, marker='x', linestyle='-.', color='orange', label='Asia', linewidth=2)
plt.plot(years, europe, marker='d', linestyle='-', color='blue', label='Europe', linewidth=2)
plt.plot(years, north_america, marker='v', linestyle=':', color='green', label='North America', linewidth=2)
plt.plot(years, oceania, marker='h', linestyle='--', color='purple', label='Oceania', linewidth=2)
