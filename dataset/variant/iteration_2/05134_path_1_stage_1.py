...
# Applying the same color 'forestgreen' to both scatter plot and smooth line
plt.scatter(green_space_area, health_index, color='forestgreen', edgecolor='black', s=100, label='Data Points')
plt.plot(x_smooth, y_smooth, color='forestgreen', linestyle='-', linewidth=2, label='Smooth Fit')
