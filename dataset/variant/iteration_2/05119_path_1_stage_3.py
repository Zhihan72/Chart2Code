...
# Plot the stacked bar chart with shuffled colors
ax.bar(years, ai_exhibitors, color='plum', alpha=0.8)
ax.bar(years, robotics_exhibitors, bottom=ai_exhibitors, color='salmon', alpha=0.8)
ax.bar(years, quantum_exhibitors, bottom=robotics_cumulative, color='skyblue', alpha=0.8)
ax.bar(years, ar_exhibitors, bottom=quantum_cumulative, color='lightgreen', alpha=0.8)
