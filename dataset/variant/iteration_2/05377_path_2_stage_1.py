...
# Plot lines for each sports league with new colors
ax.plot(years, esports_revenue, marker='o', linestyle='-', color='purple', linewidth=2, label='eSports')
ax.plot(years, robot_combat_revenue, marker='^', linestyle='-', color='orange', linewidth=2, label='Robot Combat')
ax.plot(years, drone_racing_revenue, marker='s', linestyle='-', color='cyan', linewidth=2, label='Drone Racing')
