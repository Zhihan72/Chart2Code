...
# Changed the textual elements as per the direction
ax.plot(years, solar_energy, label='Sunny', color='orange', linewidth=2.5, linestyle='-', marker='>', markersize=8)
ax.plot(years, hydro_energy, label='Water Power', color='green', linewidth=2, linestyle='-.', marker='D', markersize=7)

# Randomly altered the title and labels
...
for year, s, h in zip(years, solar_energy, hydro_energy):
    # Annotations with unchanged data values
