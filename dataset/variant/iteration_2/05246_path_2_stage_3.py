...
ax.barh(y_positions, product_B_sales, height=bar_height, color='green', edgecolor='black')
ax.barh(y_positions + bar_height, product_C_sales, height=bar_height, color='red', edgecolor='black')
