...
ax1 = axes[0]
ax1.plot(years_actual, product_a_sales, marker='o', linestyle='-', color='#8b0000', linewidth=2, label='Gadget X')
ax1.plot(years_actual, product_b_sales, marker='s', linestyle='--', color='#00008b', linewidth=2, label='Device Y')
ax1.plot(years_actual, product_c_sales, marker='^', linestyle='-.', color='#006400', linewidth=2, label='Tool Z')
ax1.plot(years_actual, product_d_sales, marker='x', linestyle=':', color='#800080', linewidth=2, label='Instrument Q')
...
ax1.legend(title='Items', loc='upper left', fontsize=10)
...
ax2 = axes[1]
ax2.plot(years_forecast, product_a_forecast, marker='o', linestyle='-', color='#8b0000', linewidth=2, label='Gadget X')
ax2.plot(years_forecast, product_b_forecast, marker='s', linestyle='--', color='#00008b', linewidth=2, label='Device Y')
ax2.plot(years_forecast, product_c_forecast, marker='^', linestyle='-.', color='#006400', linewidth=2, label='Tool Z')
ax2.plot(years_forecast, product_d_forecast, marker='x', linestyle=':', color='#800080', linewidth=2, label='Instrument Q')
...
ax2.legend(title='Items', loc='upper left', fontsize=10)
