...
# Creating extended artificial data with additional groups
age_groups = ['Children', 'Teens', 'Adults', 'Seniors', 'Young Adults', 'Elders']
daily_fluid_intake_liters = {
    ...
    'Young Adults': [2.6, 2.9, 2.5, 2.7, 2.8, 2.9, 3.0, 3.1, 2.9, 3.3, 3.2],
    'Elders': [1.7, 1.8, 1.5, 1.6, 1.5, 1.6, 1.7, 1.5, 1.6, 1.5, 1.6]
}
hydration_levels = {
    ...
    'Young Adults': [75, 77, 76, 78, 79, 80, 82, 85, 81, 87, 86],
    'Elders': [60, 63, 62, 65, 64, 63, 66, 64, 63, 62, 64]
}
