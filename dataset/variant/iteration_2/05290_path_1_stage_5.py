...
# Plot only USA and China data
axs[0].plot(years, usa_ev_growth, color='green', linestyle='-', marker='o', linewidth=2)
axs[0].plot(years, china_ev_growth, color='blue', linestyle='-', marker='s', linewidth=2)
...
# Calculate contributions relative to remaining countries
usa_contribution = usa_ev_growth / (usa_ev_growth + china_ev_growth)
china_contribution = china_ev_growth / (usa_ev_growth + china_ev_growth)

axs[1].plot(years, usa_contribution, color='green', linestyle='--', marker='o', linewidth=2)
axs[1].plot(years, china_contribution, color='blue', linestyle='--', marker='s', linewidth=2)
