...
# New color set for the lines
colors = ['#FF5733', '#FFC300', '#DAF7A6', '#581845', '#900C3F']

# Create the plot
plt.figure(figsize=(14, 8))

# Plot lines for each country's CO2 emission reductions with new colors
for i, (country, color) in enumerate(zip(countries, colors)):
    plt.plot(years, co2_reductions[i], marker='o', label=country, color=color)
