...
# Main Pie chart with a consistent color and no stylistic elements
wedges, _, autotexts = ax[0].pie(
    festival_distribution,
    colors=[single_color] * len(festival_distribution),
    explode=explode,
    autopct='%1.1f%%',
    startangle=140,
    pctdistance=0.85,
...
# Bar chart for Participants with a consistent color and no stylistic elements
