...
festival_names = ['Music Gala', 'Harvest Celebration', 'Gastronomy Highlights']
...
ax[0].set_title("Top Festival Attendees", fontsize=16, fontweight='bold', pad=20)
ax[0].set_ylabel("Participants Count")
...
ax[1].set_title("Festival Share in Regions", fontsize=16, fontweight='bold', pad=20)

fig.suptitle("Festivals Overview in Avecondale", fontsize=20, fontweight='bold',)
