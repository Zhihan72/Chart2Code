...
# Revenue Plot
ax[0].plot(years, alpha_revenue, color='#1f77b4', marker='o')
ax[0].plot(years, beta_revenue, color='#ff7f0e', marker='s')
ax[0].plot(years, gamma_revenue, color='#2ca02c', marker='^')
...
ax[1].plot(years, alpha_rd, color='#1f77b4', marker='o')
ax[1].plot(years, beta_rd, color='#ff7f0e', marker='s')
ax[1].plot(years, gamma_rd, color='#2ca02c', marker='^')
...
ax[2].plot(years, alpha_employees, color='#1f77b4', marker='o')
ax[2].plot(years, beta_employees, color='#ff7f0e', marker='s')
ax[2].plot(years, gamma_employees, color='#2ca02c', marker='^')
