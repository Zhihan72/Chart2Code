...
# Randomly altered values within original data structure constraints
...
axs[1, 1].plot(years, np.array(recycling_boomers) + np.array(recycling_genx) + np.array(recycling_millennials), marker='o')
axs[1, 1].plot(years, np.array(volunteering_boomers) + np.array(volunteering_genx) + np.array(volunteering_millennials), marker='o')
axs[1, 1].plot(years, np.array(fitness_boomers) + np.array(fitness_genx) + np.array(fitness_millennials), marker='o')
