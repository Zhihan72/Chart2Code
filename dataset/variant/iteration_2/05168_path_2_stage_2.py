...
ax.plot(days, new_york_temp, marker='o', linestyle='-', color=consistent_color, label='NY')
ax.plot(days, san_francisco_temp, marker='s', linestyle='--', color=consistent_color, label='SF')
ax.plot(days, miami_temp, marker='^', linestyle=':', color=consistent_color, label='MIA')
