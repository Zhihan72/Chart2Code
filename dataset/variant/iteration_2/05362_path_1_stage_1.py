...
ax.plot(years, neo_tokyo_consumption, marker='D', linestyle='--', color='purple', linewidth=1.5, markersize=6, label='Neo-Tokyo')
ax.plot(years, metropolis_consumption, marker='x', linestyle='-.', color='orange', linewidth=1.5, markersize=6, label='Metropolis')
ax.plot(years, omega_city_consumption, marker='p', linestyle=':', color='cyan', linewidth=1.5, markersize=6, label='Omega City')
