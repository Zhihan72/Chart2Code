...
disciplines = ['CS', 'Bus', 'Sci', 'Arts', 'Hum']
...
ax.stackplot(years, enrollment_data, labels=disciplines, colors=['#1f77b4', '#ff7f0e', '#2ca02c', '#d62728', '#9467bd'], alpha=0.6)

ax.plot(years, total_enrollments, label='Total', color='purple', linewidth=3, marker='s', linestyle='--')

ax.set_title('Online Education Enrollment (2015-2025)', fontsize=17, fontweight='bold', pad=15)
ax.set_xlabel('Year', fontsize=13)
ax.set_ylabel('Enrollments (k)', fontsize=13)

ax.spines['top'].set_visible(False)
ax.spines['right'].set_visible(False)

ax.legend(loc='lower right', title='Disc.', fontsize=11)
