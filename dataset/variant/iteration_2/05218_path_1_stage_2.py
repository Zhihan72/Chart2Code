...
bars1 = ax1.barh(y - bar_width, fuel_efficiency_2020, bar_width, color='skyblue')
bars2 = ax1.barh(y, fuel_efficiency_2021, bar_width, color='lightgreen')
bars3 = ax1.barh(y + bar_width, fuel_efficiency_2022, bar_width, color='salmon')
