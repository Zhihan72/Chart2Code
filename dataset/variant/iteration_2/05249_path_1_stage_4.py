...
types_of_fruits = ['Grapes', 'Peaches', 'Kiwi', 'Pineapples', 'Plums', 'Mangoes', 'Oranges']
...
mangoes = [30, 35, 45, 55, 65, 75, 85, 90, 100, 110, 120]
oranges = [25, 30, 35, 45, 55, 65, 70, 75, 85, 90, 100]
export_data = [np.array(apples), np.array(bananas), np.array(cherries), np.array(dragonfruits), 
               np.array(elderberries), np.array(mangoes), np.array(oranges)]

fig, ax = plt.subplots(figsize=(12, 8))

line_styles = ['-', '--', '-.', ':', '-', '--', '-.']
markers = ['s', '^', 'X', 'D', 'P', 'o', 'v']
colors = ['orange', 'blue', 'green', 'purple', 'red', 'magenta', 'cyan']
