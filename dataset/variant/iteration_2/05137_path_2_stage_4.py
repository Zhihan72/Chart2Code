...
nuclear = np.array([50, 55, 60, 65, 70, 76, 82, 89, 96, 104, 112, 121, 130, 140, 150, 161, 172, 184, 196, 209, 222])

plt.figure(figsize=(20, 12))
plt.stackplot(years, solar, wind, hydro, biomass, geothermal, nuclear, 
              colors=['#2196f3', '#f44336', '#4caf50', '#ffeb3b', '#9c27b0', '#ff9800'], alpha=0.8)
...
ax.plot(years[:-1], solar_growth_rate, marker='o', linestyle='-', color='#2196f3', linewidth=2.5)
