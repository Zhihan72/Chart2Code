...
colors = ['#8B4513', '#556B2F', '#DAA520', '#4682B4']
markers = ['^', 'd', 'o', 's']
...
for data, name, color, marker in zip(woodlands_data, woodland_names, colors, markers):
    ax1.plot(years, data, label=name, color=color, marker=marker, linestyle='-.', linewidth=2, alpha=0.8)
...
ax1.legend(title='Woodlands', title_fontsize='13', loc='best', frameon=True, shadow=True)
