...
# Using the same color 'green' for both CO2 levels and global temperatures
ax1.plot(years, co2_levels, color='green', linestyle='-', linewidth=2, marker='o')
ax1.plot(years, global_temps, color='green', linestyle='--', linewidth=2, marker='s')

ax1.set_title('CO2 & Temp Trends (2000-2020)', fontsize=16, weight='bold')
ax1.set_xlabel('Year', fontsize=14)
ax1.set_ylabel('CO2 (ppm)', fontsize=14, color='green')
ax1.tick_params(axis='y', labelcolor='green')

ax1_secondary = ax1.twinx()
ax1_secondary.set_ylabel('Temp (°C)', fontsize=14, color='green')
