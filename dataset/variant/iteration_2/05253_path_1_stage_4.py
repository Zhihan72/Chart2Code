...
# Applying new colors to the energy sources
ax.plot(years, solar_energy, color='cyan', marker='o', linestyle='-', linewidth=2)
ax.plot(years, wind_energy, color='teal', marker='^', linestyle='-', linewidth=2)
ax.plot(years, hydro_energy, color='lime', marker='s', linestyle='-', linewidth=2)
ax.plot(years, geothermal_energy, color='magenta', marker='D', linestyle='-', linewidth=2)
ax.plot(years, biomass_energy, color='coral', marker='x', linestyle='-', linewidth=2)
