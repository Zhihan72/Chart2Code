...
ax.plot(weeks, mountain_park_visitors, marker='^', color='green', label='Mountain Park', linewidth=2)

ax.set_title('Public Park Weekly Visitor Trends Over a Year', fontsize=18, fontweight='bold', pad=20)
...
for i in range(0, len(weeks), 6):
    ...
    ax.annotate(f'{mountain_park_visitors[i]}k', (weeks[i], mountain_park_visitors[i]), textcoords="offset points", xytext=(10, 10), ha='center', fontsize=9, color='green')
