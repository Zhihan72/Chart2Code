...
# Updated sources and energy_data for removal of 'Wind'
sources = ['Coal', 'NatGas', 'Nuclr', 'Hydro', 'Solar']
countries = ['USA', 'China', 'Ger', 'Ind', 'Braz']

energy_data = [
    [1000, 1200, 800, 500, 300],
    [1500, 2000, 1000, 800, 600],
    [300, 450, 900, 700, 500],
    [1400, 1200, 200, 600, 400],
    [200, 300, 100, 900, 800]
]
...
bar_width = 0.7
# Adjusted colors list to match the reduced number of sources
