...
ax.plot(hours, cpu_usage, label='CPU Usage', color='purple', marker='o', linestyle='-', linewidth=2.5)
ax.plot(hours, ram_usage, label='RAM Usage', color='orange', marker='s', linestyle='--', linewidth=2.5)
ax.plot(hours, disk_usage, label='Disk Usage', color='brown', marker='^', linestyle='-.', linewidth=2.5)
...
for usage, label, color in zip([cpu_usage, ram_usage, disk_usage], ['CPU', 'RAM', 'Disk'], ['purple', 'orange', 'brown']):
