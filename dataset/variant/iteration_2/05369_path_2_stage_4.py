...
plt.plot(years, asia, marker='o', linestyle='-', color='red', linewidth=2)
plt.plot(years, europe, marker='s', linestyle='--', color='cyan', linewidth=2)
plt.plot(years, north_america, marker='^', linestyle='-.', color='brown', linewidth=2)
plt.plot(years, oceania, marker='D', linestyle=':', color='magenta', linewidth=2)
