...
ax1 = axes[0]
ax1.plot(years_actual, product_a_sales, marker='o', linestyle='-', color='#ff6347', linewidth=2)
ax1.plot(years_actual, product_b_sales, marker='s', linestyle='--', color='#4682b4', linewidth=2)
ax1.plot(years_actual, product_c_sales, marker='^', linestyle='-.', color='#2e8b57', linewidth=2)
...
ax2 = axes[1]
ax2.plot(years_forecast, product_a_forecast, marker='o', linestyle='-', color='#ff6347', linewidth=2)
ax2.plot(years_forecast, product_b_forecast, marker='s', linestyle='--', color='#4682b4', linewidth=2)
ax2.plot(years_forecast, product_c_forecast, marker='^', linestyle='-.', color='#2e8b57', linewidth=2)
