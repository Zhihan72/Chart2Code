...
# Changed the color from '#8A2BE2' to a new color '#FF6347'
bars_children = ax.bar(children_index, children_preferences, width=bar_width, label='Children', color='#FF6347', edgecolor='black', linestyle='-.', hatch='/')
