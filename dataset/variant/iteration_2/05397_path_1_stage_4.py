...
ax.stackplot(years, burnt_area_data, labels=['Evergreen Forest', 'Broadleaf Forest', 'Hybrid Forest', 'Equatorial Forest'], 
...
ax.set_title("Wildfire Effects on Various Forest Categories\n(Burn Area in Thousand Ha)", fontsize=16, fontweight='bold', pad=20)
ax.set_xlabel("Time Period", fontsize=12)
ax.set_ylabel("Burn Area (K Ha)", fontsize=12)
...
for year, value, label, color in zip(significant_years, significant_values, ['Evergreen Forest', 'Broadleaf Forest', 'Hybrid Forest', 'Equatorial Forest'], colors):
...
ax.legend(custom_legend, ['Evergreen Forest', 'Broadleaf Forest', 'Hybrid Forest', 'Equatorial Forest'], loc='upper right', fontsize=10, title="Forest Categories", frameon=False)
