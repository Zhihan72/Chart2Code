...
sectors = ['Transport', 'Industrial', 'Residential', 'Agriculture', 'Waste Management', 'Energy']
...
bar_height = 0.13  # Adjusted to accommodate additional series
