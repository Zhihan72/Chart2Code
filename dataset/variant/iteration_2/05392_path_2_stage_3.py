...
ax1.stackplot(years, e_coli, staph, salmonella, labels=['E. coli', 'Staph', 'Salmonella'], 
              colors=['#99ff99','#ff9999','#66b3ff'], alpha=0.7)

ax2.plot(years, total_concentration, label='Total Conc.', color='black', lw=2, linestyle='--', marker='o')

ax1.set_title('Bacterial Conc. (2010-2020)', fontsize=16, fontweight='bold')
ax1.set_xlabel('Year', fontsize=14)
ax1.set_ylabel('Bacterial Conc. (CFU/mL)', fontsize=14, color='dimgray')
