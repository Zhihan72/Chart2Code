...
plt.plot(years, ev_us, color='red', marker='o', linestyle='-', linewidth=2, markersize=5, label='US')
plt.plot(years, ev_europe, color='purple', marker='s', linestyle='-', linewidth=2, markersize=5, label='EUR')
plt.plot(years, ev_china, color='orange', marker='d', linestyle='-', linewidth=2, markersize=5, label='CN')
plt.plot(years, ev_japan, color='blue', marker='p', linestyle='-', linewidth=2, markersize=5, label='JPN')
plt.plot(years, ev_india, color='green', marker='*', linestyle='-', linewidth=2, markersize=5, label='IND')
