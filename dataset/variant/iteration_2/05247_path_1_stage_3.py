...
# Plotting the bars for vitamin content with a new color
bars = ax1.bar(fruits, vitamin_content, color="sandybrown", edgecolor='black', linewidth=0.8)

ax1.grid(True, linestyle='--', alpha=0.7)

# Plotting the line chart for average ratings with a new color
ax2 = ax1.twinx()
ax2.plot(fruits, avg_rating, color="crimson", marker='o', linestyle='-', linewidth=2.5, markersize=10)
