...
ax.plot(years, northern_hemisphere, marker='o', linestyle='-', color=common_color, linewidth=2, label='Northern Hemisphere')
ax.plot(years, tropical_regions, marker='^', linestyle='--', color=common_color, linewidth=2, label='Tropical Regions')
ax.plot(years, southern_hemisphere, marker='s', linestyle='-.', color=common_color, linewidth=2, label='Southern Hemisphere')
