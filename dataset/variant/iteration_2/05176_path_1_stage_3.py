...
ax.plot(years, city_A_temps, marker='o', linestyle='-', color='#ff7f0e', linewidth=2, label='A')
ax.plot(years, city_B_temps, marker='s', linestyle='--', color='#2ca02c', linewidth=2, label='B')
ax.plot(years, city_C_temps, marker='^', linestyle='-.', color='#1f77b4', linewidth=2, label='C')
