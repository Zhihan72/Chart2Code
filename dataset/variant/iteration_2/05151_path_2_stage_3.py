...
ax.plot(months, lunar_rabbits_population, marker='D', linestyle='-.', color='navy', linewidth=1.5, markersize=7, label='Lunar Rabbits')
ax.plot(months, sun_chameleons_population, marker='x', linestyle=':', color='crimson', linewidth=1.5, markersize=7, label='Sun Chameleons')
...
# Altered legend position and format
