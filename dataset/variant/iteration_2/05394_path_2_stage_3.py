...
# Subplot for Star System 2 moved to the first position with shuffled color
ax[0].plot(density_temp2, temperature_grid, color='blue', alpha=0.7)
ax[0].fill_betweenx(temperature_grid, density_temp2, color='blue', alpha=0.1)
ax[0].scatter([0]*len(temperature_star_system2), temperature_star_system2, color='blue', edgecolor='black', s=80, alpha=0.7)
...
# Subplot for Star System 1 moved to the second position with shuffled color
ax[1].plot(density_temp1, temperature_grid, color='red', alpha=0.7)
ax[1].fill_betweenx(temperature_grid, density_temp1, color='red', alpha=0.1)
ax[1].scatter([0]*len(temperature_star_system1), temperature_star_system1, color='red', edgecolor='black', s=80, alpha=0.7)
