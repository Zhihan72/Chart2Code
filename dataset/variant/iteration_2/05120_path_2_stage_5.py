...
# Manually shuffled data while preserving original structure
social_media = [2.8, 1.5, 0.8, 2.1, 3.2]
gaming = [1.3, 0.8, 2.4, 0.6, 1.9]
productivity = [2.3, 1.8, 1.9, 1.2, 1.5]
entertainment = [2.0, 1.5, 1.2, 2.4, 2.1]
