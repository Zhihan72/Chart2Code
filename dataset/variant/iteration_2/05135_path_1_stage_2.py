...
color_order = ['lightgreen', 'lightyellow', 'lightblue', 'lightcoral']
edge_color_order = ['green', 'goldenrod', 'blue', 'red']
median_color_order = ['darkgreen', 'darkgoldenrod', 'darkblue', 'darkred']
...
ax.text(4, 8.3, 'Win: Avg', fontsize=10, color='red', ha='center')
