...
axs[0].plot(years, usa_contribution, label='USA Share', color='purple', linestyle='-', marker='x', linewidth=1.5)
axs[0].plot(years, china_contribution, label='China Share', color='orange', linestyle=':', marker='d', linewidth=1.5)
axs[0].plot(years, norway_contribution, label='Norway Share', color='pink', linestyle='-.', marker='v', linewidth=1.5)
...
axs[1].plot(years, usa_ev_growth, label='USA Growth', color='purple', linestyle='--', marker='*', linewidth=2)
axs[1].plot(years, china_ev_growth, label='China Growth', color='orange', linestyle='-', marker='p', linewidth=2)
axs[1].plot(years, norway_ev_growth, label='Norway Growth', color='pink', linestyle=':', marker='h', linewidth=2)
