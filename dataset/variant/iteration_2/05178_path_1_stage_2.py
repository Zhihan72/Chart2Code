...
ax.plot(years, solar_energy, label='Solar', color='orange', linewidth=2, marker='o', markersize=6)
ax.plot(years, wind_energy, label='Wind', color='blue', linewidth=2, marker='^', markersize=6)
ax.plot(years, hydro_energy, label='Hydro', color='green', linewidth=2, marker='s', markersize=6)
ax.plot(years, geothermal_energy, label='Geothermal', color='red', linewidth=2, marker='d', markersize=6)
...
for year, s, w, h, g in zip(years, solar_energy, wind_energy, hydro_energy, geothermal_energy):
    ...
    ax.annotate(f'{g}', xy=(year, g), xytext=(year, g+20), textcoords='offset points', ha='center', fontsize=10, color='red')
