...
# Randomly altered search interest for different languages (fictional data, % of total search interest)
...
ax.annotate('Python rises to preeminence', xy=(2018, 72), xytext=(2015, 60),
            arrowprops=dict(facecolor='black', arrowstyle='->', lw=1), fontsize=12, color='blue')
ax.annotate('JavaScript’s steady growth', xy=(2010, 18), xytext=(2014, 30),
