...
# Shuffle the colors
ax1.barh(y - bar_height, fuel_2020, bar_height, color='lightgreen')
ax1.barh(y, fuel_2021, bar_height, color='salmon')
ax1.barh(y + bar_height, fuel_2022, bar_height, color='skyblue')
