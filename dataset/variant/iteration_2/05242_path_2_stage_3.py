...
ax.barh(positions, germany_farms, height=bar_height, color='cornflowerblue', edgecolor='grey')
ax.barh(positions + bar_height, france_farms, height=bar_height, color='seagreen', edgecolor='grey')
ax.barh(positions + 2 * bar_height, italy_farms, height=bar_height, color='tomato', edgecolor='grey')
ax.barh(positions + 3 * bar_height, spain_farms, height=bar_height, color='gold', edgecolor='grey')
ax.barh(positions + 4 * bar_height, sweden_farms, height=bar_height, color='mediumpurple', edgecolor='grey')
ax.barh(positions + 5 * bar_height, netherlands_farms, height=bar_height, color='orange', edgecolor='grey')
...
for i in range(len(years)):
    ...
    ax.text(netherlands_farms[i] + 50, i + 5 * bar_height, f'{netherlands_farms[i]}', va='center', ha='left', color='black', fontsize=8)
    ax.text(norway_farms[i] + 50, i + 6 * bar_height, f'{norway_farms[i]}', va='center', ha='left', color='black', fontsize=8)
