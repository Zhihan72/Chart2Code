...
ax.bar(x - bar_width, electricity_bills[0], width=bar_width, label='Electricity (Small)', color='#FF5733')
...
ax.bar(x, electricity_bills[1], width=bar_width, label='Electricity (Medium)', color='#C70039')
...
ax.bar(x + bar_width, electricity_bills[2], width=bar_width, label='Electricity (Large)', color='#900C3F')
