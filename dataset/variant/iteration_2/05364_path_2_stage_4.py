...
# Shuffled the colors
bars1 = ax1.bar(index, new_constructions, bar_width, color='gold', edgecolor='black', label='Constructions')
bars2 = ax1.bar(index + bar_width, green_spaces, bar_width, color='lightcoral', edgecolor='black', label='Green Areas')
bars3 = ax1.bar(index + 2 * bar_width, renewable_projects, bar_width, color='lightseagreen', edgecolor='black', label='Renewables')
