...
ocean_energy = np.array([15, 18, 21, 25, 30, 35, 40, 45, 50, 55, 60])  # New data series
...
air_quality_improvement = np.array([30, 35, 40, 45, 50, 60, 70, 80, 95, 110, 130])  # New effect
...
ax1.fill_between(years, cumulative_biomass, cumulative_ocean_energy, color='#1E90FF', alpha=0.7)  # Adding new data
...
ax2.plot(years, air_quality_improvement, color='purple', linewidth=2.5, marker='^')  # Adding new effect
