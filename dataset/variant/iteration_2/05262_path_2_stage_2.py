...
categories = ['Fiction', 'Non-Fiction', 'Science Fiction', 'Fantasy', 'Biographies']
distribution = [30, 20, 15, 15, 10]
colors = ['#FF9999', '#66B2FF', '#99FF99', '#FFD700', '#FFB6C1']

fig, ax = plt.subplots(figsize=(10, 7))

# Create the pie chart with a specified wedgeprops to create a hole in the center
wedges, texts, autotexts = ax.pie(
    ...
    autopct='%1.1f%%', 
    startangle=90,
    wedgeprops={'width': 0.3, 'edgecolor': 'w'}  # Define the width to make it a donut pie chart
)
