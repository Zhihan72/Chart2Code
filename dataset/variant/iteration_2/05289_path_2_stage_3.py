...
ax.barh(weeks - 0.45, mystery_readings, height=0.2, color='#1f77b4', label='Mystery')
ax.barh(weeks - 0.15, fantasy_readings, height=0.2, color='#ff7f0e', label='Fantasy')
ax.barh(weeks + 0.15, science_fiction_readings, height=0.2, color='#2ca02c', label='Science Fiction')
ax.barh(weeks + 0.45, adventure_readings, height=0.2, color='#d62728', label='Adventure')
