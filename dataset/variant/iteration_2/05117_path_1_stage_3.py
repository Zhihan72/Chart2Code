...
bars_cats = ax.barh(y - bar_height, cats, height=bar_height, label='Cats', color='lightblue')
bars_dogs = ax.barh(y, dogs, height=bar_height, label='Dogs', color='lightyellow')
bars_fish = ax.barh(y + bar_height, fish, height=bar_height, label='Fish', color='lightcoral')
