...
ax1.plot(years, strawberries_vitamin_c, color='#FF69B4', marker='d', linestyle='-', linewidth=2, label='Strawberries - Vitamin C (mg/100g)')
...
ax2.plot(years, strawberries_fiber, color='#32CD32', marker='d', linestyle='--', linewidth=2, label='Strawberries - Fiber (g/100g)')
