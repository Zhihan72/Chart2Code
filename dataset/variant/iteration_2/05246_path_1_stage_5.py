...
ax.barh(y_positions - bar_height / 2, product_A_sales, height=bar_height, color='purple', edgecolor='black', label='Product A')
ax.barh(y_positions + bar_height / 2, product_B_sales, height=bar_height, color='orange', edgecolor='black', label='Product B')
