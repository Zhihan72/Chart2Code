...
# Shuffled colors for the scatter charts
ax1.scatter(xenia_height, xenia_diameter, color='green', edgecolor='black', alpha=0.7, s=100, label='Xenia')
ax1.scatter(zog_height, zog_diameter, color='red', edgecolor='black', alpha=0.7, s=100, label='Zog')
ax1.scatter(trogar_height, trogar_diameter, color='blue', edgecolor='black', alpha=0.7, s=100, label='Trogar')
...
# Shuffled colors for the bar plot
