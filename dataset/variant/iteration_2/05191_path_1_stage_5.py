...
ax.plot(angles, mage, color=colors[0], linewidth=2, linestyle=line_styles[0], marker=markers[0], label='Mage')
ax.plot(angles, knight, color=colors[1], linewidth=2, linestyle=line_styles[1], marker=markers[1], label='Knight')
