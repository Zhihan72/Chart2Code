...
# Use new set of colors for the bars
rects1 = ax.bar(x_positions - bar_width/2, weekday_hours, width=bar_width, label='Weekday', color='darkgreen', edgecolor='black')
rects2 = ax.bar(x_positions + bar_width/2, weekend_hours, width=bar_width, label='Weekend', color='darkorange', edgecolor='black')
