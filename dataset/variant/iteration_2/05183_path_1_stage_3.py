...
# Updated color palette for the bars
...
ax2 = ax1.twiny()
ax2.plot(growth_rates, instruments, color='darkgreen', marker='o', linestyle='-', linewidth=2, label='Growth Rate (%)')
ax2.set_xlabel('Growth Rate (%)', fontsize=12, color='darkgreen')
