...
# Plotting sea levels with altered styles
ax1.plot(years, sea_levels_global, color='purple', marker='o', label='Global Sea Level', linewidth=1)
ax1.plot(years, sea_levels_atlantic, color='green', linestyle='--', marker='x', label='Atlantic Sea Level', linewidth=3)

# Title and labels for the first y-axis
...
ax2 = ax1.twinx()
ax2.plot(years, temp_anomaly, color='brown', linestyle='-', marker='s', label='Temperature Anomaly (°C)', linewidth=2)

# Secondary y-axis label
ax2.set_ylabel('Temperature Anomaly (°C)', fontsize=14, color='brown')

# Layout adjustments
fig.tight_layout()

# Removed additional legend to avoid overlap
# Show the plot
plt.show()