...
# Backstory:
# This plot explores the relationship between urban green space per capita and average happiness index in various cities. 
# Data from multiple cities around the world is simulated based on hypothetical values.
# The green spaces include parks, gardens, and other urban green facilities contributing to environmental quality and residents' well-being.
...
plt.scatter(green_space_per_capita, happiness_index, color='forestgreen', edgecolors='black', s=150, alpha=0.7)
...
plt.plot(green_space_per_capita, m * green_space_per_capita + b, color='darkorange', linestyle='--', linewidth=2, label='Trend Line')
