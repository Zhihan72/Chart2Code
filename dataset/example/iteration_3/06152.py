...
# Backstory
# The chart shows the hypothetical journey of solar-powered car production over the years from 2010 to 2020 by three major manufacturers.
# The manufacturers are SolarTech, SunDrive, and EcoWheels.
...
ax.plot(years, solartech_production, label='SolarTech', marker='o', linestyle='-', linewidth=2, color='gold')
ax.plot(years, sundrive_production, label='SunDrive', marker='s', linestyle='-', linewidth=2, color='darkorange')
