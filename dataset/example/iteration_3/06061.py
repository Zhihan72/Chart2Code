...
# Backstory: An electronics store tracks the performance of its sales specialists based on monthly sales and customer satisfaction scores.
# The chart will illustrate the sales numbers and satisfaction scores for each specialist over a 12-month period.
...
# Plot bars
ax.bar(r1, monthly_sales[0], color='r', width=bar_width, edgecolor='grey', label=specialists[0])
ax.bar(r2, monthly_sales[1], color='g', width=bar_width, edgecolor='grey', label=specialists[1])
ax.bar(r3, monthly_sales[2], color='b', width=bar_width, edgecolor='grey', label=specialists[2])
ax.bar(r4, monthly_sales[3], color='orange', width=bar_width, edgecolor='grey', label=specialists[3])
