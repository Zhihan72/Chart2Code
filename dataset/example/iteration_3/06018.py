...
# Backstory:
# A fictional town called "TechVille" has launched a 5-year program to increase technological literacy among its residents.
# The program encompasses workshops on various contemporary tech topics. This bar chart visualizes attendance for each of these workshops over the years.
...
ax.set_ylabel("Attendance (in thousands)", fontsize=14)

# Set x-axis ticks with positions and add grid
ax.set_xticks(bar_positions + bar_width * 1.5)
ax.set_xticklabels(years)
ax.yaxis.grid(True, linestyle='--', alpha=0.7)

# Add legend
ax.legend(title="Workshop Topics", loc='upper left', bbox_to_anchor=(1.05, 1), frameon=False)
