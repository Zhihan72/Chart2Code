...
# Backstory: A survey was conducted among a group of students to understand their favorite types of snacks. 
# The findings are summarized in this pie chart.
...
# Automatically adjust layout to give specified padding
plt.tight_layout()
