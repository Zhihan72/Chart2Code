...
# Backstory: Analyze the sales performance of different genres of books in an independent bookstore for the past year

# Define book genres and monthly sales data
genres = ['Mystery', 'Romance', 'Science Fiction', 'Fantasy', 'Non-fiction', 'Horror']
...
# Plotting the monthly sales data as grouped bar chart
