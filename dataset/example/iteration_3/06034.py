...
# Backstory:
# This plot represents the yearly CO2 emissions (in million tons) of various continents over a five-year period.
# Additionally, it includes subplots showing the proportion of emissions from leading countries in each continent.
...
axs[0, 0].bar(years, emissions_na, color='blue', alpha=0.7, label='North America')
axs[0, 0].bar(years, emissions_eu, color='green', alpha=0.7, label='Europe')
axs[0, 0].bar(years, emissions_as, color='red', alpha=0.7, label='Asia')
axs[0, 0].bar(years, emissions_af, color='brown', alpha=0.7, label='Africa')
axs[0, 0].bar(years, emissions_sa, color='purple', alpha=0.7, label='South America')
