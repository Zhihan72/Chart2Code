...
# Backstory: 
# In a small countryside town named Martindale, farmers grow different vegetables each season. 
# The community is keenly interested in the yield trends over the past decade. Here, we'll plot 
# the annual yield (in tons) for tomatoes, carrots, and broccoli, focusing on their fluctuating trends.
