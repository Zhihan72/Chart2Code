...
# Title and Backstory
# Storyline: This script represents the interconnected network of science fiction authors, highlighting their influence on each other within the genre. The darker the node, the more influential the author, and the thicker the edge, the stronger the connection.
...
# Define node influence level for node color and edge influence level for edge width
influence_levels = {
    "Jules Verne": 10, 
    "H.G. Wells": 8,
    "Isaac Asimov": 7,
...
edges = nx.draw_networkx_edges(G, pos, width=edge_widths, arrowsize=20, edge_color='lightgrey')
