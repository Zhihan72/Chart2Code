...
# Backstory:
# In a fictional world, different regions are vying with each other to lead in the production of imaginary "Magic Beans". 
# We want to compare the annual production of Magic Beans among these regions over the last 5 years.
...
for i, region in enumerate(regions):
    ax.bar(x + i * bar_width, production_data[i], width=bar_width, label=region, color=colors[i])
...
ax.legend(title='Regions', fontsize=12, title_fontsize='13')
