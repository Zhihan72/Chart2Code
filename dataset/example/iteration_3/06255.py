...
# Backstory: The chart reflects the Fantasy World Natural Resource Usage over a decade in the land of Mythica.
# The resources include Moon Crystals, Sun Gemstones, Star Dust, and Sky Pearls.
...
ax.stackplot(years, resource_data, labels=['Moon Crystals', 'Sun Gemstones', 'Star Dust', 'Sky Pearls'],
             colors=['#C0C0C0', '#FFD700', '#ADD8E6', '#FF69B4'], alpha=0.8)
