...
# Backstory:
# This chart depicts the trend of energy consumption in a small town from 2000 to 2022. 
# The town's energy consumption has evolved significantly due to the introduction 
...
# Plot the data
plt.plot(years, traditional_energy, label='Traditional Energy', color='brown', linestyle='-', linewidth=2)
plt.plot(years, solar_energy, label='Solar Energy', color='orange', linestyle='--', linewidth=2)
plt.plot(years, wind_energy, label='Wind Energy', color='cyan', linestyle='-.', linewidth=2)
