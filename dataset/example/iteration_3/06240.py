...
# Backstory:
# The chart displays the popularity of various space exploration missions among the public.
# The data reflects the number of votes (in thousands) that each mission received in a recent worldwide survey.
...
counts = [1, 9]  # Apollo 11 was the only manned mission
