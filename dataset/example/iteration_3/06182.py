...
# Topic: Solar Panel Adoption and Efficiency
# Backstory: The following chart compares the adoption rates and efficiency of solar panels across various regions over a decade (2011-2021). 
# This provides insights into how different regions are contributing to clean energy adoption throughout the years.

# Define years and regions
years = np.arange(2011, 2022)
regions = ["North America", "Europe", "Asia", "Africa", "South America", "Australia", "Middle East"]
...
axs[0].set_title('Solar Panel Adoption Rates (%)\n(2011-2021)', fontsize=16, weight='bold')
...
# Annotate and label the heatmap
axs[1].set_title('Solar Panel Efficiency Improvement (%/year)\n(2011-2021)', fontsize=16, weight='bold')
...
cbar2.set_label('Efficiency Improvement (%/year)', rotation=270, labelpad=20)

# Main title for the chart
plt.suptitle('Global Solar Panel Adoption and Efficiency Trends\n(2011-2021)', fontsize=18, weight='bold')
