...
# Backstory:
# In Fantasy Kingdom, various Wizardry Schools cast different types of spells during the Grand Magical Tournament. 
# We want to visualize the distribution of spell types cast by each school. 
# Additionally, we will include a secondary subplot to show the average power level of these spells across the schools.
