...
# Backstory:
# The town of GreenVille has been tracking the monthly waste recycling rates for different materials over a year.
# This data will help the town understand recycling trends and emphasize areas that need improvement.
...
ax[0].bar(x_indexes - bar_width, plastic_recycling, width=bar_width, color='#FF5733', label='Plastic', alpha=0.8)
ax[0].bar(x_indexes, glass_recycling, width=bar_width, color='#33FF57', label='Glass', alpha=0.8)
ax[0].bar(x_indexes + bar_width, metal_recycling, width=bar_width, color='#3357FF', label='Metal', alpha=0.8)
ax[0].bar(x_indexes + 2*bar_width, paper_recycling, width=bar_width, color='#FFD700', label='Paper', alpha=0.8)
...
ax[0].legend(title='Waste Material', fontsize=10)
ax[0].grid(True, linestyle='--', alpha=0.7)

# Stacked bar chart for percentage contributions
ax[1].bar(months, plastic_percentage, color='#FF5733', label='Plastic', alpha=0.8)
ax[1].bar(months, glass_percentage, bottom=plastic_percentage, color='#33FF57', label='Glass', alpha=0.8)
ax[1].bar(months, metal_percentage, bottom=plastic_percentage+glass_percentage, color='#3357FF', label='Metal', alpha=0.8)
ax[1].bar(months, paper_percentage, bottom=plastic_percentage+glass_percentage+metal_percentage, color='#FFD700', label='Paper', alpha=0.8)
...
ax[1].legend(loc='upper right', title='Waste Material', fontsize=10)
