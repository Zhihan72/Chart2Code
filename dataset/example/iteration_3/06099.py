...
# Backstory: This chart depicts the monthly sales performance of a new beverage product 'AquaFizz' across different store types. 
# The bar chart shows the sales in units for each store type, and the line chart above it showcases the overall sales growth percentage month-over-month.

# Define the months and store types
months = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"]
store_types = ["Supermarkets", "Convenience Stores", "Online Retailers", "Specialty Shops"]
