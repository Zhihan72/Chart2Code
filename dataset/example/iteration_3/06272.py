...
# Backstory: 
# The chart depicts the yearly trends in renewable energy output for different types of renewable sources 
# from 2010 to 2020, illustrating the growth of solar, wind, hydro, and geothermal energy production.
...
ax.plot(years, solar, label='Solar', color='gold', marker='o', linestyle='--')
ax.plot(years, wind, label='Wind', color='lightblue', marker='s', linestyle='-.')
ax.plot(years, hydro, label='Hydro', color='cornflowerblue', marker='^', linestyle=':')
ax.plot(years, geothermal, label='Geothermal', color='brown', marker='d', linestyle='-')
