...
# Create artificial wind speed data for different seasons (in meters per second)
...
# Colors for the density plots
colors = ['green', 'orange', 'brown', 'blue']

# Plot densities for each season
for i, (ax_, season, data, color) in enumerate(zip(ax.flatten(), seasons, wind_speed_data, colors)):
    density = gaussian_kde(data)
    x_vals = np.linspace(0, 7, 200)  # Define the range of x-values for plot
