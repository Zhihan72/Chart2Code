...
# Backstory and data context:
# We are comparing the training outcomes in three different fictional space academies.
# The academies train space explorers in various key skills necessary for interstellar missions.
...
ax.plot(angles, jupiter_academy, linewidth=2, linestyle='-', label='Jupiter Academy', color='#2ca02c', marker='^')
ax.fill(angles, jupiter_academy, '#2ca02c', alpha=0.15)
