...
# Backstory: Tracking the average screen time per day across different age groups
# among teenagers over a period of five years from 2018 to 2022.

# Define the years for the dataset
years = np.array([2018, 2019, 2020, 2021, 2022])

# Average screen time data for different age groups (in hours)
screen_time_data = {
