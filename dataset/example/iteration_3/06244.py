...
# Backstory:
# The fictitious town of Green Gardens started a "Green Energy Initiative" in 2015 aimed at increasing renewable energy usage and reducing reliance on fossil fuels. 
# This script will depict the annual energy consumption trends and the growth in renewable energy share.
...
plt.subplot(2, 1, 1)
plt.plot(years, fossil_fuels, label='Fossil Fuels', color='brown', marker='o', linestyle='-')
plt.plot(years, solar_energy, label='Solar Energy', color='orange', marker='o', linestyle='-')
plt.plot(years, wind_energy, label='Wind Energy', color='skyblue', marker='o', linestyle='-')
plt.plot(years, total_energy, label='Total Energy', color='green', marker='D', linestyle='--')

# Highlighting the year with significant change
...
plt.subplot(2, 1, 2)
plt.plot(years, share_renewable, label='Renewable Energy Share', color='purple', marker='o', linestyle='-')
...
# Optimize layout to avoid overlaps and show the plot
plt.tight_layout()
plt.show()