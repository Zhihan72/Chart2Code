...
# Backstory: Tracking Water Levels and Temperature Changes in a Lake Over the Course of a Year
# We're interested in understanding how the water level and temperature of a lake fluctuate month-by-month across one year.
...
ax1.plot(months, water_levels, color='blue', marker='o', linestyle='-', linewidth=2, markersize=8, label='Water Level (meters)')
...
# Create a secondary y-axis for temperatures
ax2 = ax1.twinx()
ax2.plot(months, temperatures, color='red', marker='s', linestyle='-', linewidth=2, markersize=8, label='Temperature (°C)')
...
# Merging legends of both plots
lines, labels = ax1.get_legend_handles_labels()
lines2, labels2 = ax2.get_legend_handles_labels()
ax1.legend(lines + lines2, labels + labels2, loc='upper left', fontsize=10)

# Annotate the highest and lowest water levels and temperatures
