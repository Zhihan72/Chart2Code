...
# Backstory: Analysis of Monthly Sales for Different Product Categories in a Retail Store

# Categories and corresponding sales data over the first 6 months of the year
categories = ["Electronics", "Fashion", "Home Goods", "Beauty", "Toys", "Books"]
months = ["January", "February", "March", "April", "May", "June"]

# Sales data in thousands USD (no random usage, explicitly crafted)
sales_data = [
...
# Convert sales_data to a numpy array for easier manipulation
sales_data = np.array(sales_data)

# Set up the bar chart
fig, ax = plt.subplots(figsize=(14, 8))

# Position of bars along the x-axis
