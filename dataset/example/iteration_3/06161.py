...
# Plotting the growth of Internet bandwidth over the years across different continents
# The data captures how bandwidth usage on average has exploded from the early 2000s to 2020
...
plt.plot(years, europe_bandwidth, label='Europe', color='blue', linewidth=2, marker='s', markersize=5)
plt.plot(years, north_america_bandwidth, label='North America', color='green', linewidth=2, marker='^', markersize=5)
plt.plot(years, africa_bandwidth, label='Africa', color='purple', linewidth=2, marker='d', markersize=5)

# Add titles, labels, and legend
plt.title('Growth of Internet Bandwidth Usage across Continents (2000 - 2020)', fontsize=16, fontweight='bold')
plt.xlabel('Year', fontsize=12)
plt.ylabel('Bandwidth Usage (Gbps)', fontsize=12)

# Add a legend to the upper left corner
plt.legend(title="Continents", fontsize=10, title_fontsize=12, loc='upper left')
...
# Display the plot with a grid and proper spacing
plt.show()