...
# Backstory:
# In a distant future, humanity has colonized Mars, and researchers are monitoring the energy consumption of Mars' colonies. This dataset shows the monthly energy consumption in three major colonies.
...
ax2.bar(months_indices - width, colony_alpha, width, label='Colony Alpha', edgecolor='black', color='#FF9999', alpha=0.7)
ax2.bar(months_indices, colony_beta, width, label='Colony Beta', edgecolor='black', color='#66B3FF', alpha=0.7)
ax2.bar(months_indices + width, colony_gamma, width, label='Colony Gamma', edgecolor='black', color='#99FF99', alpha=0.7)
