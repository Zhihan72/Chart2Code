...
# Title and backstory
# The chart captures a critical period in the realm of technology, illustrating the evolution of internet users and bandwidth consumption
# over the past decade, reflecting the digital transformation and increasing reliance on internet connectivity.
...
# Plot internet users
ax1.plot(years, internet_users, marker='o', linestyle='-', linewidth=2, color='blue', label='Internet Users (Billions)')
...
ax2 = ax1.twinx()
ax2.plot(years, bandwidth_usage, marker='s', linestyle='-', linewidth=2, color='green', label='Bandwidth Usage (Exabytes/Month)')
...
ax1.set_ylabel("Internet Users (Billions)", fontsize=14, color='blue')
ax2.set_ylabel("Bandwidth Usage (Exabytes/Month)", fontsize=14, color='green')
