...
# Backstory: Tracking the Rise of Renewable Energy Sources Over Time
# The chart illustrates how different renewable energy sources (solar, wind, hydro, geothermal) have grown from 2010 to 2030.
...
ax.set_title('Growth of Renewable Energy Production (2010-2030)', fontsize=16, fontweight='bold')
...
ax2 = ax.twinx()
ax2.plot(years, total_production, 'o--', color='#2c3e50', label='Total Renewable Production')
ax2.set_ylabel('Total Production (GWh)', fontsize=12, color='#2c3e50')
ax2.tick_params(axis='y', colors='#2c3e50')

# Consolidate legends
lines, labels = ax.get_legend_handles_labels()
lines2, labels2 = ax2.get_legend_handles_labels()
ax.legend(lines + lines2, labels + labels2, loc='upper left', title='Energy Metrics')
