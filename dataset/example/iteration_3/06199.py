...
# Backstory: Analysis of Average Weekly Study Time per Subject for High School Students
# In a recent survey conducted among high school students, data was collected regarding the average number of hours spent studying various subjects each week. The school wants to visualize this data to identify which subjects receive the most study attention and to consider if the scheduling needs any adjustment.

# Define the data
subjects = ['Mathematics', 'Science', 'English', 'History', 'Physical Education', 'Arts', 'Computer Science']
study_hours = [8, 6, 5, 4, 3, 2, 7]

# Extra data (average grades in each subject)
average_grades = [85, 78, 88, 80, 90, 95, 85]  # Grades out of 100

# Colors for each bar
colors = ['#FF9999', '#66B3FF', '#99FF99', '#FFCC99', '#FFD700', '#DA70D6', '#8A2BE2']
