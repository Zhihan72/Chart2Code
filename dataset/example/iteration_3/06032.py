...
# Backstory:
# The chart highlights the seasonal temperatures across different fictional cities in the world of Elementia.
# Specifically, the data represents the recorded temperatures (in degrees Celsius) during the summer and winter seasons.

# Define cities
cities = ["Inferno City", "Frostville", "Temperate Town", "Zephyr Zone", "Aqua Haven"]

# Define temperature data (in degrees Celsius) for each city during summer and winter
summer_temperatures = [
...
ax1.set_title("Summer Temperatures Across Cities in Elementia", fontsize=14, fontweight='bold', pad=15)
...
ax2.set_title("Winter Temperatures Across Cities in Elementia", fontsize=14, fontweight='bold', pad=15)
