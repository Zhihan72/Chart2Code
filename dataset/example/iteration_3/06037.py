...
# Backstory: Comparing the average voltage levels in various sectors of a futuristic city
# The city has implemented advanced power monitoring with various sectors having sensors that report average voltages
# over different months of the year. The data will be visualized using a heatmap to identify trends.
...
voltage_levels = np.array([
    ...
    [200, 205, 210, 215, 220, 225, 228, 230, 225, 220, 215, 210],  # Agricultural
    [230, 232, 234, 236, 238, 240, 242, 244, 243, 241, 239, 237],  # Healthcare
