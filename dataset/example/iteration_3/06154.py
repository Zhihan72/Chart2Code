...
# Backstory: Comparing levels of monthly screen time among different age groups
# Data representation: Monthly screen time (in hours) for various age groups

# Age groups
age_groups = [
    '6-12 years', '13-18 years', '19-25 years', 
    '26-40 years', '41-60 years', '60+ years'
]
...
ax.set_title('Monthly Screen Time Among Different Age Groups', fontsize=20, fontweight='bold', pad=20)
ax.set_xlabel('Hours per Month', fontsize=15)
...
ax.annotate('Highest screen time observed', xy=(240, 2), xytext=(250, 1.8),
            arrowprops=dict(facecolor='gray', arrowstyle='->'), fontsize=12)

ax.annotate('Consistent screen time usage', xy=(170, 4), xytext=(180, 4.5),
            arrowprops=dict(facecolor='gray', arrowstyle='->'), fontsize=12)
