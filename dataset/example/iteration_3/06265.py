...
# Simulating data based on a fictional study of "Urban Green Spaces and Air Quality"
# Data spans three cities under investigation
...
# Additional data: estimated population density (people per sq km)
population_density = [5000, 7000, 6000]

fig, ax1 = plt.subplots(figsize=(14, 8))

# Scatter plot for green space vs air quality
scatter = ax1.scatter(green_spaces_hectares, air_quality_index, c=range(len(cities)), cmap='tab20b', s=200, edgecolor='black', alpha=0.8)
