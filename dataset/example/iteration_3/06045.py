...
# Backstory: The chart represents the analysis of monthly running distances (in km) by different types of athletes over the span of one year.
# Athletes include: Amateur, Semi-Professional, Professional, Marathoners, and Sprinters.
...
legend = ax.legend(handles, labels, loc='upper left', frameon=False, fontsize=12)
