...
# ----- Backstory -----
# In a small village, people predominantly rely on different transportation modes for their daily commutes. This pie chart represents the distribution of different transportation modes in the village.
...
# Add title with line breaks for clarity
