...
# Backstory: Interdisciplinary Astrobiology Research Group conducted a survey to study the water content in soil samples 
# collected from different planetary bodies in our solar system. The aim was to identify areas with the highest potential 
# for supporting life.
...
box = ax.boxplot(water_content_data, patch_artist=True, notch=False, vert=True, labels=planets)
...
ax.set_xlabel("Planetary Bodies", fontsize=12)
...
for i, planet in enumerate(planets):
    ...
    ax.text(i + 1, max_val + 2, f'Max: {max_val:.1f}%', ha='center', fontsize=10, color=colors[i])
