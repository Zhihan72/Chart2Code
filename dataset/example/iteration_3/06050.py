...
# Backstory: This chart shows the evolution of renewable energy storage capacities in the fictional island of Greenopolis from 2010 to 2030.
# The emphasis is on different types of storage methods: Batteries, Pumped Hydro, Thermal Storage, and Flywheels.
...
total_storage = batteries + pumped_hydro + thermal_storage + flywheels

# Stacked data
storage_data = np.vstack((batteries, pumped_hydro, thermal_storage, flywheels))
...
ax1.stackplot(years, storage_data, labels=['Batteries', 'Pumped Hydro', 'Thermal Storage', 'Flywheels'], 
              colors=['#FFCC00', '#1E90FF', '#FF6347', '#32CD32'], alpha=0.85)
