...
# Backstory:
# "Global Forest Coverage and Reforestation Efforts"
# This chart visualizes the progression and efficacy of global reforestation initiatives from 2000 to 2020. It shows 
# how deforestation rates have decreased over time while new forest coverage has increased due to various global efforts.
...
ax.stackplot(years, data_stack, labels=['Deforestation', 'Reforestation'], colors=['#8B0000', '#228B22'], alpha=0.7)
