...
# Backstory: The data represents the fictional market penetration of various smartphone brands in a futuristic tech-driven city from 2020 to 2030. The area chart visualizes the rise and fall in dominance, capturing consumer preferences over the years.
...
ax.stackplot(years, data, labels=["Brand A", "Brand B", "Brand C", "Brand D", "Brand E"], 
...
ax.legend(loc='upper left', fontsize=10, title='Smartphone Brands')
