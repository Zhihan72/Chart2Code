...
# Backstory: Analyzing Batting Performance in Cricket
# We have performance data for three cricket players across different match conditions.

# Data: Runs scored by three players (Player A, Player B, Player C) in different matches
match_conditions = ['Day Match', 'Night Match', 'Day-Night Match']
player_a_scores = [50, 75, 65]
player_b_scores = [60, 80, 70]
player_c_scores = [45, 55, 60]

# Create an artificial dataset for scatter plot
...
background_score = [20, 20, 20]  # Background constant for average performance

# Plot configuration
fig, ax = plt.subplots(figsize=(10, 6))

# Scatter plots for individual players
...
# Add large circles for average runs
