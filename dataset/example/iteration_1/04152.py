...
# Backstory: Monitoring the impact of climate change on Arctic sea ice extent
...
# Add a horizontal line indicating a sensitive threshold
...
# Adding a legend for the months
