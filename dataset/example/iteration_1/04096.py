...
# Backstory: Performance Analysis of Different Sales Strategies in Q1 2023

# Sales strategies being analyzed
strategies = [
    'Online Marketing', 'Field Sales', 'Telemarketing', 
    'Refer-a-Friend', 'Retail Partnerships', 'Email Campaigns'
]

# Percentage of total sales achieved by each strategy
sales_percentages = [40, 20, 10, 15, 5, 10]

# Cumulative percentage for stacked bar plot
cumulative_sales = np.cumsum(sales_percentages)

# Revenue generated per strategy (constructed data)
revenues = [80000, 40000, 20000, 30000, 10000, 20000]
...
# Add a line plot for revenue to add additional data dimension
ax2 = ax1.twinx()
...
# Grid lines for better readabilities
