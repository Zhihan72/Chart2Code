...
# Backstory: Analyzing the Ticket Sales of Various Movie Genres Over a Decade
# Data: Ticket sales (in millions) for different movie genres from 2010 to 2020
...
# Create the figure and the axes (two subplots)
fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(12, 10), gridspec_kw={'height_ratios': [3, 1]})

# First subplot: Ticket Sales Trend for Each Genre
ax1.plot(years, action_sales, marker='o', linestyle='-', color='red', label='Action', linewidth=2)
ax1.plot(years, comedy_sales, marker='o', linestyle='-', color='blue', label='Comedy', linewidth=2)
ax1.plot(years, drama_sales, marker='o', linestyle='-', color='green', label='Drama', linewidth=2)
ax1.plot(years, scifi_sales, marker='o', linestyle='-', color='purple', label='Sci-Fi', linewidth=2)
...
# Second subplot: Total Ticket Sales for All Genres Combined
