...
# Backstory: Tracking the Rise of E-commerce during and after the COVID-19 Pandemic.
...
ax1.stackplot(years, ecommerce_data, labels=labels, colors=colors, alpha=0.85)
...
for idx, sector in enumerate(labels):
