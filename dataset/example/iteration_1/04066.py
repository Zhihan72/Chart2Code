...
# Backstory: Evaluating Martial Arts Training Centers 
# in terms of various training parameters in a fictional city.

# Define the training centers and parameters
centers = ['DragonForce', 'TigerClaw', 'EagleStrike', 'PantherHeart', 'WolfPack']
