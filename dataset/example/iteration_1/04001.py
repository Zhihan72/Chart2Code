...
# Backstory: The plot shows a farmer's crop yield over a decade. 
# The farmer grows Wheat, Corn, and Soybeans. This data captures the trend 
# in yields due to varying factors like weather, technological advancements, and soil quality.
...
ax.plot(years, wheat_yield, label='Wheat Yield', color='saddlebrown', marker='o', linewidth=2, linestyle='-')
ax.plot(years, corn_yield, label='Corn Yield', color='gold', marker='s', linewidth=2, linestyle='-.')
ax.plot(years, soybean_yield, label='Soybean Yield', color='green', marker='^', linewidth=2, linestyle='--')
