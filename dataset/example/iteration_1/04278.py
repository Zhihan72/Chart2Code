...
# Backstory: Solar Energy Adoption Over the Decades
# This chart visualizes the adoption of different types of solar energy (Residential, Commercial, Industrial) in the U.S. from 1975 to 2025.
...
ax1 = axes[0]
ax1.stackplot(decades, area_data, labels=['Residential Solar', 'Commercial Solar', 'Industrial Solar'], colors=colors, alpha=0.8)
ax1.set_title('Percentage of Total Energy Usage (%)', fontsize=14)
ax1.set_xlabel('Decade', fontsize=12)
ax1.set_ylabel('Percentage (%)', fontsize=12)
ax1.legend(loc='upper left', bbox_to_anchor=(1, 1), fontsize=10, title='Solar Energy Sectors')
