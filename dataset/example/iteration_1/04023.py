...
# Backstory: Monitoring the health of the city’s river through various parameters.
# The river’s health is a critical issue in our city, and in this study, we monitor key parameters of the river over a decade.
...
ax1.plot(years, dissolved_oxygen, label='Dissolved Oxygen (mg/L)', color='blue', marker='o', linewidth=2)
ax1.plot(years, ph_level, label='pH Level', color='green', marker='^', linewidth=2)

# Plot the nitrate concentration on a secondary y-axis
ax2.plot(years, nitrate_concentration, label='Nitrate Concentration (mg/L)', color='red', marker='s', linewidth=2)

# Adding labels and title
ax1.set_xlabel('Year', fontsize=12)
ax1.set_ylabel('Dissolved Oxygen (mg/L) / pH Level', fontsize=12, color='blue')
