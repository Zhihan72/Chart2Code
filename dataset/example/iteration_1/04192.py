...
# Backstory: Tracking the popularity trends of various board games over a decade
...
ax.plot(years, settlers_of_catan, label='Settlers of Catan', color='blue', linewidth=2)
ax.plot(years, ticket_to_ride, label='Ticket to Ride', color='orange', linewidth=2)
ax.plot(years, pandemic, label='Pandemic', color='green', linewidth=2)
ax.plot(years, carcassonne, label='Carcassonne', color='red', linewidth=2)
ax.plot(years, terraforming_mars, label='Terraforming Mars', color='purple', linewidth=2)
...
ax_bar = ax.twinx()
ax_bar.barh(x - width/2, popularity_2010, width, label='2010', color='skyblue', alpha=0.7)
ax_bar.barh(x + width/2, popularity_2020, width, label='2020', color='navy', alpha=0.7)
