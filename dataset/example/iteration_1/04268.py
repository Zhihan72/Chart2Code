...
# Backstory:
# The following chart visualizes the growth of different fruit sales over a decade from 2010 to 2020.
# The chart will display the sales of apples, oranges, and bananas in thousands of units.
...
# Plot sales data with different markers and styles
ax.plot(years, apple_sales, marker='o', linestyle='-', color='r', linewidth=2, markersize=6, label='Apples')
ax.plot(years, orange_sales, marker='s', linestyle='--', color='orange', linewidth=2, markersize=6, label='Oranges')
ax.plot(years, banana_sales, marker='^', linestyle='-.', color='yellow', linewidth=2, markersize=6, label='Bananas')
