...
# Backstory: Annual Chocolate Consumption
# Purpose: This bar chart aims to depict the annual chocolate consumption per capita in 
# different countries. Each subplot shows the data for two different years to highlight the trend.

# Data Initialization
countries = ['Switzerland', 'Germany', 'Belgium', 'UK', 'USA', 'France']
choco_consumption_2015 = [9.0, 8.4, 8.3, 8.2, 5.5, 6.5]  # kg per capita
choco_consumption_2020 = [10.1, 9.2, 8.9, 8.5, 6.2, 7.0]  # kg per capita
