...
# Backstory: Exploring the daily changes in temperature in different fictional cities
# The chart will display the distribution of temperature differences throughout a week for various cities.
...
data = [city_A, city_B, city_C, city_D, city_E]
