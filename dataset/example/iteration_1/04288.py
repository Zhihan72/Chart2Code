...
# Backstory: Tracking the Impact of Climate Policy on CO2 Emissions and Renewable Energy Adoption
...
ax1.plot(years, north_america_co2, label="North America", color='blue', marker='o', linestyle='-', linewidth=2)
ax1.plot(years, europe_co2, label="Europe", color='green', marker='s', linestyle='--', linewidth=2)
ax1.plot(years, asia_co2, label="Asia", color='red', marker='^', linestyle='-.', linewidth=2)
...
ax2.plot(years, north_america_renew, label="North America", color='blue', marker='o', linestyle='-', linewidth=2)
ax2.plot(years, europe_renew, label="Europe", color='green', marker='s', linestyle='--', linewidth=2)
ax2.plot(years, asia_renew, label="Asia", color='red', marker='^', linestyle='-.', linewidth=2)
