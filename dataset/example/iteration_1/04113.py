...
# Backstory:
# We are visualizing the overall satisfaction levels of employees in different departments of a tech company
# over the course of a year. Each month, employees provided their satisfaction scores on a scale of 1 to 5.
...
axes = axes.flatten()  # Flatten the matrix of axes into a single array for easy iteration
fig.delaxes(axes[-1])  # Remove the last subplot as we have 5 departments and 6 subplots
