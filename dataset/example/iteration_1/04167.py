...
# Lunar Rover Usage by Research Teams
# Splitting the teams by different terrains
# terrains: Crater, Plain, Valley, Mountain, Ridge
# Teams: "Alpha", "Beta", "Gamma", "Delta", "Omega"
# Note: Each dataset (list) represents the operational hours of rovers in a month for the respective terrains.
