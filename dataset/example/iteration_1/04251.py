...
# Backstory:
# Imagine this as a storyline of the "Solar Power Revolution" campaign led by different regions over the three decades of development and uptake of solar power: 1990s, 2000s, and 2010s. Each decade highlights how each region's adoption and installation capacity have grown.

# Define the decades
decades = np.array([1990, 2000, 2010])

# Solar capacity installed (in Megawatts) by regions (manually crafted for the storyline)
north_america = np.array([50, 400, 8000])
europe = np.array([80, 600, 9000])
asia = np.array([20, 500, 20000])
rest_of_the_world = np.array([10, 100, 3200])
...
ax.plot(decades, rest_of_the_world, marker='d', label='Rest of the World', linestyle=':', color='#FFD166', linewidth=2)
