...
# Focus on Climate Patterns in the Imaginary Land of "Ecolia" Over Three Decades
...
avg_temperature = np.array([15.2, 15.4, 15.6, 15.9, 16.0, 16.2, 16.4])  # in Celsius
avg_precipitation = np.array([1100, 1120, 1090, 1150, 1180, 1200, 1225])  # in mm
co2_levels = np.array([350, 360, 370, 380, 390, 400, 410])  # in ppm
...
axs[0].set_title('Average Temperature Trend in Ecolia (1990-2020)', fontsize=16, fontweight='bold', color='darkred')
axs[0].set_xlabel('Year', fontsize=12, fontweight='bold')
axs[0].set_ylabel('Temperature (°C)', fontsize=12, fontweight='bold')
axs[0].grid(True, linestyle='--', alpha=0.5)

# Precipitation Trend
axs[1].plot(years, avg_precipitation, color='blue', marker='s', linestyle='-', linewidth=2)
axs[1].set_title('Average Annual Precipitation in Ecolia (1990-2020)', fontsize=16, fontweight='bold', color='navy')
...
axs[2].set_title('Atmospheric CO2 Levels in Ecolia (1990-2020)', fontsize=16, fontweight='bold', color='darkgreen')
axs[2].set_xlabel('Year', fontsize=12, fontweight='bold')
axs[2].set_ylabel('CO2 Levels (ppm)', fontsize=12, fontweight='bold')
...
# Add a closing summary on the last subplot
summary_text = (
