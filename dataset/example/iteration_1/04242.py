...
# Backstory:
# We are comparing the evolution of four different superhero activity levels over a decade.
# These superheroes are: SuperAqua, PyroMan, EarthGuardian, and WindWoman.
# The data represents the frequency of their heroics per year from 2013 to 2022.
...
# Plot each superhero's activities with distinct line styles and markers
plt.plot(years, superaqua_activities, marker='o', linestyle='-', color='blue', linewidth=2, label='SuperAqua')
plt.plot(years, pyroman_activities, marker='s', linestyle='--', color='red', linewidth=2, label='PyroMan')
plt.plot(years, earthguardian_activities, marker='^', linestyle='-.', color='green', linewidth=2, label='EarthGuardian')
plt.plot(years, windwoman_activities, marker='x', linestyle=':', color='purple', linewidth=2, label='WindWoman')
