...
# Backstory: Comparing the Performance of Different Electric Vehicle Models Over 2021
# The script plots monthly sales data for 4 fictional electric vehicle (EV) models.
...
# Customize legend
ax.legend(title='EV Models', title_fontsize='13', fontsize='11', loc='upper left', frameon=True)
