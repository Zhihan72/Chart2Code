...
# Backstory:
# We are charting the Renewable Energy Production in the fictional city Greenvilla over a decade.
# We focus on three main sources of energy: Solar, Wind, and Hydro from 2010 to 2020.
...
ax.plot(years, solar_energy, label="Solar Energy", color='gold', marker='o', linestyle='dashdot', linewidth=2)
ax.plot(years, wind_energy, label="Wind Energy", color='skyblue', marker='^', linestyle='dotted', linewidth=2)
ax.plot(years, hydro_energy, label="Hydro Energy", color='seagreen', marker='s', linestyle='dashed', linewidth=2)
