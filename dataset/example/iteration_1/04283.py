...
# Backstory: 
# Imagine a futuristic city, "TechVille", tracking the advent of different renewable technologies over the last decade 
# with significant progress in solar and battery storage technologies alongside traditional renewables like hydro.
...
axs[0].stackplot(years, solar, wind, hydro, battery_storage, 
                 ...
                 colors=['#FFD700', '#1E90FF', '#32CD32', '#8B4513'], alpha=0.85)
...
axs[1].plot(years, wind_share, label='Wind', color='#1E90FF', marker='s')
