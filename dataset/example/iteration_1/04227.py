...
# Backstory: Cinematic Magic: Annual Audience Rating Trends
# Each year, movie studios release numerous films across various genres. Audience ratings often provide insight
# into the popularity and quality of films in different genres. This script visualizes the annual average 
# audience ratings for five popular movie genres over a five-year period.
...
# Colors for each genre category
colors = ['#FF6347', '#FF69B4', '#8B008B', '#1E90FF', '#FFD700']
