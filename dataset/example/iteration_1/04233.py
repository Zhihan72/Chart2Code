...
# Backstory: The chart explores the popularity of different genres of books over the last decade in a library system.
# We compare the number of borrowings for each genre across three different years: 2011, 2016, and 2021. 
# Additionally, we include a line plot showing the average borrowings growth percentage per genre over this period.

# Defining genres and borrowing data for the years 2011, 2016, and 2021
...
# Calculating the borrowing growth from 2011 to 2021
