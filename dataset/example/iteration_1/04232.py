...
agencies = ['Sherlock Holmes & Co.', 'Poirot Detective Services', 'Marple Investigations', 'Columbo Association']
...
solve_rates = [sherlock_data, poirot_data, marple_data, columbo_data]
...
colors = ['#FF6347', '#FFD700', '#98FB98', '#1E90FF']
patterns = ['/', '\\', '-', '|']
...
plt.ylabel('Solve Rate (%)', fontsize=12)
