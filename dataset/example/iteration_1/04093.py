...
# Backstory: Comparison of Monthly Water Consumption Across Different Types of Households
# Data Description: Monthly water consumption (in liters) for different types of households in a neighborhood
...
# Plot the data with customized properties
box = ax.boxplot(water_usage_data, vert=True, patch_artist=True, labels=household_types, notch=True, whis=[5, 95])
...
ax.set_xlabel('Household Type', fontsize=12)
