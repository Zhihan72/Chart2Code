...
# Backstory: We're examining the relationship between happiness and various personal and environmental factors.
# Specifically, we look at the score of happiness related to the amount of sleep, the number of daily steps,
# and the amount of time spent outdoors.

# Data: Here we create lists representing the scored happiness, amount of sleep (in hours), 
# number of daily steps (in thousands), and time spent outdoors (in hours).
