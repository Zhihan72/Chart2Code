...
# Backstory:
# This chart represents the yearly average temperature trends across multiple futuristic Martian colonies.
# The data showcases the increasing variability and average temperatures as the colonies develop their own ecosystems.
