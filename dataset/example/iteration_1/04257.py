...
# Backstory: Imagine a futuristic city powered by green energy from various renewable sources. 
# Each source contributes differently to the city's power grid. 
...
contributions = [300, 450, 200, 150, 100]
