...
# Backstory: This chart represents the sales data of different genres of books in a large city library spanning a decade (2011-2021). 
# The bars represent average annual sales for each genre, and an inset pie chart depicts the percentage of total sales that each genre contributes.
...
# Create a figure with two subplots (one bar and one pie chart inset)
...
# Create inset of width 40% and height 40% of the parent axis
ax_inset = inset_axes(ax, width="40%", height="40%", loc="upper right")

# Pie Chart
ax_inset.pie(percentage_sales, labels=genres, autopct='%1.1f%%', startangle=140, colors=colors, pctdistance=0.85,
             wedgeprops=dict(edgecolor='w'), textprops={'color': 'black', 'fontsize': 8})
