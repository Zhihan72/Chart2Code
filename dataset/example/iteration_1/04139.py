...
# Backstory: "CyberCity Network Activity Monitoring"
# This chart tracks network traffic in different areas of a futuristic city called CyberCity. 
# The heatmap shows activity in various city zones over the span of a week, while additional plots 
# display distribution of activity through bar plots.

# Define city zones and days of the week
city_zones = ["Downtown", "Residential", "Commercial", "Industrial", "Parks", "Suburbs", "Tech Hub", "University"]
