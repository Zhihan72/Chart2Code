...
# Backstory: "Wildfire Impact on Different Types of Forests Over Two Decades"
# The chart will reflect the impact of wildfires on different types of forests (Coniferous, Deciduous, Mixed, and Tropical)
# over a span of two decades, showing burnt area in thousands of hectares.
...
# Construct the stacked data for the area chart
...
ax.legend(custom_legend, ['Coniferous Forest', 'Deciduous Forest', 'Mixed Forest', 'Tropical Forest'], loc='upper left', fontsize=10, title="Forest Types")
