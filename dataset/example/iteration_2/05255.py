...
# Construct data for sea levels in mm (sample artificial data)
...
# Additional data: Average annual global temperature anomaly (in °C)
...
# Plotting the sea levels for different regions
ax1.plot(years, sea_levels_global, color='blue', label='Global Sea Level', linewidth=2)
ax1.plot(years, sea_levels_pacific, color='green', linestyle='--', label='Pacific Sea Level', linewidth=2)
ax1.plot(years, sea_levels_atlantic, color='red', linestyle='-.', label='Atlantic Sea Level', linewidth=2)
