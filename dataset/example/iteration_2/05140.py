...
# Backstory: Comparing the Productivity of Orchards in Different Regions
# Data represent the annual yield (in tons) of different types of fruits from four orchards over a decade.
...
# Customize colors for each fruit box
colors = ['#FF6347', '#FFD700', '#90EE90', '#FF69B4']
