...
# Backstory: Internet Usage Growth
# Over the past decade, various regions have seen significant growth in internet usage. This analysis 
# showcases the growth of internet users across different world regions from 2010 to 2020 to highlight the 
# rapid digital transformation globally.
...
# Format: data[region][year] representing millions of users
internet_users = [
