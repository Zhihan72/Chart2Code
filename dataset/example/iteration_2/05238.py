...
# Backstory:
# The chart shows the top 5 fruit production volumes in Wonderland for the year 2022. 
# Wonderland is a fictitious place known for its diverse and bountiful fruit orchards.
# We are comparing the production volumes of Apples, Bananas, Cherries, Dates, and Elderberries.
...
colors = ['#FFA07A', '#F0E68C', '#FFC0CB', '#D2691E', '#8A2BE2']
