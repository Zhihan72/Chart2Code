...
# Backstory: Analysis of the Spending Habits on Leisure Activities
# between Different Age Groups over the Weekends in 2023.
...
for i, (spending, age_group) in enumerate(zip(data, age_groups)):
    bars = ax.bar(indices + i * bar_width, spending, width=bar_width, label=age_group, color=colors[i])
