...
# Backstory: Tracking the health and performance of an IT system by monitoring CPU, RAM, and Disk usage over time
# The goal is to visualize how the usage of these resources changes over a typical workday
...
# Plot the data
ax.plot(hours, cpu_usage, label='CPU Usage', color='red', marker='o', linestyle='-', linewidth=2.5)
ax.plot(hours, ram_usage, label='RAM Usage', color='green', marker='s', linestyle='--', linewidth=2.5)
ax.plot(hours, disk_usage, label='Disk Usage', color='blue', marker='^', linestyle='-.', linewidth=2.5)

# Adding grid, title, and labels
ax.set_title("IT System Performance Monitoring\nCPU, RAM, and Disk Usage Over a Workday", fontsize=18, fontweight='bold', pad=20)
...
# Annotate peak usages
for usage, label, color in zip([cpu_usage, ram_usage, disk_usage], ['CPU', 'RAM', 'Disk'], ['red', 'green', 'blue']):
