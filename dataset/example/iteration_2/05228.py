...
# Backstory: Tracking the progression of different athletes over three types of fitness tests
# This could be a representation of their improvements over a training program spanning six months.
...
# Plot strength scores
ax1.plot(months, strength_scores, marker='s', markersize=6, linewidth=2, 
         linestyle='--', color='tomato', label='Strength')

# Plot flexibility scores
ax1.plot(months, flexibility_scores, marker='D', markersize=6, linewidth=2, 
         linestyle='-.', color='forestgreen', label='Flexibility')

# Title and labels
ax1.set_title("Athletes' Performance Tracking Over Six Months\nA Comprehensive Analysis of Fitness Improvements", 
              fontsize=18, fontweight='bold', pad=20)
ax1.set_xlabel("Months", fontsize=14, labelpad=15)
ax1.set_ylabel("Average Scores", fontsize=14, labelpad=15)

# Adding legend
ax1.legend(title="Tests", title_fontsize='13', fontsize='12', loc='upper left')
...
ax1.annotate(f'Peak: {max_endurance}', xy=(x[max_idx], max_endurance), xytext=(x[max_idx], max_endurance+10),
...
ax1.annotate(f'Peak: {max_strength}', xy=(x[max_idx], max_strength), xytext=(x[max_idx], max_strength+10),
...
ax1.annotate(f'Peak: {max_flexibility}', xy=(x[max_idx], max_flexibility), xytext=(x[max_idx], max_flexibility+10),
