...
# Backstory: Imagine we are tracking the health and fitness journey of three friends (Alice, Bob, and Charlie) over a year.
# Each friend has logged their monthly running distance (in kilometers) and gym visits.
...
ax1.plot(months, alice_running, marker='o', linestyle='-', color='blue', label='Alice')
ax1.plot(months, bob_running, marker='s', linestyle='--', color='green', label='Bob')
ax1.plot(months, charlie_running, marker='^', linestyle='-.', color='red', label='Charlie')
...
ax2.plot(months, alice_gym, marker='o', linestyle='-', color='blue', label='Alice')
ax2.plot(months, bob_gym, marker='s', linestyle='--', color='green', label='Bob')
ax2.plot(months, charlie_gym, marker='^', linestyle='-.', color='red', label='Charlie')
