...
# Backstory: The chart depicts different sources of renewable energy production over a decade, showcasing their growth rates.
# Title: Transition to Renewable Energy Sources (2020-2030)
# Labels: Year, Energy Production (in TeraWatts), Legend with different energy sources
...
ax.stackplot(years, data, labels=['Solar Energy', 'Wind Energy', 'Hydraulic Energy', 'Geothermal Energy'],
             colors=['#fdd835', '#4caf50', '#2196f3', '#ff5722'], alpha=0.8)
