...
# Backstory: The dataset represents the exam scores of students from different majors
# measured across different weeks. The box plot will show the distribution of these scores 
# for a detailed course-performance analysis. There is also a line plot showing the 
# median score changes over weeks for additional insight.
...
# Define colors for each major box plot
colors = ['lightgreen', 'lightblue', 'lightcoral', 'lightsalmon', 'lightcyan']
