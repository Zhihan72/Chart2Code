...
# Backstory: Forest Conservation Analysis
# The chart compares tree plantation activities of three organizations over five years and contrasts their impact.
...
bar1 = ax1.bar(x - width, org_A, width, label='Org A', color='#79C753', edgecolor='black')
bar2 = ax1.bar(x, org_B, width, label='Org B', color='#4CAF50', edgecolor='black')
bar3 = ax1.bar(x + width, org_C, width, label='Org C', color='#2E7D32', edgecolor='black')
