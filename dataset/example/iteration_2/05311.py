...
# Backstory:
# We are examining the trend of different sources of greenhouse gas emissions over five decades.
# The sectors being studied are Transportation, Industry, Agriculture, and Residential from 1980s to 2020s.
# The data is manually constructed and reflects hypothetical values representing the percentage of total greenhouse gas emissions contributed by each sector.
...
axs[0].plot(decades, transportation_emissions, marker='o', linestyle='-', linewidth=2, color='blue', label='Transportation')
axs[0].plot(decades, industry_emissions, marker='s', linestyle='-', linewidth=2, color='green', label='Industry')
axs[0].plot(decades, agriculture_emissions, marker='^', linestyle='-', linewidth=2, color='orange', label='Agriculture')
axs[0].plot(decades, residential_emissions, marker='d', linestyle='-', linewidth=2, color='red', label='Residential')
