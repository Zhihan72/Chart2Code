...
# Backstory: Tracking the Efficiency of Electric Vehicles (EVs)
# This script will plot the energy consumption efficiency (in kWh/100 miles) of different electric vehicles over the years 
# to understand how technology advancements have improved efficiency.

# Data: Years and corresponding energy consumption efficiency for three EV models
years = np.array([2010, 2012, 2014, 2016, 2018, 2020, 2022])

# Efficiency data for three different EV models
