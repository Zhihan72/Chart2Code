...
# Backstory: Tracking the Solar Energy Battle
# SolarTech is in a fierce competition with other renewable energy companies over the last decade.
# This chart visualizes their market share dynamics in the solar energy market from 2010 to 2020.
...
# Plot the first area chart for market shares
...
# Second subplot: Pie chart of final year market shares
final_year_shares = market_share_data[:, -1]
ax2.pie(final_year_shares, labels=labels, autopct='%1.1f%%', colors=colors, startangle=140,
        wedgeprops={'alpha':0.8}, textprops={'fontsize': 12})

ax2.set_title("Final Market Shares in 2020", fontsize=14, fontweight='bold')
