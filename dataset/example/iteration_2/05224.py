...
# Backstory:
# Tracking the Population of Different Bird Species Over Time
# This chart shows the population growth trends of three different bird species over five decades.
...
plt.scatter(decades, species_a_population, color='blue', label='Species A', edgecolor='k', s=100, alpha=0.7)
plt.scatter(decades, species_b_population, color='green', label='Species B', edgecolor='k', s=100, alpha=0.7)
plt.scatter(decades, species_c_population, color='red', label='Species C', edgecolor='k', s=100, alpha=0.7)
