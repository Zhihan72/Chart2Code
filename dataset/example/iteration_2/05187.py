...
# Backstory:
# The chart visualizes the relationship between city size (population) and the number of green parks available.
# Cities with different sizes might have different policies or capabilities to develop green zones.
# Hence, we want to explore if there's any noticeable correlation between city size and park richness.
...
# Add scatter plot
scatter = ax.scatter(populations, park_counts, s=populations, alpha=0.6, edgecolors='w', c=park_counts, cmap='viridis', label='Cities')
