...
# Backstory:
# SpaceX has been tracking the daily fluctuations in the energy output of its solar panels on the International Space Station over a month. 
# The data exhibits how differently positioned panels react to cosmic radiation on specific days.
# This script visualizes the energy output from 4 distinct solar panels over a month.

# Time period (days) of a month
days = np.arange(1, 31)

# Energy output data in kWh for four solar panels
...
# Plotting the data for each panel
...
ax1.plot(days, panel_D, label='Panel D', color='purple', marker='D', linestyle=':', linewidth=2)
