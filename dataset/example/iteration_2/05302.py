...
# Backstory:
# This chart showcases a fictional analysis of the nutrient content in different types of fruits over a decade. 
# The data highlights the Vitamin C and Fiber content in three popular fruits: Apples, Oranges, and Bananas.
# The objective is to analyze how these nutrient levels have varied year-over-year from 2011 to 2020.
...
ax1.plot(years, apples_vitamin_c, color='#FF6347', marker='o', linestyle='-', linewidth=2, label='Apples - Vitamin C (mg/100g)')
ax1.plot(years, oranges_vitamin_c, color='#FFA500', marker='s', linestyle='-', linewidth=2, label='Oranges - Vitamin C (mg/100g)')
ax1.plot(years, bananas_vitamin_c, color='#FFD700', marker='^', linestyle='-', linewidth=2, label='Bananas - Vitamin C (mg/100g)')

# Add secondary y-axis for Fiber content
ax2 = ax1.twinx()
ax2.plot(years, apples_fiber, color='#008000', marker='o', linestyle='--', linewidth=2, label='Apples - Fiber (g/100g)')
ax2.plot(years, oranges_fiber, color='#556B2F', marker='s', linestyle='--', linewidth=2, label='Oranges - Fiber (g/100g)')
ax2.plot(years, bananas_fiber, color='#8B4513', marker='^', linestyle='--', linewidth=2, label='Bananas - Fiber (g/100g)')
