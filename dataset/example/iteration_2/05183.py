...
# Backstory:
# The chart displays the "Annual Sales of Musical Instruments (2022) and Yearly Growth Rates". 
# The data shows sales figures of various musical instruments in thousands of units, along with their year-over-year growth rates in percentage.

# Data for the bar chart
instruments = ['Guitars', 'Pianos', 'Violins', 'Drums', 'Flutes']
sales = [150, 80, 60, 90, 45]  # Sales in thousands of units

# Data for the line plot
growth_rates = [7, 5, 10, 3, 8]  # Year-over-year growth rates in percentage
