...
# Backstory: Analyzing the yearly increase in the number of organic farms in various European countries.
...
ax.bar(positions, germany_farms, width=bar_width, color='cornflowerblue', edgecolor='grey', label='Germany')
ax.bar(positions + bar_width, france_farms, width=bar_width, color='seagreen', edgecolor='grey', label='France')
ax.bar(positions + 2 * bar_width, italy_farms, width=bar_width, color='tomato', edgecolor='grey', label='Italy')
ax.bar(positions + 3 * bar_width, spain_farms, width=bar_width, color='gold', edgecolor='grey', label='Spain')
ax.bar(positions + 4 * bar_width, sweden_farms, width=bar_width, color='mediumpurple', edgecolor='grey', label='Sweden')
...
ax.set_ylabel('Number of Organic Farms', fontsize=12, fontweight='bold')
