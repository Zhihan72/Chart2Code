...
# Population growth (in millions) of three fictional species in a biodiversity reserve
...
ax1.stackplot(years, population_data, labels=['Species A', 'Species B', 'Species C'], 
              colors=['#ffcc99', '#66b3ff', '#99ff99'], alpha=0.8)
...
# Adding a legend
ax1.legend(loc='upper left', fontsize=12, title='Species')

# Annotate significant growth trends
